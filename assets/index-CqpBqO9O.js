...
void main() {
	...
	`}var js=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Kd(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var qd=class e{static createButton(t,n={}){let r=document.createElement(`button`);function i(){let e=null;async function i(n){n.addEventListener(`end`,a),await t.xr.setSession(n),r.textContent=`EXIT VR`,e=n}function a(){e.removeEventListener(`end`,a),r.textContent=`ENTER VR`,e=null}r.style.display=``,r.style.cursor=`pointer`,r.style.left=`calc(50% - 50px)`,r.style.width=`100px`,r.textContent=`ENTER VR`;let o={...n,optionalFeatures:[`local-floor`,`bounded-floor`,`layers`,...n.optionalFeatures||[]]};r.onmouseenter=function(){r.style.opacity=`1.0`},r.onmouseleave=function(){r.style.opacity=`0.5`},r.onclick=function(){e===null?navigator.xr.requestSession(`immersive-vr`,o).then(i):(e.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)})}function a(){r.style.display=``,r.style.cursor=`auto`,r.style.left=`calc(50% - 75px)`,r.style.width=`150px`,r.onmouseenter=null,r.onmouseleave=null,r.onclick=null}function o(){a(),r.textContent=`VR NOT SUPPORTED`}function s(e){a(),console.warn(`Exception when trying to call xr.isSessionSupported`,e),r.textContent=`VR NOT ALLOWED`}function c(e){e.style.position=`absolute`,e.style.bottom=`20px`,e.style.padding=`12px 6px`,e.style.border=`1px solid #fff`,e.style.borderRadius=`4px`,e.style.background=`rgba(0,0,0,0.1)`,e.style.color=`#fff`,e.style.font=`normal 13px sans-serif`,e.style.textAlign=`center`,e.style.opacity=`0.5`,e.style.outline=`none`,e.style.zIndex=`999`}if(`xr`in navigator)return r.id=`VRButton`,r.style.display=`none`,c(r),navigator.xr.isSessionSupported(`immersive-vr`).then(function(t){t?i():o(),t&&e.xrSessionIsGranted&&r.click()}).catch(s),r;{let e=document.createElement(`a`);return window.isSecureContext===!1?(e.href=document.location.href.replace(/^http:/,`https:`),e.innerHTML=`WEBXR NEEDS HTTPS`):(e.href=`https://immersiveweb.dev/`,e.innerHTML=`WEBXR NOT AVAILABLE`),e.style.left=`calc(50% - 90px)`,e.style.width=`180px`,e.style.textDecoration=`none`,c(e),e}}static registerSessionGrantedListener(){if(typeof navigator<`u`&&`xr`in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener(`sessiongranted`,()=>{e.xrSessionIsGranted=!0})}}};qd.xrSessionIsGranted=!1,qd.registerSessionGrantedListener();var Jd=class{constructor(e=new G(0,0,0),t=new G(0,1,0),n=1){this.start=e,this.end=t,this.radius=n}clone(){return new this.constructor().copy(this)}set(e,t,n){return this.start.copy(e),this.end.copy(t),this.radius=n,this}copy(e){return this.start.copy(e.start),this.end.copy(e.end),this.radius=e.radius,this}getCenter(e){return e.copy(this.end).add(this.start).multiplyScalar(.5)}translate(e){return this.start.add(e),this.end.add(e),this}intersectsBox(e){return Yd(this.start.x,this.start.y,this.end.x,this.end.y,e.min.x,e.max.x,e.min.y,e.max.y,this.radius)&&Yd(this.start.x,this.start.z,this.end.x,this.end.z,e.min.x,e.max.x,e.min.z,e.max.z,this.radius)&&Yd(this.start.y,this.start.z,this.end.y,this.end.z,e.min.y,e.max.y,e.min.z,e.max.z,this.radius)}};function Yd(e,t,n,r,i,a,o,s,c){return(i-e<c||i-n<c)&&(e-a<c||n-a<c)&&(o-t<c||o-r<c)&&(t-s<c||r-s<c)}var Xd=new G,Zd=new G,Qd=new G,$d=new G,ef=new ji,tf=new Xo,nf=new Xo,rf=new Xn,af=new xr,of=new Jd,sf=new G,cf=new G,lf=new G,uf=new G,df=1e-10;function ff(e,t,n=null,r=null){let i=cf.copy(e.end).sub(e.start),a=lf.copy(t.end).sub(t.start),o=uf.copy(t.start).sub(e.start),s=i.dot(a),c=i.dot(i),l=a.dot(a),u=a.dot(o),d=i.dot(o),f,p,m=c*l-s*s;if(Math.abs(m)<df){let e=-u/l,t=(s-u)/l;Math.abs(e-.5)<Math.abs(t-.5)?(f=0,p=e):(f=1,p=t)}else f=(u*s+d*l)/m,p=(f*s-u)/l;p=Math.max(0,Math.min(1,p)),f=Math.max(0,Math.min(1,f)),n&&n.copy(i).multiplyScalar(f).add(e.start),r&&r.copy(a).multiplyScalar(p).add(t.start)}var pf=class e{constructor(e){this.box=e,this.bounds=new Xn,this.layers=new ln,this.trianglesPerLeaf=8,this.maxLevel=16,this.subTrees=[],this.triangles=[]}addTriangle(e){return this.bounds.min.x=Math.min(this.bounds.min.x,e.a.x,e.b.x,e.c.x),this.bounds.min.y=Math.min(this.bounds.min.y,e.a.y,e.b.y,e.c.y),this.bounds.min.z=Math.min(this.bounds.min.z,e.a.z,e.b.z,e.c.z),this.bounds.max.x=Math.max(this.bounds.max.x,e.a.x,e.b.x,e.c.x),this.bounds.max.y=Math.max(this.bounds.max.y,e.a.y,e.b.y,e.c.y),this.bounds.max.z=Math.max(this.bounds.max.z,e.a.z,e.b.z,e.c.z),this.triangles.push(e),this}calcBox(){return this.box=this.bounds.clone(),this.box.min.x-=.01,this.box.min.y-=.01,this.box.min.z-=.01,this}split(t){if(!this.box)return;let n=[],r=Zd.copy(this.box.max).sub(this.box.min).multiplyScalar(.5);for(let t=0;t<2;t++)for(let i=0;i<2;i++)for(let a=0;a<2;a++){let o=new Xn,s=Xd.set(t,i,a);o.min.copy(this.box.min).add(s.multiply(r)),o.max.copy(o.min).add(r),n.push(new e(o))}let i;for(;i=this.triangles.pop();)for(let e=0;e<n.length;e++)n[e].box.intersectsTriangle(i)&&n[e].triangles.push(i);for(let e=0;e<n.length;e++){let r=n[e].triangles.length;r>this.trianglesPerLeaf&&t<this.maxLevel&&n[e].split(t+1),r!==0&&this.subTrees.push(n[e])}return this}build(){return this.calcBox(),this.split(0),this}getRayTriangles(e,t){for(let n=0;n<this.subTrees.length;n++){let r=this.subTrees[n];if(e.intersectsBox(r.box))if(r.triangles.length>0)for(let e=0;e<r.triangles.length;e++)t.indexOf(r.triangles[e])===-1&&t.push(r.triangles[e]);else r.getRayTriangles(e,t)}}triangleCapsuleIntersect(e,t){t.getPlane(ef);let n=ef.distanceToPoint(e.start)-e.radius,r=ef.distanceToPoint(e.end)-e.radius;if(n>0&&r>0||n<-e.radius&&r<-e.radius)return!1;let i=Math.abs(n/(Math.abs(n)+Math.abs(r))),a=Xd.copy(e.start).lerp(e.end,i);if(t.containsPoint(a))return{normal:ef.normal.clone(),point:a.clone(),depth:Math.abs(Math.min(n,r))};let o=e.radius*e.radius,s=tf.set(e.start,e.end),c=[[t.a,t.b],[t.b,t.c],[t.c,t.a]];for(let t=0;t<c.length;t++)if(ff(s,nf.set(c[t][0],c[t][1]),Qd,$d),Qd.distanceToSquared($d)<o)return{normal:Qd.clone().sub($d).normalize(),point:$d.clone(),depth:e.radius-Qd.distanceTo($d)};return!1}triangleBoxIntersect(e,t){if(Math.max(t.a.x,t.b.x,t.c.x)<e.min.x||Math.min(t.a.x,t.b.x,t.c.x)>e.max.x||Math.max(t.a.y,t.b.y,t.c.y)<e.min.y||Math.min(t.a.y,t.b.y,t.c.y)>e.max.y||Math.max(t.a.z,t.b.z,t.c.z)<e.min.z||Math.min(t.a.z,t.b.z,t.c.z)>e.max.z||!e.intersectsTriangle(t))return!1;t.getPlane(ef),Xd.x=ef.normal.x>0?e.min.x:e.max.x,Xd.y=ef.normal.y>0?e.min.y:e.max.y,Xd.z=ef.normal.z>0?e.min.z:e.max.z;let n=ef.distanceToPoint(Xd),r={depth:-n,normal:ef.normal.clone(),point:Xd.clone()};return r.point.addScaledVector(r.normal,n),r}triangleSphereIntersect(e,t){if(t.getPlane(ef),!e.intersectsPlane(ef))return!1;let n=Math.abs(ef.distanceToSphere(e)),r=e.radius*e.radius-n*n,i=ef.projectPoint(e.center,Xd);if(t.containsPoint(e.center))return{normal:ef.normal.clone(),point:i.clone(),depth:Math.abs(ef.distanceToSphere(e))};let a=[[t.a,t.b],[t.b,t.c],[t.c,t.a]];for(let t=0;t<a.length;t++){tf.set(a[t][0],a[t][1]),tf.closestPointToPoint(i,!0,Zd);let n=Zd.distanceToSquared(e.center);if(n<r)return{normal:e.center.clone().sub(Zd).normalize(),point:Zd.clone(),depth:e.radius-Math.sqrt(n)}}return!1}getSphereTriangles(e,t){for(let n=0;n<this.subTrees.length;n++){let r=this.subTrees[n];if(e.intersectsBox(r.box))if(r.triangles.length>0)for(let e=0;e<r.triangles.length;e++)t.indexOf(r.triangles[e])===-1&&t.push(r.triangles[e]);else r.getSphereTriangles(e,t)}}getBoxTriangles(e,t){for(let n=0;n<this.subTrees.length;n++){let r=this.subTrees[n];if(e.intersectsBox(r.box))if(r.triangles.length>0)for(let e=0;e<r.triangles.length;e++)t.indexOf(r.triangles[e])===-1&&t.push(r.triangles[e]);else r.getBoxTriangles(e,t)}}getCapsuleTriangles(e,t){for(let n=0;n<this.subTrees.length;n++){let r=this.subTrees[n];if(e.intersectsBox(r.box))if(r.triangles.length>0)for(let e=0;e<r.triangles.length;e++)t.indexOf(r.triangles[e])===-1&&t.push(r.triangles[e]);else r.getCapsuleTriangles(e,t)}}boxIntersect(e){rf.copy(e);let t=[],n,r=!1;this.getBoxTriangles(e,t);for(let e=0;e<t.length;e++)(n=this.triangleBoxIntersect(rf,t[e]))&&(r=!0,rf.translate(n.normal.multiplyScalar(n.depth)));if(r){let t=rf.getCenter(sf).sub(e.getCenter(Xd)),n=t.length();return{normal:t.normalize(),depth:n}}return!1}sphereIntersect(e){af.copy(e);let t=[],n,r=!1;this.getSphereTriangles(e,t);for(let e=0;e<t.length;e++)(n=this.triangleSphereIntersect(af,t[e]))&&(r=!0,af.center.add(n.normal.multiplyScalar(n.depth)));if(r){let t=af.center.clone().sub(e.center),n=t.length();return{normal:t.normalize(),depth:n}}return!1}capsuleIntersect(e){of.copy(e);let t=[],n,r=!1;this.getCapsuleTriangles(of,t);for(let e=0;e<t.length;e++)(n=this.triangleCapsuleIntersect(of,t[e]))&&(r=!0,of.translate(n.normal.multiplyScalar(n.depth)));if(r){let t=of.getCenter(sf).sub(e.getCenter(Xd)),n=t.length();return{normal:t.normalize(),depth:n}}return!1}rayIntersect(e){let t=[],n,r,i=1e100;this.getRayTriangles(e,t);for(let a=0;a<t.length;a++){let o=e.intersectTriangle(t[a].a,t[a].b,t[a].c,!0,Xd);if(o){let s=o.sub(e.origin).length();i>s&&(r=o.clone().add(e.origin),i=s,n=t[a])}}return i<1e100?{distance:i,triangle:n,position:r}:!1}fromGraphNode(e){return e.updateWorldMatrix(!0,!0),e.traverse(e=>{if(e.isMesh===!0&&this.layers.test(e.layers)){let t,n=!1;e.geometry.index===null?t=e.geometry:(n=!0,t=e.geometry.toNonIndexed());let r=t.getAttribute(`position`);for(let t=0;t<r.count;t+=3){let n=new G().fromBufferAttribute(r,t),i=new G().fromBufferAttribute(r,t+1),a=new G().fromBufferAttribute(r,t+2);n.applyMatrix4(e.matrixWorld),i.applyMatrix4(e.matrixWorld),a.applyMatrix4(e.matrixWorld),this.addTriangle(new Yn(n,i,a))}n&&t.dispose()}}),this.build(),this}clear(){return this.box=null,this.bounds.makeEmpty(),this.subTrees.length=0,this.triangles.length=0,this}};function mf(e){if(e===void 0)throw ReferenceError(`this hasn't been initialised - super() hasn't been called`);return e}function hf(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}var gf={autoSleep:120,force3D:`auto`,nullTargetWarn:1,units:{lineHeight:``}},_f={duration:.5,overwrite:!1,delay:0},vf,yf,bf,xf=1e8,Sf=1/xf,Cf=Math.PI*2,wf=Cf/4,Tf=0,Ef=Math.sqrt,Df=Math.cos,Of=Math.sin,kf=function(e){return typeof e==`string`},Af=function(e){return typeof e==`function`},jf=function(e){return typeof e==`number`},Mf=function(e){return e===void 0},Nf=function(e){return typeof e==`object`},Pf=function(e){return e!==!1},Ff=function(){return typeof window<`u`},If=function(e){return Af(e)||kf(e)},Lf=typeof ArrayBuffer==`function`&&ArrayBuffer.isView||function(){},Rf=Array.isArray,zf=/random\([^)]+\)/g,Bf=/,\s*/g,Vf=/(?:-?\.?\d|\.)+/gi,Hf=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Uf=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Wf=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Gf=/[+-]=-?[.\d]+/,Kf=/[^,'"\[\]\s]+/gi,qf=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Jf,Yf,Xf,Zf,Qf={},$f={},ep,tp=function(e){return($f=Np(e,Qf))&&Zh},np=function(e,t){return console.warn(`Invalid property`,e,`set to`,t,`Missing plugin? gsap.registerPlugin()`)},rp=function(e,t){return!t&&console.warn(e)},ip=function(e,t){return e&&(Qf[e]=t)&&$f&&($f[e]=t)||Qf},ap=function(){return 0},op={suppressEvents:!0,isStart:!0,kill:!1},sp={suppressEvents:!0,kill:!1},cp={suppressEvents:!0},lp={},up=[],dp={},fp,pp={},mp={},hp=30,gp=[],_p=``,vp=function(e){var t=e[0],n,r;if(Nf(t)||Af(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=gp.length;r--&&!gp[r].targetTest(t););n=gp[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new sh(e[r],n)))||e.splice(r,1);return e},yp=function(e){return e._gsap||vp(gm(e))[0]._gsap},bp=function(e,t,n){return(n=e[t])&&Af(n)?e[t]():Mf(n)&&e.getAttribute&&e.getAttribute(t)||n},xp=function(e,t){return(e=e.split(`,`)).forEach(t)||e},Sp=function(e){return Math.round(e*1e5)/1e5||0},Cp=function(e){return Math.round(e*1e7)/1e7||0},wp=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n===`+`?e+r:n===`-`?e-r:n===`*`?e*r:e/r},Tp=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},Ep=function(){var e=up.length,t=up.slice(0),n,r;for(dp={},up.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},Dp=function(e){return!!(e._initted||e._startAt||e.add)},Op=function(e,t,n,r){up.length&&!yf&&Ep(),e.render(t,n,r||!!(yf&&t<0&&Dp(e))),up.length&&!yf&&Ep()},kp=function(e){var t=parseFloat(e);return(t||t===0)&&(e+``).match(Kf).length<2?t:kf(e)?e.trim():e},Ap=function(e){return e},jp=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},Mp=function(e){return function(t,n){for(var r in n)r in t||r===`duration`&&e||r===`ease`||(t[r]=n[r])}},Np=function(e,t){for(var n in t)e[n]=t[n];return e},Pp=function e(t,n){for(var r in n)r!==`__proto__`&&r!==`constructor`&&r!==`prototype`&&(t[r]=Nf(n[r])?e(t[r]||(t[r]={}),n[r]):n[r]);return t},Fp=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},Ip=function(e){var t=e.parent||Jf,n=e.keyframes?Mp(Rf(e.keyframes)):jp;if(Pf(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},Lp=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},Rp=function(e,t,n,r,i){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var a=e[r],o;if(i)for(o=t[i];a&&a[i]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=a,t.parent=t._dp=e,t},zp=function(e,t,n,r){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var i=t._prev,a=t._next;i?i._next=a:e[n]===t&&(e[n]=a),a?a._prev=i:e[r]===t&&(e[r]=i),t._next=t._prev=t.parent=null},Bp=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},Vp=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},Hp=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},Up=function(e,t,n,r){return e._startAt&&(yf?e._startAt.revert(sp):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},Wp=function e(t){return!t||t._ts&&e(t.parent)},Gp=function(e){return e._repeat?Kp(e._tTime,e=e.duration()+e._rDelay)*e:0},Kp=function(e,t){var n=Math.floor(e=Cp(e/t));return e&&n===e?n-1:n},qp=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},Jp=function(e){return e._end=Cp(e._start+(e._tDur/Math.abs(e._ts||e._rts||Sf)||0))},Yp=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=Cp(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),Jp(e),n._dirty||Vp(n,e)),e},Xp=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=qp(e.rawTime(),t),(!t._dur||um(0,t.totalDuration(),n)-t._tTime>Sf)&&t.render(n,!0)),Vp(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-Sf}},Zp=function(e,t,n,r){return t.parent&&Bp(t),t._start=Cp((jf(n)?n:n||e!==Jf?sm(e,n,t):e._time)+t._delay),t._end=Cp(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),Rp(e,t,`_first`,`_last`,e._sort?`_start`:0),tm(t)||(e._recent=t),r||Xp(e,t),e._ts<0&&Yp(e,e._tTime),e},Qp=function(e,t){return(Qf.ScrollTrigger||np(`scrollTrigger`,t))&&Qf.ScrollTrigger.create(t,e)},$p=function(e,t,n,r,i){if(gh(e,t,i),!e._initted)return 1;if(!n&&e._pt&&!yf&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&fp!==Jm.frame)return up.push(e),e._lazy=[i,r],1},em=function e(t){var n=t.parent;return n&&n._ts&&n._initted&&!n._lock&&(n.rawTime()<0||e(n))},tm=function(e){var t=e.data;return t===`isFromStart`||t===`isStart`},nm=function(e,t,n,r){var i=e.ratio,a=t<0||!t&&(!e._start&&em(e)&&!(!e._initted&&tm(e))||(e._ts<0||e._dp._ts<0)&&!tm(e))?0:1,o=e._rDelay,s=0,c,l,u;if(o&&e._repeat&&(s=um(0,e._tDur,t),l=Kp(s,o),e._yoyo&&l&1&&(a=1-a),l!==Kp(e._tTime,o)&&(i=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==i||yf||r||e._zTime===Sf||!t&&e._zTime){if(!e._initted&&$p(e,t,r,n,s))return;for(u=e._zTime,e._zTime=t||(n?Sf:0),n||=t&&!u,e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=s,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&Up(e,t,n,!0),e._onUpdate&&!n&&Nm(e,`onUpdate`),s&&e._repeat&&!n&&e.parent&&Nm(e,`onRepeat`),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&Bp(e,1),!n&&!yf&&(Nm(e,a?`onComplete`:`onReverseComplete`,!0),e._prom&&e._prom()))}else e._zTime||=t},rm=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data===`isPause`&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data===`isPause`&&r._start<t)return r;r=r._prev}},im=function(e,t,n,r){var i=e._repeat,a=Cp(t)||0,o=e._tTime/e._tDur;return o&&!r&&(e._time*=a/e._dur),e._dur=a,e._tDur=i?i<0?1e10:Cp(a*(i+1)+e._rDelay*i):a,o>0&&!r&&Yp(e,e._tTime=e._tDur*o),e.parent&&Jp(e),n||Vp(e.parent,e),e},am=function(e){return e instanceof lh?Vp(e):im(e,e._dur)},om={_start:0,endTime:ap,totalDuration:ap},sm=function e(t,n,r){var i=t.labels,a=t._recent||om,o=t.duration()>=xf?a.endTime(!1):t._dur,s,c,l;return kf(n)&&(isNaN(n)||n in i)?(c=n.charAt(0),l=n.substr(-1)===`%`,s=n.indexOf(`=`),c===`<`||c===`>`?(s>=0&&(n=n.replace(/=/,``)),(c===`<`?a._start:a.endTime(a._repeat>=0))+(parseFloat(n.substr(1))||0)*(l?(s<0?a:r).totalDuration()/100:1)):s<0?(n in i||(i[n]=o),i[n]):(c=parseFloat(n.charAt(s-1)+n.substr(s+1)),l&&r&&(c=c/100*(Rf(r)?r[0]:r).totalDuration()),s>1?e(t,n.substr(0,s-1),r)+c:o+c)):n==null?o:+n},cm=function(e,t,n){var r=jf(t[1]),i=(r?2:1)+(e<2?0:1),a=t[i],o,s;if(r&&(a.duration=t[1]),a.parent=n,e){for(o=a,s=n;s&&!(`immediateRender`in o);)o=s.vars.defaults||{},s=Pf(s.vars.inherit)&&s.parent;a.immediateRender=Pf(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[i-1]}return new Ch(t[0],a,t[i+1])},lm=function(e,t){return e||e===0?t(e):t},um=function(e,t,n){return n<e?e:n>t?t:n},dm=function(e,t){return!kf(e)||!(t=qf.exec(e))?``:t[1]},fm=function(e,t,n){return lm(n,function(n){return um(e,t,n)})},pm=[].slice,mm=function(e,t){return e&&Nf(e)&&`length`in e&&(!t&&!e.length||e.length-1 in e&&Nf(e[0]))&&!e.nodeType&&e!==Yf},hm=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(e){var r;return kf(e)&&!t||mm(e,1)?(r=n).push.apply(r,gm(e)):n.push(e)})||n},gm=function(e,t,n){return bf&&!t&&bf.selector?bf.selector(e):kf(e)&&!n&&(Xf||!Ym())?pm.call((t||Zf).querySelectorAll(e),0):Rf(e)?hm(e,n):mm(e)?pm.call(e,0):e?[e]:[]},_m=function(e){return e=gm(e)[0]||rp(`Invalid scope`)||{},function(t){var n=e.current||e.nativeElement||e;return gm(t,n.querySelectorAll?n:n===e?rp(`Invalid scope`)||Zf.createElement(`div`):e)}},vm=function(e){return e.sort(function(){return .5-Math.random()})},ym=function(e){if(Af(e))return e;var t=Nf(e)?e:{each:e},n=nh(t.ease),r=t.from||0,i=parseFloat(t.base)||0,a={},o=r>0&&r<1,s=isNaN(r)||o,c=t.axis,l=r,u=r;return kf(r)?l=u={center:.5,edges:.5,end:1}[r]||0:!o&&s&&(l=r[0],u=r[1]),function(e,o,d){var f=(d||t).length,p=a[f],m,h,g,_,v,y,b,x,S;if(!p){if(S=t.grid===`auto`?0:(t.grid||[1,xf])[1],!S){for(b=-xf;b<(b=d[S++].getBoundingClientRect().left)&&S<f;);S<f&&S--}for(p=a[f]=[],m=s?Math.min(S,f)*l-.5:r%S,h=S===xf?0:s?f*u/S-.5:r/S|0,b=0,x=xf,y=0;y<f;y++)g=y%S-m,_=h-(y/S|0),p[y]=v=c?Math.abs(c===`y`?_:g):Ef(g*g+_*_),v>b&&(b=v),v<x&&(x=v);r===`random`&&vm(p),p.max=b-x,p.min=x,p.v=f=(parseFloat(t.amount)||parseFloat(t.each)*(S>f?f-1:c?c===`y`?f/S:S:Math.max(S,f/S))||0)*(r===`edges`?-1:1),p.b=f<0?i-f:i,p.u=dm(t.amount||t.each)||0,n=n&&f<0?th(n):n}return f=(p[e]-p.min)/p.max||0,Cp(p.b+(n?n(f):f)*p.v)+p.u}},bm=function(e){var t=10**((e+``).split(`.`)[1]||``).length;return function(n){var r=Cp(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+(jf(n)?0:dm(n))}},xm=function(e,t){var n=Rf(e),r,i;return!n&&Nf(e)&&(r=n=e.radius||xf,e.values?(e=gm(e.values),(i=!jf(e[0]))&&(r*=r)):e=bm(e.increment)),lm(t,n?Af(e)?function(t){return i=e(t),Math.abs(i-t)<=r?i:t}:function(t){for(var n=parseFloat(i?t.x:t),a=parseFloat(i?t.y:0),o=xf,s=0,c=e.length,l,u;c--;)i?(l=e[c].x-n,u=e[c].y-a,l=l*l+u*u):l=Math.abs(e[c]-n),l<o&&(o=l,s=c);return s=!r||o<=r?e[s]:t,i||s===t||jf(t)?s:s+dm(t)}:bm(e))},Sm=function(e,t,n,r){return lm(Rf(e)?!t:n===!0?!!(n=0):!r,function(){return Rf(e)?e[~~(Math.random()*e.length)]:(n||=1e-5)&&(r=n<1?10**((n+``).length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},Cm=function(){var e=[...arguments];return function(t){return e.reduce(function(e,t){return t(e)},t)}},wm=function(e,t){return function(n){return e(parseFloat(n))+(t||dm(n))}},Tm=function(e,t,n){return Am(e,t,0,1,n)},Em=function(e,t,n){return lm(n,function(n){return e[~~t(n)]})},Dm=function e(t,n,r){var i=n-t;return Rf(t)?Em(t,e(0,t.length),n):lm(r,function(e){return(i+(e-t)%i)%i+t})},Om=function e(t,n,r){var i=n-t,a=i*2;return Rf(t)?Em(t,e(0,t.length-1),n):lm(r,function(e){return e=(a+(e-t)%a)%a||0,t+(e>i?a-e:e)})},km=function(e){return e.replace(zf,function(e){var t=e.indexOf(`[`)+1,n=e.substring(t||7,t?e.indexOf(`]`):e.length-1).split(Bf);return Sm(t?n:+n[0],t?0:+n[1],+n[2]||1e-5)})},Am=function(e,t,n,r,i){var a=t-e,o=r-n;return lm(i,function(t){return n+((t-e)/a*o||0)})},jm=function e(t,n,r,i){var a=isNaN(t+n)?0:function(e){return(1-e)*t+e*n};if(!a){var o=kf(t),s={},c,l,u,d,f;if(r===!0&&(i=1)&&(r=null),o)t={p:t},n={p:n};else if(Rf(t)&&!Rf(n)){for(u=[],d=t.length,f=d-2,l=1;l<d;l++)u.push(e(t[l-1],t[l]));d--,a=function(e){e*=d;var t=Math.min(f,~~e);return u[t](e-t)},r=n}else i||(t=Np(Rf(t)?[]:{},t));if(!u){for(c in n)dh.call(s,t,c,`get`,n[c]);a=function(e){return Mh(e,s)||(o?t.p:t)}}}return lm(r,a)},Mm=function(e,t,n){var r=e.labels,i=xf,a,o,s;for(a in r)o=r[a]-t,o<0==!!n&&o&&i>(o=Math.abs(o))&&(s=a,i=o);return s},Nm=function(e,t,n){var r=e.vars,i=r[t],a=bf,o=e._ctx,s,c,l;if(i)return s=r[t+`Params`],c=r.callbackScope||e,n&&up.length&&Ep(),o&&(bf=o),l=s?i.apply(c,s):i.call(c),bf=a,l},Pm=function(e){return Bp(e),e.scrollTrigger&&e.scrollTrigger.kill(!!yf),e.progress()<1&&Nm(e,`onInterrupt`),e},Fm,Im=[],Lm=function(e){if(e)if(e=!e.name&&e.default||e,Ff()||e.headless){var t=e.name,n=Af(e),r=t&&!n&&e.init?function(){this._props=[]}:e,i={init:ap,render:Mh,add:dh,kill:Ph,modifier:Nh,rawVars:0},a={targetTest:0,get:0,getSetter:Oh,aliases:{},register:0};if(Ym(),e!==r){if(pp[t])return;jp(r,jp(Fp(e,i),a)),Np(r.prototype,Np(i,Fp(e,a))),pp[r.prop=t]=r,e.targetTest&&(gp.push(r),lp[t]=1),t=(t===`css`?`CSS`:t.charAt(0).toUpperCase()+t.substr(1))+`Plugin`}ip(t,r),e.register&&e.register(Zh,r,Lh)}else Im.push(e)},Rm=255,zm={aqua:[0,Rm,Rm],lime:[0,Rm,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Rm],navy:[0,0,128],white:[Rm,Rm,Rm],olive:[128,128,0],yellow:[Rm,Rm,0],orange:[Rm,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Rm,0,0],pink:[Rm,192,203],cyan:[0,Rm,Rm],transparent:[Rm,Rm,Rm,0]},Bm=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*Rm+.5|0},Vm=function(e,t,n){var r=e?jf(e)?[e>>16,e>>8&Rm,e&Rm]:0:zm.black,i,a,o,s,c,l,u,d,f,p;if(!r){if(e.substr(-1)===`,`&&(e=e.substr(0,e.length-1)),zm[e])r=zm[e];else if(e.charAt(0)===`#`){if(e.length<6&&(i=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e=`#`+i+i+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):``)),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&Rm,r&Rm,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&Rm,e&Rm]}else if(e.substr(0,3)===`hsl`){if(r=p=e.match(Vf),!t)s=r[0]%360/360,c=r[1]/100,l=r[2]/100,a=l<=.5?l*(c+1):l+c-l*c,i=l*2-a,r.length>3&&(r[3]*=1),r[0]=Bm(s+1/3,i,a),r[1]=Bm(s,i,a),r[2]=Bm(s-1/3,i,a);else if(~e.indexOf(`=`))return r=e.match(Hf),n&&r.length<4&&(r[3]=1),r}else r=e.match(Vf)||zm.transparent;r=r.map(Number)}return t&&!p&&(i=r[0]/Rm,a=r[1]/Rm,o=r[2]/Rm,u=Math.max(i,a,o),d=Math.min(i,a,o),l=(u+d)/2,u===d?s=c=0:(f=u-d,c=l>.5?f/(2-u-d):f/(u+d),s=u===i?(a-o)/f+(a<o?6:0):u===a?(o-i)/f+2:(i-a)/f+4,s*=60),r[0]=~~(s+.5),r[1]=~~(c*100+.5),r[2]=~~(l*100+.5)),n&&r.length<4&&(r[3]=1),r},Hm=function(e){var t=[],n=[],r=-1;return e.split(Wm).forEach(function(e){var i=e.match(Uf)||[];t.push.apply(t,i),n.push(r+=i.length+1)}),t.c=n,t},Um=function(e,t,n){var r=``,i=(e+r).match(Wm),a=t?`hsla(`:`rgba(`,o=0,s,c,l,u;if(!i)return e;if(i=i.map(function(e){return(e=Vm(e,t,1))&&a+(t?e[0]+`,`+e[1]+`%,`+e[2]+`%,`+e[3]:e.join(`,`))+`)`}),n&&(l=Hm(e),s=n.c,s.join(r)!==l.c.join(r)))for(c=e.replace(Wm,`1`).split(Uf),u=c.length-1;o<u;o++)r+=c[o]+(~s.indexOf(o)?i.shift()||a+`0,0,0,0)`:(l.length?l:i.length?i:n).shift());if(!c)for(c=e.split(Wm),u=c.length-1;o<u;o++)r+=c[o]+i[o];return r+c[u]},Wm=function(){var e=`(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b`,t;for(t in zm)e+=`|`+t+`\\b`;return RegExp(e+`)`,`gi`)}(),Gm=/hsl[a]?\(/,Km=function(e){var t=e.join(` `),n;if(Wm.lastIndex=0,Wm.test(t))return n=Gm.test(t),e[1]=Um(e[1],n),e[0]=Um(e[0],n,Hm(e[1])),!0},qm,Jm=function(){var e=Date.now,t=500,n=33,r=e(),i=r,a=1e3/240,o=a,s=[],c,l,u,d,f,p,m=function u(m){var h=e()-i,g=m===!0,_,v,y,b;if((h>t||h<0)&&(r+=h-n),i+=h,y=i-r,_=y-o,(_>0||g)&&(b=++d.frame,f=y-d.time*1e3,d.time=y/=1e3,o+=_+(_>=a?4:a-_),v=1),g||(c=l(u)),v)for(p=0;p<s.length;p++)s[p](y,f,b,m)};return d={time:0,frame:0,tick:function(){m(!0)},deltaRatio:function(e){return f/(1e3/(e||60))},wake:function(){ep&&(!Xf&&Ff()&&(Yf=Xf=window,Zf=Yf.document||{},Qf.gsap=Zh,(Yf.gsapVersions||=[]).push(Zh.version),tp($f||Yf.GreenSockGlobals||!Yf.gsap&&Yf||{}),Im.forEach(Lm)),u=typeof requestAnimationFrame<`u`&&requestAnimationFrame,c&&d.sleep(),l=u||function(e){return setTimeout(e,o-d.time*1e3+1|0)},qm=1,m(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(c),qm=0,l=ap},lagSmoothing:function(e,r){t=e||1/0,n=Math.min(r||33,t)},fps:function(e){a=1e3/(e||240),o=d.time*1e3+a},add:function(e,t,n){var r=t?function(t,n,i,a){e(t,n,i,a),d.remove(r)}:e;return d.remove(e),s[n?`unshift`:`push`](r),Ym(),r},remove:function(e,t){~(t=s.indexOf(e))&&s.splice(t,1)&&p>=t&&p--},_listeners:s},d}(),Ym=function(){return!qm&&Jm.wake()},$={},Xm=/^[\d.\-M][\d.\-,\s]/,Zm=/["']/g,Qm=function(e){for(var t={},n=e.substr(1,e.length-3).split(`:`),r=n[0],i=1,a=n.length,o,s,c;i<a;i++)s=n[i],o=i===a-1?s.length:s.lastIndexOf(`,`),c=s.substr(0,o),t[r]=isNaN(c)?c.replace(Zm,``).trim():+c,r=s.substr(o+1).trim();return t},$m=function(e){var t=e.indexOf(`(`)+1,n=e.indexOf(`)`),r=e.indexOf(`(`,t);return e.substring(t,~r&&r<n?e.indexOf(`)`,n+1):n)},eh=function(e){var t=(e+``).split(`(`),n=$[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf(`{`)?[Qm(t[1])]:$m(e).split(`,`).map(kp)):$._CE&&Xm.test(e)?$._CE(``,e):n},th=function(e){return function(t){return 1-e(1-t)}},nh=function(e,t){return e&&(Af(e)?e:$[e]||eh(e))||t},rh=function(e,t,n,r){n===void 0&&(n=function(e){return 1-t(1-e)}),r===void 0&&(r=function(e){return e<.5?t(e*2)/2:1-t((1-e)*2)/2});var i={easeIn:t,easeOut:n,easeInOut:r},a;return xp(e,function(e){for(var t in $[e]=Qf[e]=i,$[a=e.toLowerCase()]=n,i)$[a+(t===`easeIn`?`.in`:t===`easeOut`?`.out`:`.inOut`)]=$[e+`.`+t]=i[t]}),i},ih=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},ah=function e(t,n,r){var i=n>=1?n:1,a=(r||(t?.3:.45))/(n<1?n:1),o=a/Cf*(Math.asin(1/i)||0),s=function(e){return e===1?1:i*2**(-10*e)*Of((e-o)*a)+1},c=t===`out`?s:t===`in`?function(e){return 1-s(1-e)}:ih(s);return a=Cf/a,c.config=function(n,r){return e(t,n,r)},c},oh=function e(t,n){n===void 0&&(n=1.70158);var r=function(e){return e?--e*e*((n+1)*e+n)+1:0},i=t===`out`?r:t===`in`?function(e){return 1-r(1-e)}:ih(r);return i.config=function(n){return e(t,n)},i};xp(`Linear,Quad,Cubic,Quart,Quint,Strong`,function(e,t){var n=t<5?t+1:t;rh(e+`,Power`+(n-1),t?function(e){return e**+n}:function(e){return e},function(e){return 1-(1-e)**n},function(e){return e<.5?(e*2)**n/2:1-((1-e)*2)**n/2})}),$.Linear.easeNone=$.none=$.Linear.easeIn,rh(`Elastic`,ah(`in`),ah(`out`),ah()),(function(e,t){var n=1/t,r=2*n,i=2.5*n,a=function(a){return a<n?e*a*a:a<r?e*(a-1.5/t)**2+.75:a<i?e*(a-=2.25/t)*a+.9375:e*(a-2.625/t)**2+.984375};rh(`Bounce`,function(e){return 1-a(1-e)},a)})(7.5625,2.75),rh(`Expo`,function(e){return 2**(10*(e-1))*e+e*e*e*e*e*e*(1-e)}),rh(`Circ`,function(e){return-(Ef(1-e*e)-1)}),rh(`Sine`,function(e){return e===1?1:-Df(e*wf)+1}),rh(`Back`,oh(`in`),oh(`out`),oh()),$.SteppedEase=$.steps=Qf.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+ +!t,i=+!!t,a=1-Sf;return function(e){return((r*um(0,a,e)|0)+i)*n}}},_f.ease=$[`quad.out`],xp(`onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt`,function(e){return _p+=e+`,`+e+`Params,`});var sh=function(e,t){this.id=Tf++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:bp,this.set=t?t.getSetter:Oh},ch=function(){function e(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,im(this,+e.duration,1,1),this.data=e.data,bf&&(this._ctx=bf,bf.data.push(this)),qm||Jm.wake()}var t=e.prototype;return t.delay=function(e){return e||e===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+e-this._delay),this._delay=e,this):this._delay},t.duration=function(e){return arguments.length?this.totalDuration(this._repeat>0?e+(e+this._rDelay)*this._repeat:e):this.totalDuration()&&this._dur},t.totalDuration=function(e){return arguments.length?(this._dirty=0,im(this,this._repeat<0?e:(e-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(e,t){if(Ym(),!arguments.length)return this._tTime;var n=this._dp;if(n&&n.smoothChildTiming&&this._ts){for(Yp(this,e),!n._dp||n.parent||Xp(n,this);n&&n.parent;)n.parent._time!==n._start+(n._ts>=0?n._tTime/n._ts:(n.totalDuration()-n._tTime)/-n._ts)&&n.totalTime(n._tTime,!0),n=n.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&e<this._tDur||this._ts<0&&e>0||!this._tDur&&!e)&&Zp(this._dp,this,this._start-this._delay)}return(this._tTime!==e||!this._dur&&!t||this._initted&&Math.abs(this._zTime)===Sf||!this._initted&&this._dur&&e||!e&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=e),Op(this,e,t)),this},t.time=function(e,t){return arguments.length?this.totalTime(Math.min(this.totalDuration(),e+Gp(this))%(this._dur+this._rDelay)||(e?this._dur:0),t):this._time},t.totalProgress=function(e,t){return arguments.length?this.totalTime(this.totalDuration()*e,t):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(e,t){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-e:e)+Gp(this),t):this.duration()?Math.min(1,this._time/this._dur):+(this.rawTime()>0)},t.iteration=function(e,t){var n=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(e-1)*n,t):this._repeat?Kp(this._tTime,n)+1:1},t.timeScale=function(e,t){if(!arguments.length)return this._rts===-Sf?0:this._rts;if(this._rts===e)return this;var n=this.parent&&this._ts?qp(this.parent._time,this):this._tTime;return this._rts=+e||0,this._ts=this._ps||e===-Sf?0:this._rts,this.totalTime(um(-Math.abs(this._delay),this.totalDuration(),n),t!==!1),Jp(this),Hp(this)},t.paused=function(e){return arguments.length?(this._ps!==e&&(this._ps=e,e?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Ym(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Sf&&(this._tTime-=Sf)))),this):this._ps},t.startTime=function(e){if(arguments.length){this._start=Cp(e);var t=this.parent||this._dp;return t&&(t._sort||!this.parent)&&Zp(t,this,this._start-this._delay),this}return this._start},t.endTime=function(e){return this._start+(Pf(e)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(e){var t=this.parent||this._dp;return t?e&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?qp(t.rawTime(e),this):this._tTime:this._tTime},t.revert=function(e){e===void 0&&(e=cp);var t=yf;return yf=e,Dp(this)&&(this.timeline&&this.timeline.revert(e),this.totalTime(-.01,e.suppressEvents)),this.data!==`nested`&&e.kill!==!1&&this.kill(),yf=t,this},t.globalTime=function(e){for(var t=this,n=arguments.length?e:t.rawTime();t;)n=t._start+n/(Math.abs(t._ts)||1),t=t._dp;return!this.parent&&this._sat?this._sat.globalTime(e):n},t.repeat=function(e){return arguments.length?(this._repeat=e===1/0?-2:e,am(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(e){if(arguments.length){var t=this._time;return this._rDelay=e,am(this),t?this.time(t):this}return this._rDelay},t.yoyo=function(e){return arguments.length?(this._yoyo=e,this):this._yoyo},t.seek=function(e,t){return this.totalTime(sm(this,e),Pf(t))},t.restart=function(e,t){return this.play().totalTime(e?-this._delay:0,Pf(t)),this._dur||(this._zTime=-Sf),this},t.play=function(e,t){return e!=null&&this.seek(e,t),this.reversed(!1).paused(!1)},t.reverse=function(e,t){return e!=null&&this.seek(e||this.totalDuration(),t),this.reversed(!0).paused(!1)},t.pause=function(e,t){return e!=null&&this.seek(e,t),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(e){return arguments.length?(!!e!==this.reversed()&&this.timeScale(-this._rts||(e?-Sf:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Sf,this},t.isActive=function(){var e=this.parent||this._dp,t=this._start,n;return!!(!e||this._ts&&this._initted&&e.isActive()&&(n=e.rawTime(!0))>=t&&n<this.endTime(!0)-Sf)},t.eventCallback=function(e,t,n){var r=this.vars;return arguments.length>1?(t?(r[e]=t,n&&(r[e+`Params`]=n),e===`onUpdate`&&(this._onUpdate=t)):delete r[e],this):r[e]},t.then=function(e){var t=this,n=t._prom;return new Promise(function(r){var i=Af(e)?e:Ap,a=function(){var e=t.then;t.then=null,n&&n(),Af(i)&&(i=i(t))&&(i.then||i===t)&&(t.then=e),r(i),t.then=e};t._initted&&t.totalProgress()===1&&t._ts>=0||!t._tTime&&t._ts<0?a():t._prom=a})},t.kill=function(){Pm(this)},e}();jp(ch.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Sf,_prom:0,_ps:!1,_rts:1});var lh=function(e){hf(t,e);function t(t,n){var r;return t===void 0&&(t={}),r=e.call(this,t)||this,r.labels={},r.smoothChildTiming=!!t.smoothChildTiming,r.autoRemoveChildren=!!t.autoRemoveChildren,r._sort=Pf(t.sortChildren),Jf&&Zp(t.parent||Jf,mf(r),n),t.reversed&&r.reverse(),t.paused&&r.paused(!0),t.scrollTrigger&&Qp(mf(r),t.scrollTrigger),r}var n=t.prototype;return n.to=function(e,t,n){return cm(0,arguments,this),this},n.from=function(e,t,n){return cm(1,arguments,this),this},n.fromTo=function(e,t,n,r){return cm(2,arguments,this),this},n.set=function(e,t,n){return t.duration=0,t.parent=this,Ip(t).repeatDelay||(t.repeat=0),t.immediateRender=!!t.immediateRender,new Ch(e,t,sm(this,n),1),this},n.call=function(e,t,n){return Zp(this,Ch.delayedCall(0,e,t),n)},n.staggerTo=function(e,t,n,r,i,a,o){return n.duration=t,n.stagger=n.stagger||r,n.onComplete=a,n.onCompleteParams=o,n.parent=this,new Ch(e,n,sm(this,i)),this},n.staggerFrom=function(e,t,n,r,i,a,o){return n.runBackwards=1,Ip(n).immediateRender=Pf(n.immediateRender),this.staggerTo(e,t,n,r,i,a,o)},n.staggerFromTo=function(e,t,n,r,i,a,o,s){return r.startAt=n,Ip(r).immediateRender=Pf(r.immediateRender),this.staggerTo(e,t,r,i,a,o,s)},n.render=function(e,t,n){var r=this._time,i=this._dirty?this.totalDuration():this._tDur,a=this._dur,o=e<=0?0:Cp(e),s=this._zTime<0!=e<0&&(this._initted||!a),c,l,u,d,f,p,m,h,g,_,v,y;if(this!==Jf&&o>i&&e>=0&&(o=i),o!==this._tTime||n||s){if(r!==this._time&&a&&(o+=this._time-r,e+=this._time-r),c=o,g=this._start,h=this._ts,p=!h,s&&(a||(r=this._zTime),(e||!t)&&(this._zTime=e)),this._repeat){if(v=this._yoyo,f=a+this._rDelay,this._repeat<-1&&e<0)return this.totalTime(f*100+e,t,n);if(c=Cp(o%f),o===i?(d=this._repeat,c=a):(_=Cp(o/f),d=~~_,d&&d===_&&(c=a,d--),c>a&&(c=a)),_=Kp(this._tTime,f),!r&&this._tTime&&_!==d&&this._tTime-_*f-this._dur<=0&&(_=d),v&&d&1&&(c=a-c,y=1),d!==_&&!this._lock){var b=v&&_&1,x=b===(v&&d&1);if(d<_&&(b=!b),r=b?0:o%a?a:o,this._lock=1,this.render(r||(y?0:Cp(d*f)),t,!a)._lock=0,this._tTime=o,!t&&this.parent&&Nm(this,`onRepeat`),this.vars.repeatRefresh&&!y&&(this.invalidate()._lock=1,_=d),r&&r!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act||(a=this._dur,i=this._tDur,x&&(this._lock=2,r=b?a:-1e-4,this.render(r,!0),this.vars.repeatRefresh&&!y&&this.invalidate()),this._lock=0,!this._ts&&!p))return this}}if(this._hasPause&&!this._forcing&&this._lock<2&&(m=rm(this,Cp(r),Cp(c)),m&&(o-=c-(c=m._start))),this._tTime=o,this._time=c,this._act=!!h,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=e,r=0),!r&&o&&a&&!t&&!_&&(Nm(this,`onStart`),this._tTime!==o))return this;if(c>=r&&e>=0)for(l=this._first;l;){if(u=l._next,(l._act||c>=l._start)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(c-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(c-l._start)*l._ts,t,n),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=-Sf);break}}l=u}else{l=this._last;for(var S=e<0?e:c;l;){if(u=l._prev,(l._act||S<=l._end)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(S-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(S-l._start)*l._ts,t,n||yf&&Dp(l)),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=S?-Sf:Sf);break}}l=u}}if(m&&!t&&(this.pause(),m.render(c>=r?0:-Sf)._zTime=c>=r?1:-1,this._ts))return this._start=g,Jp(this),this.render(e,t,n);this._onUpdate&&!t&&Nm(this,`onUpdate`,!0),(o===i&&this._tTime>=this.totalDuration()||!o&&r)&&(g===this._start||Math.abs(h)!==Math.abs(this._ts))&&(this._lock||((e||!a)&&(o===i&&this._ts>0||!o&&this._ts<0)&&Bp(this,1),!t&&!(e<0&&!r)&&(o||r||!i)&&(Nm(this,o===i&&e>=0?`onComplete`:`onReverseComplete`,!0),this._prom&&!(o<i&&this.timeScale()>0)&&this._prom())))}return this},n.add=function(e,t){var n=this;if(jf(t)||(t=sm(this,t,e)),!(e instanceof ch)){if(Rf(e))return e.forEach(function(e){return n.add(e,t)}),this;if(kf(e))return this.addLabel(e,t);if(Af(e))e=Ch.delayedCall(0,e);else return this}return this===e?this:Zp(this,e,t)},n.getChildren=function(e,t,n,r){e===void 0&&(e=!0),t===void 0&&(t=!0),n===void 0&&(n=!0),r===void 0&&(r=-xf);for(var i=[],a=this._first;a;)a._start>=r&&(a instanceof Ch?t&&i.push(a):(n&&i.push(a),e&&i.push.apply(i,a.getChildren(!0,t,n)))),a=a._next;return i},n.getById=function(e){for(var t=this.getChildren(1,1,1),n=t.length;n--;)if(t[n].vars.id===e)return t[n]},n.remove=function(e){return kf(e)?this.removeLabel(e):Af(e)?this.killTweensOf(e):(e.parent===this&&zp(this,e),e===this._recent&&(this._recent=this._last),Vp(this))},n.totalTime=function(t,n){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=Cp(Jm.time-(this._ts>0?t/this._ts:(this.totalDuration()-t)/-this._ts))),e.prototype.totalTime.call(this,t,n),this._forcing=0,this):this._tTime},n.addLabel=function(e,t){return this.labels[e]=sm(this,t),this},n.removeLabel=function(e){return delete this.labels[e],this},n.addPause=function(e,t,n){var r=Ch.delayedCall(0,t||ap,n);return r.data=`isPause`,this._hasPause=1,Zp(this,r,sm(this,e))},n.removePause=function(e){var t=this._first;for(e=sm(this,e);t;)t._start===e&&t.data===`isPause`&&Bp(t),t=t._next},n.killTweensOf=function(e,t,n){for(var r=this.getTweensOf(e,n),i=r.length;i--;)mh!==r[i]&&r[i].kill(e,t);return this},n.getTweensOf=function(e,t){for(var n=[],r=gm(e),i=this._first,a=jf(t),o;i;)i instanceof Ch?Tp(i._targets,r)&&(a?(!mh||i._initted&&i._ts)&&i.globalTime(0)<=t&&i.globalTime(i.totalDuration())>t:!t||i.isActive())&&n.push(i):(o=i.getTweensOf(r,t)).length&&n.push.apply(n,o),i=i._next;return n},n.tweenTo=function(e,t){t||={};var n=this,r=sm(n,e),i=t,a=i.startAt,o=i.onStart,s=i.onStartParams,c=i.immediateRender,l,u=Ch.to(n,jp({ease:t.ease||`none`,lazy:!1,immediateRender:!1,time:r,overwrite:`auto`,duration:t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale())||Sf,onStart:function(){if(n.pause(),!l){var e=t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale());u._dur!==e&&im(u,e,0,1).render(u._time,!0,!0),l=1}o&&o.apply(u,s||[])}},t));return c?u.render(0):u},n.tweenFromTo=function(e,t,n){return this.tweenTo(t,jp({startAt:{time:sm(this,e)}},n))},n.recent=function(){return this._recent},n.nextLabel=function(e){return e===void 0&&(e=this._time),Mm(this,sm(this,e))},n.previousLabel=function(e){return e===void 0&&(e=this._time),Mm(this,sm(this,e),1)},n.currentLabel=function(e){return arguments.length?this.seek(e,!0):this.previousLabel(this._time+Sf)},n.shiftChildren=function(e,t,n){n===void 0&&(n=0);var r=this._first,i=this.labels,a;for(e=Cp(e);r;)r._start>=n&&(r._start+=e,r._end+=e),r=r._next;if(t)for(a in i)i[a]>=n&&(i[a]+=e);return Vp(this)},n.invalidate=function(t){var n=this._first;for(this._lock=0;n;)n.invalidate(t),n=n._next;return e.prototype.invalidate.call(this,t)},n.clear=function(e){e===void 0&&(e=!0);for(var t=this._first,n;t;)n=t._next,this.remove(t),t=n;return this._dp&&(this._time=this._tTime=this._pTime=0),e&&(this.labels={}),Vp(this)},n.totalDuration=function(e){var t=0,n=this,r=n._last,i=xf,a,o,s;if(arguments.length)return n.timeScale((n._repeat<0?n.duration():n.totalDuration())/(n.reversed()?-e:e));if(n._dirty){for(s=n.parent;r;)a=r._prev,r._dirty&&r.totalDuration(),o=r._start,o>i&&n._sort&&r._ts&&!n._lock?(n._lock=1,Zp(n,r,o-r._delay,1)._lock=0):i=o,o<0&&r._ts&&(t-=o,(!s&&!n._dp||s&&s.smoothChildTiming)&&(n._start+=Cp(o/n._ts),n._time-=o,n._tTime-=o),n.shiftChildren(-o,!1,-1/0),i=0),r._end>t&&r._ts&&(t=r._end),r=a;im(n,n===Jf&&n._time>t?n._time:t,1,1),n._dirty=0}return n._tDur},t.updateRoot=function(e){if(Jf._ts&&(Op(Jf,qp(e,Jf)),fp=Jm.frame),Jm.frame>=hp){hp+=gf.autoSleep||120;var t=Jf._first;if((!t||!t._ts)&&gf.autoSleep&&Jm._listeners.length<2){for(;t&&!t._ts;)t=t._next;t||Jm.sleep()}}},t}(ch);jp(lh.prototype,{_lock:0,_hasPause:0,_forcing:0});var uh=function(e,t,n,r,i,a,o){var s=new Lh(this._pt,e,t,0,1,jh,null,i),c=0,l=0,u,d,f,p,m,h,g,_;for(s.b=n,s.e=r,n+=``,r+=``,(g=~r.indexOf(`random(`))&&(r=km(r)),a&&(_=[n,r],a(_,e,t),n=_[0],r=_[1]),d=n.match(Wf)||[];u=Wf.exec(r);)p=u[0],m=r.substring(c,u.index),f?f=(f+1)%5:m.substr(-5)===`rgba(`&&(f=1),p!==d[l++]&&(h=parseFloat(d[l-1])||0,s._pt={_next:s._pt,p:m||l===1?m:`,`,s:h,c:p.charAt(1)===`=`?wp(h,p)-h:parseFloat(p)-h,m:f&&f<4?Math.round:0},c=Wf.lastIndex);return s.c=c<r.length?r.substring(c,r.length):``,s.fp=o,(Gf.test(r)||g)&&(s.e=0),this._pt=s,s},dh=function(e,t,n,r,i,a,o,s,c,l){Af(r)&&(r=r(i||0,e,a));var u=e[t],d=n===`get`?Af(u)?c?e[t.indexOf(`set`)||!Af(e[`get`+t.substr(3)])?t:`get`+t.substr(3)](c):e[t]():u:n,f=Af(u)?c?Eh:Th:wh,p;if(kf(r)&&(~r.indexOf(`random(`)&&(r=km(r)),r.charAt(1)===`=`&&(p=wp(d,r)+(dm(d)||0),(p||p===0)&&(r=p))),!l||d!==r||hh)return!isNaN(d*r)&&r!==``?(p=new Lh(this._pt,e,t,+d||0,r-(d||0),typeof u==`boolean`?Ah:kh,0,f),c&&(p.fp=c),o&&p.modifier(o,this,e),this._pt=p):(!u&&!(t in e)&&np(t,r),uh.call(this,e,t,d,r,f,s||gf.stringFilter,c))},fh=function(e,t,n,r,i){if(Af(e)&&(e=bh(e,i,t,n,r)),!Nf(e)||e.style&&e.nodeType||Rf(e)||Lf(e))return kf(e)?bh(e,i,t,n,r):e;var a={},o;for(o in e)a[o]=bh(e[o],i,t,n,r);return a},ph=function(e,t,n,r,i,a){var o,s,c,l;if(pp[e]&&(o=new pp[e]).init(i,o.rawVars?t[e]:fh(t[e],r,i,a,n),n,r,a)!==!1&&(n._pt=s=new Lh(n._pt,i,e,0,1,o.render,o,0,o.priority),n!==Fm))for(c=n._ptLookup[n._targets.indexOf(i)],l=o._props.length;l--;)c[o._props[l]]=s;return o},mh,hh,gh=function e(t,n,r){var i=t.vars,a=i.ease,o=i.startAt,s=i.immediateRender,c=i.lazy,l=i.onUpdate,u=i.runBackwards,d=i.yoyoEase,f=i.keyframes,p=i.autoRevert,m=t._dur,h=t._startAt,g=t._targets,_=t.parent,v=_&&_.data===`nested`?_.vars.targets:g,y=t._overwrite===`auto`&&!vf,b=t.timeline,x=i.easeReverse||d,S,C,w,T,E,D,O,k,A,j,M,N,ee;if(b&&(!f||!a)&&(a=`none`),t._ease=nh(a,_f.ease),t._rEase=x&&(nh(x)||t._ease),t._from=!b&&!!i.runBackwards,t._from&&(t.ratio=1),!b||f&&!i.stagger){if(k=g[0]?yp(g[0]).harness:0,N=k&&i[k.prop],S=Fp(i,lp),h&&(h._zTime<0&&h.progress(1),n<0&&u&&s&&!p?h.render(-1,!0):h.revert(u&&m?sp:op),h._lazy=0),o){if(Bp(t._startAt=Ch.set(g,jp({data:`isStart`,overwrite:!1,parent:_,immediateRender:!0,lazy:!h&&Pf(c),startAt:null,delay:0,onUpdate:l&&function(){return Nm(t,`onUpdate`)},stagger:0},o))),t._startAt._dp=0,t._startAt._sat=t,n<0&&(yf||!s&&!p)&&t._startAt.revert(sp),s&&m&&n<=0&&r<=0){n&&(t._zTime=n);return}}else if(u&&m&&!h){if(n&&(s=!1),w=jp({overwrite:!1,data:`isFromStart`,lazy:s&&!h&&Pf(c),immediateRender:s,stagger:0,parent:_},S),N&&(w[k.prop]=N),Bp(t._startAt=Ch.set(g,w)),t._startAt._dp=0,t._startAt._sat=t,n<0&&(yf?t._startAt.revert(sp):t._startAt.render(-1,!0)),t._zTime=n,!s)e(t._startAt,Sf,Sf);else if(!n)return}for(t._pt=t._ptCache=0,c=m&&Pf(c)||c&&!m,C=0;C<g.length;C++){if(E=g[C],O=E._gsap||vp(g)[C]._gsap,t._ptLookup[C]=j={},dp[O.id]&&up.length&&Ep(),M=v===g?C:v.indexOf(E),k&&(A=new k).init(E,N||S,t,M,v)!==!1&&(t._pt=T=new Lh(t._pt,E,A.name,0,1,A.render,A,0,A.priority),A._props.forEach(function(e){j[e]=T}),A.priority&&(D=1)),!k||N)for(w in S)pp[w]&&(A=ph(w,S,t,M,E,v))?A.priority&&(D=1):j[w]=T=dh.call(t,E,w,`get`,S[w],M,v,0,i.stringFilter);t._op&&t._op[C]&&t.kill(E,t._op[C]),y&&t._pt&&(mh=t,Jf.killTweensOf(E,j,t.globalTime(n)),ee=!t.parent,mh=0),t._pt&&c&&(dp[O.id]=1)}D&&Ih(t),t._onInit&&t._onInit(t)}t._onUpdate=l,t._initted=(!t._op||t._pt)&&!ee,f&&n<=0&&b.render(xf,!0,!0)},_h=function(e,t,n,r,i,a,o,s){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],l,u,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(l=d[f][t],l&&l.d&&l.d._pt)for(l=l.d._pt;l&&l.p!==t&&l.fp!==t;)l=l._next;if(!l)return hh=1,e.vars[t]=`+=0`,gh(e,o),hh=0,s?rp(t+` not eligible for reset. Try splitting into individual properties`):1;c.push(l)}for(f=c.length;f--;)u=c[f],l=u._pt||u,l.s=(r||r===0)&&!i?r:l.s+(r||0)+a*l.c,l.c=n-l.s,u.e&&=Sp(n)+dm(u.e),u.b&&=l.s+dm(u.b)},vh=function(e,t){var n=e[0]?yp(e[0]).harness:0,r=n&&n.aliases,i,a,o,s;if(!r)return t;for(a in i=Np({},t),r)if(a in i)for(s=r[a].split(`,`),o=s.length;o--;)i[s[o]]=i[a];return i},yh=function(e,t,n,r){var i=t.ease||r||`power1.inOut`,a,o;if(Rf(t))o=n[e]||(n[e]=[]),t.forEach(function(e,n){return o.push({t:n/(t.length-1)*100,v:e,e:i})});else for(a in t)o=n[a]||(n[a]=[]),a===`ease`||o.push({t:parseFloat(e),v:t[a],e:i})},bh=function(e,t,n,r,i){return Af(e)?e.call(t,n,r,i):kf(e)&&~e.indexOf(`random(`)?km(e):e},xh=_p+`repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`,Sh={};xp(xh+`,id,stagger,delay,duration,paused,scrollTrigger`,function(e){return Sh[e]=1});var Ch=function(e){hf(t,e);function t(t,n,r,i){var a;typeof n==`number`&&(r.duration=n,n=r,r=null),a=e.call(this,i?n:Ip(n))||this;var o=a.vars,s=o.duration,c=o.delay,l=o.immediateRender,u=o.stagger,d=o.overwrite,f=o.keyframes,p=o.defaults,m=o.scrollTrigger,h=n.parent||Jf,g=(Rf(t)||Lf(t)?jf(t[0]):`length`in n)?[t]:gm(t),_,v,y,b,x,S,C,w;if(a._targets=g.length?vp(g):rp(`GSAP target `+t+` not found. https://gsap.com`,!gf.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=d,f||u||If(s)||If(c)){n=a.vars;var T=n.easeReverse||n.yoyoEase;if(_=a.timeline=new lh({data:`nested`,defaults:p||{},targets:h&&h.data===`nested`?h.vars.targets:g}),_.kill(),_.parent=_._dp=mf(a),_._start=0,u||If(s)||If(c)){if(b=g.length,C=u&&ym(u),Nf(u))for(x in u)~xh.indexOf(x)&&(w||={},w[x]=u[x]);for(v=0;v<b;v++)y=Fp(n,Sh),y.stagger=0,T&&(y.easeReverse=T),w&&Np(y,w),S=g[v],y.duration=+bh(s,mf(a),v,S,g),y.delay=(+bh(c,mf(a),v,S,g)||0)-a._delay,!u&&b===1&&y.delay&&(a._delay=c=y.delay,a._start+=c,y.delay=0),_.to(S,y,C?C(v,S,g):0),_._ease=$.none;_.duration()?s=c=0:a.timeline=0}else if(f){Ip(jp(_.vars.defaults,{ease:`none`})),_._ease=nh(f.ease||n.ease||`none`);var E=0,D,O,k;if(Rf(f))f.forEach(function(e){return _.to(g,e,`>`)}),_.duration();else{for(x in y={},f)x===`ease`||x===`easeEach`||yh(x,f[x],y,f.easeEach);for(x in y)for(D=y[x].sort(function(e,t){return e.t-t.t}),E=0,v=0;v<D.length;v++)O=D[v],k={ease:O.e,duration:(O.t-(v?D[v-1].t:0))/100*s},k[x]=O.v,_.to(g,k,E),E+=k.duration;_.duration()<s&&_.to({},{duration:s-_.duration()})}}s||a.duration(s=_.duration())}else a.timeline=0;return d===!0&&!vf&&(mh=mf(a),Jf.killTweensOf(g),mh=0),Zp(h,mf(a),r),n.reversed&&a.reverse(),n.paused&&a.paused(!0),(l||!s&&!f&&a._start===Cp(h._time)&&Pf(l)&&Wp(mf(a))&&h.data!==`nested`)&&(a._tTime=-Sf,a.render(Math.max(0,-c)||0)),m&&Qp(mf(a),m),a}var n=t.prototype;return n.render=function(e,t,n){var r=this._time,i=this._tDur,a=this._dur,o=e<0,s=e>i-Sf&&!o?i:e<Sf?0:e,c,l,u,d,f,p,m,h;if(!a)nm(this,e,t,n);else if(s!==this._tTime||!e||n||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==o||this._lazy){if(c=s,h=this.timeline,this._repeat){if(d=a+this._rDelay,this._repeat<-1&&o)return this.totalTime(d*100+e,t,n);if(c=Cp(s%d),s===i?(u=this._repeat,c=a):(f=Cp(s/d),u=~~f,u&&u===f?(c=a,u--):c>a&&(c=a)),p=this._yoyo&&u&1,p&&(c=a-c),f=Kp(this._tTime,d),c===r&&!n&&this._initted&&u===f)return this._tTime=s,this;u!==f&&this.vars.repeatRefresh&&!p&&!this._lock&&c!==d&&this._initted&&(this._lock=n=1,this.render(Cp(d*u),!0).invalidate()._lock=0)}if(!this._initted){if($p(this,o?e:c,n,t,s))return this._tTime=0,this;if(r!==this._time&&!(n&&this.vars.repeatRefresh&&u!==f))return this;if(a!==this._dur)return this.render(e,t,n)}if(this._rEase){var g=c<r;if(g!==this._inv){var _=g?r:a-r;this._inv=g,this._from&&(this.ratio=1-this.ratio),this._invRatio=this.ratio,this._invTime=r,this._invRecip=_?(g?-1:1)/_:0,this._invScale=g?-this.ratio:1-this.ratio,this._invEase=g?this._rEase:this._ease}this.ratio=m=this._invRatio+this._invScale*this._invEase((c-this._invTime)*this._invRecip)}else this.ratio=m=this._ease(c/a);if(this._from&&(this.ratio=m=1-m),this._tTime=s,this._time=c,!this._act&&this._ts&&(this._act=1,this._lazy=0),!r&&s&&!t&&!f&&(Nm(this,`onStart`),this._tTime!==s))return this;for(l=this._pt;l;)l.r(m,l.d),l=l._next;h&&h.render(e<0?e:h._dur*h._ease(c/this._dur),t,n)||this._startAt&&(this._zTime=e),this._onUpdate&&!t&&(o&&Up(this,e,t,n),Nm(this,`onUpdate`)),this._repeat&&u!==f&&this.vars.onRepeat&&!t&&this.parent&&Nm(this,`onRepeat`),(s===this._tDur||!s)&&this._tTime===s&&(o&&!this._onUpdate&&Up(this,e,!0,!0),(e||!a)&&(s===this._tDur&&this._ts>0||!s&&this._ts<0)&&Bp(this,1),!t&&!(o&&!r)&&(s||r||p)&&(Nm(this,s===i?`onComplete`:`onReverseComplete`,!0),this._prom&&!(s<i&&this.timeScale()>0)&&this._prom()))}return this},n.targets=function(){return this._targets},n.invalidate=function(t){return(!t||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(t),e.prototype.invalidate.call(this,t)},n.resetTo=function(e,t,n,r,i){qm||Jm.wake(),this._ts||this.play();var a=Math.min(this._dur,(this._dp._time-this._start)*this._ts),o;return this._initted||gh(this,a),o=this._ease(a/this._dur),_h(this,e,t,n,r,o,a,i)?this.resetTo(e,t,n,r,1):(Yp(this,0),this.parent||Rp(this._dp,this,`_first`,`_last`,this._dp._sort?`_start`:0),this.render(0))},n.kill=function(e,t){if(t===void 0&&(t=`all`),!e&&(!t||t===`all`))return this._lazy=this._pt=0,this.parent?Pm(this):this.scrollTrigger&&this.scrollTrigger.kill(!!yf),this;if(this.timeline){var n=this.timeline.totalDuration();return this.timeline.killTweensOf(e,t,mh&&mh.vars.overwrite!==!0)._first||Pm(this),this.parent&&n!==this.timeline.totalDuration()&&im(this,this._dur*this.timeline._tDur/n,0,1),this}var r=this._targets,i=e?gm(e):r,a=this._ptLookup,o=this._pt,s,c,l,u,d,f,p;if((!t||t===`all`)&&Lp(r,i))return t===`all`&&(this._pt=0),Pm(this);for(s=this._op=this._op||[],t!==`all`&&(kf(t)&&(d={},xp(t,function(e){return d[e]=1}),t=d),t=vh(r,t)),p=r.length;p--;)if(~i.indexOf(r[p]))for(d in c=a[p],t===`all`?(s[p]=t,u=c,l={}):(l=s[p]=s[p]||{},u=t),u)f=c&&c[d],f&&((!(`kill`in f.d)||f.d.kill(d)===!0)&&zp(this,f,`_pt`),delete c[d]),l!==`all`&&(l[d]=1);return this._initted&&!this._pt&&o&&Pm(this),this},t.to=function(e,n){return new t(e,n,arguments[2])},t.from=function(e,t){return cm(1,arguments)},t.delayedCall=function(e,n,r,i){return new t(n,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:e,onComplete:n,onReverseComplete:n,onCompleteParams:r,onReverseCompleteParams:r,callbackScope:i})},t.fromTo=function(e,t,n){return cm(2,arguments)},t.set=function(e,n){return n.duration=0,n.repeatDelay||(n.repeat=0),new t(e,n)},t.killTweensOf=function(e,t,n){return Jf.killTweensOf(e,t,n)},t}(ch);jp(Ch.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0}),xp(`staggerTo,staggerFrom,staggerFromTo`,function(e){Ch[e]=function(){var t=new lh,n=pm.call(arguments,0);return n.splice(e===`staggerFromTo`?5:4,0,0),t[e].apply(t,n)}});var wh=function(e,t,n){return e[t]=n},Th=function(e,t,n){return e[t](n)},Eh=function(e,t,n,r){return e[t](r.fp,n)},Dh=function(e,t,n){return e.setAttribute(t,n)},Oh=function(e,t){return Af(e[t])?Th:Mf(e[t])&&e.setAttribute?Dh:wh},kh=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},Ah=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},jh=function(e,t){var n=t._pt,r=``;if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},Mh=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},Nh=function(e,t,n,r){for(var i=this._pt,a;i;)a=i._next,i.p===r&&i.modifier(e,t,n),i=a},Ph=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?zp(this,t,`_pt`):t.dep||(n=1),t=r;return!n},Fh=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},Ih=function(e){for(var t=e._pt,n,r,i,a;t;){for(n=t._next,r=i;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:a)?t._prev._next=t:i=t,(t._next=r)?r._prev=t:a=t,t=n}e._pt=i},Lh=function(){function e(e,t,n,r,i,a,o,s,c){this.t=t,this.s=r,this.c=i,this.p=n,this.r=a||kh,this.d=o||this,this.set=s||wh,this.pr=c||0,this._next=e,e&&(e._prev=this)}var t=e.prototype;return t.modifier=function(e,t,n){this.mSet=this.mSet||this.set,this.set=Fh,this.m=e,this.mt=n,this.tween=t},e}();xp(_p+`parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse`,function(e){return lp[e]=1}),Qf.TweenMax=Qf.TweenLite=Ch,Qf.TimelineLite=Qf.TimelineMax=lh,Jf=new lh({sortChildren:!1,defaults:_f,autoRemoveChildren:!0,id:`root`,smoothChildTiming:!0}),gf.stringFilter=Km;var Rh=[],zh={},Bh=[],Vh=0,Hh=0,Uh=function(e){return(zh[e]||Bh).map(function(e){return e()})},Wh=function(){var e=Date.now(),t=[];e-Vh>2&&(Uh(`matchMediaInit`),Rh.forEach(function(e){var n=e.queries,r=e.conditions,i,a,o,s;for(a in n)i=Yf.matchMedia(n[a]).matches,i&&(o=1),i!==r[a]&&(r[a]=i,s=1);s&&(e.revert(),o&&t.push(e))}),Uh(`matchMediaRevert`),t.forEach(function(e){return e.onMatch(e,function(t){return e.add(null,t)})}),Vh=e,Uh(`matchMedia`))},Gh=function(){function e(e,t){this.selector=t&&_m(t),this.data=[],this._r=[],this.isReverted=!1,this.id=Hh++,e&&this.add(e)}var t=e.prototype;return t.add=function(e,t,n){Af(e)&&(n=t,t=e,e=Af);var r=this,i=function(){var e=bf,i=r.selector,a;return e&&e!==r&&e.data.push(r),n&&(r.selector=_m(n)),bf=r,a=t.apply(r,arguments),Af(a)&&r._r.push(a),bf=e,r.selector=i,r.isReverted=!1,a};return r.last=i,e===Af?i(r,function(e){return r.add(null,e)}):e?r[e]=i:i},t.ignore=function(e){var t=bf;bf=null,e(this),bf=t},t.getTweens=function(){var t=[];return this.data.forEach(function(n){return n instanceof e?t.push.apply(t,n.getTweens()):n instanceof Ch&&!(n.parent&&n.parent.data===`nested`)&&t.push(n)}),t},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(e,t){var n=this;if(e?(function(){for(var t=n.getTweens(),r=n.data.length,i;r--;)i=n.data[r],i.data===`isFlip`&&(i.revert(),i.getChildren(!0,!0,!1).forEach(function(e){return t.splice(t.indexOf(e),1)}));for(t.map(function(e){return{g:e._dur||e._delay||e._sat&&!e._sat.vars.immediateRender?e.globalTime(0):-1/0,t:e}}).sort(function(e,t){return t.g-e.g||-1/0}).forEach(function(t){return t.t.revert(e)}),r=n.data.length;r--;)i=n.data[r],i instanceof lh?i.data!==`nested`&&(i.scrollTrigger&&i.scrollTrigger.revert(),i.kill()):!(i instanceof Ch)&&i.revert&&i.revert(e);n._r.forEach(function(t){return t(e,n)}),n.isReverted=!0})():this.data.forEach(function(e){return e.kill&&e.kill()}),this.clear(),t)for(var r=Rh.length;r--;)Rh[r].id===this.id&&Rh.splice(r,1)},t.revert=function(e){this.kill(e||{})},e}(),Kh=function(){function e(e){this.contexts=[],this.scope=e,bf&&bf.data.push(this)}var t=e.prototype;return t.add=function(e,t,n){Nf(e)||(e={matches:e});var r=new Gh(0,n||this.scope),i=r.conditions={},a,o,s;for(o in bf&&!r.selector&&(r.selector=bf.selector),this.contexts.push(r),t=r.add(`onMatch`,t),r.queries=e,e)o===`all`?s=1:(a=Yf.matchMedia(e[o]),a&&(Rh.indexOf(r)<0&&Rh.push(r),(i[o]=a.matches)&&(s=1),a.addListener?a.addListener(Wh):a.addEventListener(`change`,Wh)));return s&&t(r,function(e){return r.add(null,e)}),this},t.revert=function(e){this.kill(e||{})},t.kill=function(e){this.contexts.forEach(function(t){return t.kill(e,!0)})},e}(),qh={registerPlugin:function(){[...arguments].forEach(function(e){return Lm(e)})},timeline:function(e){return new lh(e)},getTweensOf:function(e,t){return Jf.getTweensOf(e,t)},getProperty:function(e,t,n,r){kf(e)&&(e=gm(e)[0]);var i=yp(e||{}).get,a=n?Ap:kp;return n===`native`&&(n=``),e&&(t?a((pp[t]&&pp[t].get||i)(e,t,n,r)):function(t,n,r){return a((pp[t]&&pp[t].get||i)(e,t,n,r))})},quickSetter:function(e,t,n){if(e=gm(e),e.length>1){var r=e.map(function(e){return Zh.quickSetter(e,t,n)}),i=r.length;return function(e){for(var t=i;t--;)r[t](e)}}e=e[0]||{};var a=pp[t],o=yp(e),s=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(t){var r=new a;Fm._pt=0,r.init(e,n?t+n:t,Fm,0,[e]),r.render(1,r),Fm._pt&&Mh(1,Fm)}:o.set(e,s);return a?c:function(t){return c(e,s,n?t+n:t,o,1)}},quickTo:function(e,t,n){var r,i=Zh.to(e,jp((r={},r[t]=`+=0.1`,r.paused=!0,r.stagger=0,r),n||{})),a=function(e,n,r){return i.resetTo(t,e,n,r)};return a.tween=i,a},isTweening:function(e){return Jf.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=nh(e.ease,_f.ease)),Pp(_f,e||{})},config:function(e){return Pp(gf,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,i=e.defaults,a=e.extendTimeline;(r||``).split(`,`).forEach(function(e){return e&&!pp[e]&&!Qf[e]&&rp(t+` effect requires `+e+` plugin.`)}),mp[t]=function(e,t,r){return n(gm(e),jp(t||{},i),r)},a&&(lh.prototype[t]=function(e,n,r){return this.add(mp[t](e,Nf(n)?n:(r=n)&&{},this),r)})},registerEase:function(e,t){$[e]=nh(t)},parseEase:function(e,t){return arguments.length?nh(e,t):$},getById:function(e){return Jf.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new lh(e),r,i;for(n.smoothChildTiming=Pf(e.smoothChildTiming),Jf.remove(n),n._dp=0,n._time=n._tTime=Jf._time,r=Jf._first;r;)i=r._next,(t||!(!r._dur&&r instanceof Ch&&r.vars.onComplete===r._targets[0]))&&Zp(n,r,r._start-r._delay),r=i;return Zp(Jf,n,0),n},context:function(e,t){return e?new Gh(e,t):bf},matchMedia:function(e){return new Kh(e)},matchMediaRefresh:function(){return Rh.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||Wh()},addEventListener:function(e,t){var n=zh[e]||(zh[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=zh[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:Dm,wrapYoyo:Om,distribute:ym,random:Sm,snap:xm,normalize:Tm,getUnit:dm,clamp:fm,splitColor:Vm,toArray:gm,selector:_m,mapRange:Am,pipe:Cm,unitize:wm,interpolate:jm,shuffle:vm},install:tp,effects:mp,ticker:Jm,updateRoot:lh.updateRoot,plugins:pp,globalTimeline:Jf,core:{PropTween:Lh,globals:ip,Tween:Ch,Timeline:lh,Animation:ch,getCache:yp,_removeLinkedListItem:zp,reverting:function(){return yf},context:function(e){return e&&bf&&(bf.data.push(e),e._ctx=bf),bf},suppressOverwrites:function(e){return vf=e}}};xp(`to,from,fromTo,delayedCall,set,killTweensOf`,function(e){return qh[e]=Ch[e]}),Jm.add(lh.updateRoot),Fm=qh.to({},{duration:0});var Jh=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},Yh=function(e,t){var n=e._targets,r,i,a;for(r in t)for(i=n.length;i--;)a=e._ptLookup[i][r],(a&&=a.d)&&(a._pt&&(a=Jh(a,r)),a&&a.modifier&&a.modifier(t[r],e,n[i],r))},Xh=function(e,t){return{name:e,headless:1,rawVars:1,init:function(e,n,r){r._onInit=function(e){var r,i;if(kf(n)&&(r={},xp(n,function(e){return r[e]=1}),n=r),t){for(i in r={},n)r[i]=t(n[i]);n=r}Yh(e,n)}}}},Zh=qh.registerPlugin({name:`attr`,init:function(e,t,n,r,i){var a,o,s;for(a in this.tween=n,t)s=e.getAttribute(a)||``,o=this.add(e,`setAttribute`,(s||0)+``,t[a],r,i,0,0,a),o.op=a,o.b=s,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)yf?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:`endArray`,headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Xh(`roundProps`,bm),Xh(`modifiers`),Xh(`snap`,xm))||qh;Ch.version=lh.version=Zh.version=`3.15.0`,ep=1,Ff()&&Ym(),$.Power0,$.Power1,$.Power2,$.Power3,$.Power4,$.Linear,$.Quad,$.Cubic,$.Quart,$.Quint,$.Strong,$.Elastic,$.Back,$.SteppedEase,$.Bounce,$.Sine,$.Expo,$.Circ;var Qh,$h,eg,tg,ng,rg,ig,ag=function(){return typeof window<`u`},og={},sg=180/Math.PI,cg=Math.PI/180,lg=Math.atan2,ug=1e8,dg=/([A-Z])/g,fg=/(left|right|width|margin|padding|x)/i,pg=/[\s,\(]\S/,mg={autoAlpha:`opacity,visibility`,scale:`scaleX,scaleY`,alpha:`opacity`},hg=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},gg=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},_g=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},vg=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},yg=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},bg=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},xg=function(e,t){return t.set(t.t,t.p,e===1?t.e:t.b,t)},Sg=function(e,t,n){return e.style[t]=n},Cg=function(e,t,n){return e.style.setProperty(t,n)},wg=function(e,t,n){return e._gsap[t]=n},Tg=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Eg=function(e,t,n,r,i){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(i,a)},Dg=function(e,t,n,r,i){var a=e._gsap;a[t]=n,a.renderTransform(i,a)},Og=`transform`,kg=Og+`Origin`,Ag=function e(t,n){var r=this,i=this.target,a=i.style,o=i._gsap;if(t in og&&a){if(this.tfm=this.tfm||{},t!==`transform`)t=mg[t]||t,~t.indexOf(`,`)?t.split(`,`).forEach(function(e){return r.tfm[e]=Yg(i,e)}):this.tfm[t]=o.x?o[t]:Yg(i,t),t===kg&&(this.tfm.zOrigin=o.zOrigin);else return mg.transform.split(`,`).forEach(function(t){return e.call(r,t,n)});if(this.props.indexOf(Og)>=0)return;o.svg&&(this.svgo=i.getAttribute(`data-svg-origin`),this.props.push(kg,n,``)),t=Og}(a||n)&&this.props.push(t,n,a[t])},jg=function(e){e.translate&&(e.removeProperty(`translate`),e.removeProperty(`scale`),e.removeProperty(`rotate`))},Mg=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,i,a;for(i=0;i<e.length;i+=3)e[i+1]?e[i+1]===2?t[e[i]](e[i+2]):t[e[i]]=e[i+2]:e[i+2]?n[e[i]]=e[i+2]:n.removeProperty(e[i].substr(0,2)===`--`?e[i]:e[i].replace(dg,`-$1`).toLowerCase());if(this.tfm){for(a in this.tfm)r[a]=this.tfm[a];r.svg&&(r.renderTransform(),t.setAttribute(`data-svg-origin`,this.svgo||``)),i=ig(),(!i||!i.isStart)&&!n[Og]&&(jg(n),r.zOrigin&&n[kg]&&(n[kg]+=` `+r.zOrigin+`px`,r.zOrigin=0,r.renderTransform()),r.uncache=1)}},Ng=function(e,t){var n={target:e,props:[],revert:Mg,save:Ag};return e._gsap||Zh.core.getCache(e),t&&e.style&&e.nodeType&&t.split(`,`).forEach(function(e){return n.save(e)}),n},Pg,Fg=function(e,t){var n=$h.createElementNS?$h.createElementNS((t||`http://www.w3.org/1999/xhtml`).replace(/^https/,`http`),e):$h.createElement(e);return n&&n.style?n:$h.createElement(e)},Ig=function e(t,n,r){var i=getComputedStyle(t);return i[n]||i.getPropertyValue(n.replace(dg,`-$1`).toLowerCase())||i.getPropertyValue(n)||!r&&e(t,Rg(n)||n,1)||``},Lg=`O,Moz,ms,Ms,Webkit`.split(`,`),Rg=function(e,t,n){var r=(t||ng).style,i=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);i--&&!(Lg[i]+e in r););return i<0?null:(i===3?`ms`:i>=0?Lg[i]:``)+e},zg=function(){ag()&&window.document&&(Qh=window,$h=Qh.document,eg=$h.documentElement,ng=Fg(`div`)||{style:{}},Fg(`div`),Og=Rg(Og),kg=Og+`Origin`,ng.style.cssText=`border-width:0;line-height:0;position:absolute;padding:0`,Pg=!!Rg(`perspective`),ig=Zh.core.reverting,tg=1)},Bg=function(e){var t=e.ownerSVGElement,n=Fg(`svg`,t&&t.getAttribute(`xmlns`)||`http://www.w3.org/2000/svg`),r=e.cloneNode(!0),i;r.style.display=`block`,n.appendChild(r),eg.appendChild(n);try{i=r.getBBox()}catch{}return n.removeChild(r),eg.removeChild(n),i},Vg=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Hg=function(e){var t,n;try{t=e.getBBox()}catch{t=Bg(e),n=1}return t&&(t.width||t.height)||n||(t=Bg(e)),t&&!t.width&&!t.x&&!t.y?{x:+Vg(e,[`x`,`cx`,`x1`])||0,y:+Vg(e,[`y`,`cy`,`y1`])||0,width:0,height:0}:t},Ug=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Hg(e))},Wg=function(e,t){if(t){var n=e.style,r;t in og&&t!==kg&&(t=Og),n.removeProperty?(r=t.substr(0,2),(r===`ms`||t.substr(0,6)===`webkit`)&&(t=`-`+t),n.removeProperty(r===`--`?t:t.replace(dg,`-$1`).toLowerCase())):n.removeAttribute(t)}},Gg=function(e,t,n,r,i,a){var o=new Lh(e._pt,t,n,0,1,a?xg:bg);return e._pt=o,o.b=r,o.e=i,e._props.push(n),o},Kg={deg:1,rad:1,turn:1},qg={grid:1,flex:1},Jg=function e(t,n,r,i){var a=parseFloat(r)||0,o=(r+``).trim().substr((a+``).length)||`px`,s=ng.style,c=fg.test(n),l=t.tagName.toLowerCase()===`svg`,u=(l?`client`:`offset`)+(c?`Width`:`Height`),d=100,f=i===`px`,p=i===`%`,m,h,g,_;if(i===o||!a||Kg[i]||Kg[o])return a;if(o!==`px`&&!f&&(a=e(t,n,r,`px`)),_=t.getCTM&&Ug(t),(p||o===`%`)&&(og[n]||~n.indexOf(`adius`)))return m=_?t.getBBox()[c?`width`:`height`]:t[u],Sp(p?a/m*d:a/100*m);if(s[c?`width`:`height`]=d+(f?o:i),h=i!==`rem`&&~n.indexOf(`adius`)||i===`em`&&t.appendChild&&!l?t:t.parentNode,_&&(h=(t.ownerSVGElement||{}).parentNode),(!h||h===$h||!h.appendChild)&&(h=$h.body),g=h._gsap,g&&p&&g.width&&c&&g.time===Jm.time&&!g.uncache)return Sp(a/g.width*d);if(p&&(n===`height`||n===`width`)){var v=t.style[n];t.style[n]=d+i,m=t[u],v?t.style[n]=v:Wg(t,n)}else(p||o===`%`)&&!qg[Ig(h,`display`)]&&(s.position=Ig(t,`position`)),h===t&&(s.position=`static`),h.appendChild(ng),m=ng[u],h.removeChild(ng),s.position=`absolute`;return c&&p&&(g=yp(h),g.time=Jm.time,g.width=h[u]),Sp(f?m*a/d:m&&a?d/m*a:0)},Yg=function(e,t,n,r){var i;return tg||zg(),t in mg&&t!==`transform`&&(t=mg[t],~t.indexOf(`,`)&&(t=t.split(`,`)[0])),og[t]&&t!==`transform`?(i=s_(e,r),i=t===`transformOrigin`?i.svg?i.origin:c_(Ig(e,kg))+` `+i.zOrigin+`px`:i[t]):(i=e.style[t],(!i||i===`auto`||r||~(i+``).indexOf(`calc(`))&&(i=e_[t]&&e_[t](e,t,n)||Ig(e,t)||bp(e,t)||+(t===`opacity`))),n&&!~(i+``).trim().indexOf(` `)?Jg(e,t,i,n)+n:i},Xg=function(e,t,n,r){if(!n||n===`none`){var i=Rg(t,e,1),a=i&&Ig(e,i,1);a&&a!==n?(t=i,n=a):t===`borderColor`&&(n=Ig(e,`borderTopColor`))}var o=new Lh(this._pt,e.style,t,0,1,jh),s=0,c=0,l,u,d,f,p,m,h,g,_,v,y,b;if(o.b=n,o.e=r,n+=``,r+=``,r.substring(0,6)===`var(--`&&(r=Ig(e,r.substring(4,r.indexOf(`)`)))),r===`auto`&&(m=e.style[t],e.style[t]=r,r=Ig(e,t)||r,m?e.style[t]=m:Wg(e,t)),l=[n,r],Km(l),n=l[0],r=l[1],d=n.match(Uf)||[],b=r.match(Uf)||[],b.length){for(;u=Uf.exec(r);)h=u[0],_=r.substring(s,u.index),p?p=(p+1)%5:(_.substr(-5)===`rgba(`||_.substr(-5)===`hsla(`)&&(p=1),h!==(m=d[c++]||``)&&(f=parseFloat(m)||0,y=m.substr((f+``).length),h.charAt(1)===`=`&&(h=wp(f,h)+y),g=parseFloat(h),v=h.substr((g+``).length),s=Uf.lastIndex-v.length,v||(v=v||gf.units[t]||y,s===r.length&&(r+=v,o.e+=v)),y!==v&&(f=Jg(e,t,m,v)||0),o._pt={_next:o._pt,p:_||c===1?_:`,`,s:f,c:g-f,m:p&&p<4||t===`zIndex`?Math.round:0});o.c=s<r.length?r.substring(s,r.length):``}else o.r=t===`display`&&r===`none`?xg:bg;return Gf.test(r)&&(o.e=0),this._pt=o,o},Zg={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},Qg=function(e){var t=e.split(` `),n=t[0],r=t[1]||`50%`;return(n===`top`||n===`bottom`||r===`left`||r===`right`)&&(e=n,n=r,r=e),t[0]=Zg[n]||n,t[1]=Zg[r]||r,t.join(` `)},$g=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,i=t.u,a=n._gsap,o,s,c;if(i===`all`||i===!0)r.cssText=``,s=1;else for(i=i.split(`,`),c=i.length;--c>-1;)o=i[c],og[o]&&(s=1,o=o===`transformOrigin`?kg:Og),Wg(n,o);s&&(Wg(n,Og),a&&(a.svg&&n.removeAttribute(`transform`),r.scale=r.rotate=r.translate=`none`,s_(n,1),a.uncache=1,jg(r)))}},e_={clearProps:function(e,t,n,r,i){if(i.data!==`isFromStart`){var a=e._pt=new Lh(e._pt,t,n,0,0,$g);return a.u=r,a.pr=-10,a.tween=i,e._props.push(n),1}}},t_=[1,0,0,1,0,0],n_={},r_=function(e){return e===`matrix(1, 0, 0, 1, 0, 0)`||e===`none`||!e},i_=function(e){var t=Ig(e,Og);return r_(t)?t_:t.substr(7).match(Hf).map(Sp)},a_=function(e,t){var n=e._gsap||yp(e),r=e.style,i=i_(e),a,o,s,c;return n.svg&&e.getAttribute(`transform`)?(s=e.transform.baseVal.consolidate().matrix,i=[s.a,s.b,s.c,s.d,s.e,s.f],i.join(`,`)===`1,0,0,1,0,0`?t_:i):(i===t_&&!e.offsetParent&&e!==eg&&!n.svg&&(s=r.display,r.display=`block`,a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,eg.appendChild(e)),i=i_(e),s?r.display=s:Wg(e,`display`),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):eg.removeChild(e))),t&&i.length>6?[i[0],i[1],i[4],i[5],i[12],i[13]]:i)},o_=function(e,t,n,r,i,a){var o=e._gsap,s=i||a_(e,!0),c=o.xOrigin||0,l=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=s[0],p=s[1],m=s[2],h=s[3],g=s[4],_=s[5],v=t.split(` `),y=parseFloat(v[0])||0,b=parseFloat(v[1])||0,x,S,C,w;n?s!==t_&&(S=f*h-p*m)&&(C=h/S*y+b*(-m/S)+(m*_-h*g)/S,w=y*(-p/S)+f/S*b-(f*_-p*g)/S,y=C,b=w):(x=Hg(e),y=x.x+(~v[0].indexOf(`%`)?y/100*x.width:y),b=x.y+(~(v[1]||v[0]).indexOf(`%`)?b/100*x.height:b)),r||r!==!1&&o.smooth?(g=y-c,_=b-l,o.xOffset=u+(g*f+_*m)-g,o.yOffset=d+(g*p+_*h)-_):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=b,o.smooth=!!r,o.origin=t,o.originIsAbsolute=!!n,e.style[kg]=`0px 0px`,a&&(Gg(a,o,`xOrigin`,c,y),Gg(a,o,`yOrigin`,l,b),Gg(a,o,`xOffset`,u,o.xOffset),Gg(a,o,`yOffset`,d,o.yOffset)),e.setAttribute(`data-svg-origin`,y+` `+b)},s_=function(e,t){var n=e._gsap||new sh(e);if(`x`in n&&!t&&!n.uncache)return n;var r=e.style,i=n.scaleX<0,a=`px`,o=`deg`,s=getComputedStyle(e),c=Ig(e,kg)||`0`,l=u=d=m=h=g=_=v=y=0,u,d,f=p=1,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,ee,P,F,te,ne,re,ie;return n.svg=!!(e.getCTM&&Ug(e)),s.translate&&((s.translate!==`none`||s.scale!==`none`||s.rotate!==`none`)&&(r[Og]=(s.translate===`none`?``:`translate3d(`+(s.translate+` 0 0`).split(` `).slice(0,3).join(`, `)+`) `)+(s.rotate===`none`?``:`rotate(`+s.rotate+`) `)+(s.scale===`none`?``:`scale(`+s.scale.split(` `).join(`,`)+`) `)+(s[Og]===`none`?``:s[Og])),r.scale=r.rotate=r.translate=`none`),S=a_(e,n.svg),n.svg&&(n.uncache?(N=e.getBBox(),c=n.xOrigin-N.x+`px `+(n.yOrigin-N.y)+`px`,M=``):M=!t&&e.getAttribute(`data-svg-origin`),o_(e,M||c,!!M||n.originIsAbsolute,n.smooth!==!1,S)),b=n.xOrigin||0,x=n.yOrigin||0,S!==t_&&(E=S[0],D=S[1],O=S[2],k=S[3],l=A=S[4],u=j=S[5],S.length===6?(f=Math.sqrt(E*E+D*D),p=Math.sqrt(k*k+O*O),m=E||D?lg(D,E)*sg:0,_=O||k?lg(O,k)*sg+m:0,_&&(p*=Math.abs(Math.cos(_*cg))),n.svg&&(l-=b-(b*E+x*O),u-=x-(b*D+x*k))):(ie=S[6],ne=S[7],P=S[8],F=S[9],te=S[10],re=S[11],l=S[12],u=S[13],d=S[14],C=lg(ie,te),h=C*sg,C&&(w=Math.cos(-C),T=Math.sin(-C),M=A*w+P*T,N=j*w+F*T,ee=ie*w+te*T,P=A*-T+P*w,F=j*-T+F*w,te=ie*-T+te*w,re=ne*-T+re*w,A=M,j=N,ie=ee),C=lg(-O,te),g=C*sg,C&&(w=Math.cos(-C),T=Math.sin(-C),M=E*w-P*T,N=D*w-F*T,ee=O*w-te*T,re=k*T+re*w,E=M,D=N,O=ee),C=lg(D,E),m=C*sg,C&&(w=Math.cos(C),T=Math.sin(C),M=E*w+D*T,N=A*w+j*T,D=D*w-E*T,j=j*w-A*T,E=M,A=N),h&&Math.abs(h)+Math.abs(m)>359.9&&(h=m=0,g=180-g),f=Sp(Math.sqrt(E*E+D*D+O*O)),p=Sp(Math.sqrt(j*j+ie*ie)),C=lg(A,j),_=Math.abs(C)>2e-4?C*sg:0,y=re?1/(re<0?-re:re):0),n.svg&&(M=e.getAttribute(`transform`),n.forceCSS=e.setAttribute(`transform`,``)||!r_(Ig(e,Og)),M&&e.setAttribute(`transform`,M))),Math.abs(_)>90&&Math.abs(_)<270&&(i?(f*=-1,_+=m<=0?180:-180,m+=m<=0?180:-180):(p*=-1,_+=_<=0?180:-180)),t||=n.uncache,n.x=l-((n.xPercent=l&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-l)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=Sp(f),n.scaleY=Sp(p),n.rotation=Sp(m)+o,n.rotationX=Sp(h)+o,n.rotationY=Sp(g)+o,n.skewX=_+o,n.skewY=v+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(c.split(` `)[2])||!t&&n.zOrigin||0)&&(r[kg]=c_(c)),n.xOffset=n.yOffset=0,n.force3D=gf.force3D,n.renderTransform=n.svg?h_:Pg?m_:u_,n.uncache=0,n},c_=function(e){return(e=e.split(` `))[0]+` `+e[1]},l_=function(e,t,n){var r=dm(t);return Sp(parseFloat(t)+parseFloat(Jg(e,`x`,n+`px`,r)))+r},u_=function(e,t){t.z=`0px`,t.rotationY=t.rotationX=`0deg`,t.force3D=0,m_(e,t)},d_=`0deg`,f_=`0px`,p_=`) `,m_=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.z,c=n.rotation,l=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,p=n.scaleX,m=n.scaleY,h=n.transformPerspective,g=n.force3D,_=n.target,v=n.zOrigin,y=``,b=g===`auto`&&e&&e!==1||g===!0;if(v&&(u!==d_||l!==d_)){var x=parseFloat(l)*cg,S=Math.sin(x),C=Math.cos(x),w;x=parseFloat(u)*cg,w=Math.cos(x),a=l_(_,a,S*w*-v),o=l_(_,o,-Math.sin(x)*-v),s=l_(_,s,C*w*-v+v)}h!==f_&&(y+=`perspective(`+h+p_),(r||i)&&(y+=`translate(`+r+`%, `+i+`%) `),(b||a!==f_||o!==f_||s!==f_)&&(y+=s!==f_||b?`translate3d(`+a+`, `+o+`, `+s+`) `:`translate(`+a+`, `+o+p_),c!==d_&&(y+=`rotate(`+c+p_),l!==d_&&(y+=`rotateY(`+l+p_),u!==d_&&(y+=`rotateX(`+u+p_),(d!==d_||f!==d_)&&(y+=`skew(`+d+`, `+f+p_),(p!==1||m!==1)&&(y+=`scale(`+p+`, `+m+p_),_.style[Og]=y||`translate(0, 0)`},h_=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.rotation,c=n.skewX,l=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,p=n.xOrigin,m=n.yOrigin,h=n.xOffset,g=n.yOffset,_=n.forceCSS,v=parseFloat(a),y=parseFloat(o),b,x,S,C,w;s=parseFloat(s),c=parseFloat(c),l=parseFloat(l),l&&(l=parseFloat(l),c+=l,s+=l),s||c?(s*=cg,c*=cg,b=Math.cos(s)*u,x=Math.sin(s)*u,S=Math.sin(s-c)*-d,C=Math.cos(s-c)*d,c&&(l*=cg,w=Math.tan(c-l),w=Math.sqrt(1+w*w),S*=w,C*=w,l&&(w=Math.tan(l),w=Math.sqrt(1+w*w),b*=w,x*=w)),b=Sp(b),x=Sp(x),S=Sp(S),C=Sp(C)):(b=u,C=d,x=S=0),(v&&!~(a+``).indexOf(`px`)||y&&!~(o+``).indexOf(`px`))&&(v=Jg(f,`x`,a,`px`),y=Jg(f,`y`,o,`px`)),(p||m||h||g)&&(v=Sp(v+p-(p*b+m*S)+h),y=Sp(y+m-(p*x+m*C)+g)),(r||i)&&(w=f.getBBox(),v=Sp(v+r/100*w.width),y=Sp(y+i/100*w.height)),w=`matrix(`+b+`,`+x+`,`+S+`,`+C+`,`+v+`,`+y+`)`,f.setAttribute(`transform`,w),_&&(f.style[Og]=w)},g_=function(e,t,n,r,i){var a=360,o=kf(i),s=parseFloat(i)*(o&&~i.indexOf(`rad`)?sg:1)-r,c=r+s+`deg`,l,u;return o&&(l=i.split(`_`)[1],l===`short`&&(s%=a,s!==s%(a/2)&&(s+=s<0?a:-a)),l===`cw`&&s<0?s=(s+a*ug)%a-~~(s/a)*a:l===`ccw`&&s>0&&(s=(s-a*ug)%a-~~(s/a)*a)),e._pt=u=new Lh(e._pt,t,n,r,s,gg),u.e=c,u.u=`deg`,e._props.push(n),u},__=function(e,t){for(var n in t)e[n]=t[n];return e},v_=function(e,t,n){var r=__({},n._gsap),i=`perspective,force3D,transformOrigin,svgOrigin`,a=n.style,o,s,c,l,u,d,f,p;for(s in r.svg?(c=n.getAttribute(`transform`),n.setAttribute(`transform`,``),a[Og]=t,o=s_(n,1),Wg(n,Og),n.setAttribute(`transform`,c)):(c=getComputedStyle(n)[Og],a[Og]=t,o=s_(n,1),a[Og]=c),og)c=r[s],l=o[s],c!==l&&i.indexOf(s)<0&&(f=dm(c),p=dm(l),u=f===p?parseFloat(c):Jg(n,s,c,p),d=parseFloat(l),e._pt=new Lh(e._pt,o,s,u,d-u,hg),e._pt.u=p||0,e._props.push(s));__(o,r)};xp(`padding,margin,Width,Radius`,function(e,t){var n=`Top`,r=`Right`,i=`Bottom`,a=`Left`,o=(t<3?[n,r,i,a]:[n+a,n+r,i+r,i+a]).map(function(n){return t<2?e+n:`border`+n+e});e_[t>1?`border`+e:e]=function(e,t,n,r,i){var a,s;if(arguments.length<4)return a=o.map(function(t){return Yg(e,t,n)}),s=a.join(` `),s.split(a[0]).length===5?a[0]:s;a=(r+``).split(` `),s={},o.forEach(function(e,t){return s[e]=a[t]=a[t]||a[(t-1)/2|0]}),e.init(t,s,i)}});var y_={name:`css`,register:zg,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,i){var a=this._props,o=e.style,s=n.vars.startAt,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;for(m in tg||zg(),this.styles=this.styles||Ng(e),C=this.styles.props,this.tween=n,t)if(m!==`autoRound`&&(l=t[m],!(pp[m]&&ph(m,t,n,r,e,i)))){if(f=typeof l,p=e_[m],f===`function`&&(l=l.call(n,r,e,i),f=typeof l),f===`string`&&~l.indexOf(`random(`)&&(l=km(l)),p)p(this,e,m,l,n)&&(S=1);else if(m.substr(0,2)===`--`)c=(getComputedStyle(e).getPropertyValue(m)+``).trim(),l+=``,Wm.lastIndex=0,Wm.test(c)||(h=dm(c),g=dm(l),g?h!==g&&(c=Jg(e,m,c,g)+g):h&&(l+=h)),this.add(o,`setProperty`,c,l,r,i,0,0,m),a.push(m),C.push(m,0,o[m]);else if(f!==`undefined`){if(s&&m in s?(c=typeof s[m]==`function`?s[m].call(n,r,e,i):s[m],kf(c)&&~c.indexOf(`random(`)&&(c=km(c)),dm(c+``)||c===`auto`||(c+=gf.units[m]||dm(Yg(e,m))||``),(c+``).charAt(1)===`=`&&(c=Yg(e,m))):c=Yg(e,m),d=parseFloat(c),_=f===`string`&&l.charAt(1)===`=`&&l.substr(0,2),_&&(l=l.substr(2)),u=parseFloat(l),m in mg&&(m===`autoAlpha`&&(d===1&&Yg(e,`visibility`)===`hidden`&&u&&(d=0),C.push(`visibility`,0,o.visibility),Gg(this,o,`visibility`,d?`inherit`:`hidden`,u?`inherit`:`hidden`,!u)),m!==`scale`&&m!==`transform`&&(m=mg[m],~m.indexOf(`,`)&&(m=m.split(`,`)[0]))),v=m in og,v){if(this.styles.save(m),w=l,f===`string`&&l.substring(0,6)===`var(--`){if(l=Ig(e,l.substring(4,l.indexOf(`)`))),l.substring(0,5)===`calc(`){var T=e.style.perspective;e.style.perspective=l,l=Ig(e,`perspective`),T?e.style.perspective=T:Wg(e,`perspective`)}u=parseFloat(l)}if(y||(b=e._gsap,b.renderTransform&&!t.parseTransform||s_(e,t.parseTransform),x=t.smoothOrigin!==!1&&b.smooth,y=this._pt=new Lh(this._pt,o,Og,0,1,b.renderTransform,b,0,-1),y.dep=1),m===`scale`)this._pt=new Lh(this._pt,b,`scaleY`,b.scaleY,(_?wp(b.scaleY,_+u):u)-b.scaleY||0,hg),this._pt.u=0,a.push(`scaleY`,m),m+=`X`;else if(m===`transformOrigin`){C.push(kg,0,o[kg]),l=Qg(l),b.svg?o_(e,l,0,x,0,this):(g=parseFloat(l.split(` `)[2])||0,g!==b.zOrigin&&Gg(this,b,`zOrigin`,b.zOrigin,g),Gg(this,o,m,c_(c),c_(l)));continue}else if(m===`svgOrigin`){o_(e,l,1,x,0,this);continue}else if(m in n_){g_(this,b,m,d,_?wp(d,_+l):l);continue}else if(m===`smoothOrigin`){Gg(this,b,`smooth`,b.smooth,l);continue}else if(m===`force3D`){b[m]=l;continue}else if(m===`transform`){v_(this,l,e);continue}}else m in o||(m=Rg(m)||m);if(v||(u||u===0)&&(d||d===0)&&!pg.test(l)&&m in o)h=(c+``).substr((d+``).length),u||=0,g=dm(l)||(m in gf.units?gf.units[m]:h),h!==g&&(d=Jg(e,m,c,g)),this._pt=new Lh(this._pt,v?b:o,m,d,(_?wp(d,_+u):u)-d,!v&&(g===`px`||m===`zIndex`)&&t.autoRound!==!1?yg:hg),this._pt.u=g||0,v&&w!==l?(this._pt.b=c,this._pt.e=w,this._pt.r=vg):h!==g&&g!==`%`&&(this._pt.b=c,this._pt.r=_g);else if(m in o)Xg.call(this,e,m,c,_?_+l:l);else if(m in e)this.add(e,m,c||e[m],_?_+l:l,r,i);else if(m!==`parseTransform`){np(m,l);continue}v||(m in o?C.push(m,0,o[m]):typeof e[m]==`function`?C.push(m,2,e[m]()):C.push(m,1,c||e[m])),a.push(m)}}S&&Ih(this)},render:function(e,t){if(t.tween._time||!ig())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Yg,aliases:mg,getSetter:function(e,t,n){var r=mg[t];return r&&r.indexOf(`,`)<0&&(t=r),t in og&&t!==kg&&(e._gsap.x||Yg(e,`x`))?n&&rg===n?t===`scale`?Tg:wg:(rg=n||{})&&(t===`scale`?Eg:Dg):e.style&&!Mf(e.style[t])?Sg:~t.indexOf(`-`)?Cg:Oh(e,t)},core:{_removeProperty:Wg,_getMatrix:a_}};Zh.utils.checkPrefix=Rg,Zh.core.getStyleSaver=Ng,(function(e,t,n,r){var i=xp(e+`,`+t+`,`+n,function(e){og[e]=1});xp(t,function(e){gf.units[e]=`deg`,n_[e]=1}),mg[i[13]]=e+`,`+t,xp(r,function(e){var t=e.split(`:`);mg[t[1]]=i[t[0]]})})(`x,y,z,scale,scaleX,scaleY,xPercent,yPercent`,`rotation,rotationX,rotationY,skewX,skewY`,`transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective`,`0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY`),xp(`x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective`,function(e){gf.units[e]=`px`}),Zh.registerPlugin(y_);var b_=Zh.registerPlugin(y_)||Zh;b_.core.Tween;var x_=`3d`,S_=null,C_=null,w_=null,T_=null,E_=[],D_=!1,O_=.04,k_={w:!1,a:!1,s:!1,d:!1,q:!1,e:!1,shift:!1},A_=new pf,j_=new Jd(new G(0,.35,0),new G(0,1.35,0),.35),M_=document.getElementById(`canvas-container`),N_=document.getElementById(`hotspot-overlay`),P_=document.getElementById(`loading-overlay`),F_=P_.querySelector(`.loading-text`),I_=document.getElementById(`room-badge`),L_=document.getElementById(`nav-panel`),R_=document.getElementById(`btn-mode-3d`),z_=document.getElementById(`btn-mode-pano`),B_=document.getElementById(`info-modal`),V_=document.getElementById(`info-title`),H_=document.getElementById(`info-body`),U_=document.getElementById(`info-close`);I_.textContent=`Interactive Showcase`;var W_=()=>{x_===`3d`?L_.innerHTML=`
    ...
    `};W_();var G_=new Fn;G_.background=new Y(657935),G_.fog=new Pn(657935,.015);var K_=new mo(60,window.innerWidth/window.innerHeight,.1,5e3);K_.position.set(0,1.8,5);var q_=new hu({antialias:!0,powerPreference:`high-performance`});q_.setPixelRatio(Math.min(window.devicePixelRatio,2)),q_.setSize(window.innerWidth,window.innerHeight),q_.shadowMap.enabled=!0,q_.shadowMap.type=1,q_.outputColorSpace=ze,q_.xr.enabled=!0,M_.appendChild(q_.domElement),document.body.appendChild(qd.createButton(q_));var J_=new Eu(K_,q_.domElement);J_.enableDamping=!0,J_.dampingFactor=.05,J_.enablePan=!0,J_.panSpeed=2.5,J_.target.set(0,1.8,4.95),J_.update();var Y_=new la(50,60,40);Y_.scale(-1,1,1),T_=new Ur({color:16777215,transparent:!0,opacity:1}),w_=new ti(Y_,T_),w_.visible=!1,G_.add(w_),new $a().load(`/DEMO/assets/panoramas/dining_room_360.jpg`,e=>{e.colorSpace=ze,T_.map=e,T_.needsUpdate=!0},void 0,e=>{console.error(`Error loading 360 panorama image:`,e)});var X_=new En;G_.add(X_);var Z_=new So(16777215,.6);X_.add(Z_);var Q_=new to(16777215,4473924,1.2);X_.add(Q_);var $_=new xo(16777215,.8);$_.position.set(10,20,10),$_.castShadow=!0,$_.shadow.mapSize.width=2048,$_.shadow.mapSize.height=2048,$_.shadow.bias=-1e-4,X_.add($_);var ev=new xo(3900150,.3);ev.position.set(-10,10,-10),X_.add(ev),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&(k_.w=!0),(t===`s`||t===`arrowdown`)&&(k_.s=!0),(t===`a`||t===`arrowleft`)&&(k_.a=!0),(t===`d`||t===`arrowright`)&&(k_.d=!0),t===`q`&&(k_.q=!0),t===`e`&&(k_.e=!0),e.key===`Shift`&&(k_.shift=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&(k_.w=!1),(t===`s`||t===`arrowdown`)&&(k_.s=!1),(t===`a`||t===`arrowleft`)&&(k_.a=!1),(t===`d`||t===`arrowright`)&&(k_.d=!1),t===`q`&&(k_.q=!1),t===`e`&&(k_.e=!1),e.key===`Shift`&&(k_.shift=!1)}),U_.addEventListener(`click`,ov);function tv(e,t,n){if(D_)return;D_=!0,J_.enabled=!1,ov();let r=b_.timeline({onComplete:()=>{let e=new G;K_.getWorldDirection(e),J_.target.copy(K_.position).add(e.multiplyScalar(.05)),J_.update(),J_.enabled=!0,D_=!1,n&&n()}});r.to(K_.position,{x:e.x,y:e.y,z:e.z,duration:1.5,ease:`power2.inOut`}),r.to(J_.target,{x:t.x,y:t.y,z:t.z,duration:1.5,ease:`power2.inOut`},`<`)}function nv(e,t,n=40){let r=kt.degToRad(90-t),i=kt.degToRad(e);return new G(n*Math.sin(r)*Math.sin(i),n*Math.cos(r),n*Math.sin(r)*Math.cos(i))}function rv(e){let t=document.createElement(`div`);t.className=`hotspot hotspot-info`;let n=document.createElement(`div`);n.className=`hotspot-icon`,n.innerHTML=`i`,t.appendChild(n);let r=document.createElement(`div`);r.className=`hotspot-tooltip`,r.textContent=e.title,t.appendChild(r),t.addEventListener(`click`,()=>{e.isPanoHotspot?av(e.title,e.content):tv(e.camPos,e.lookTarget,()=>{av(e.title,e.content)})}),N_.appendChild(t),E_.push({element:t,pos3D:e.pos3D})}function iv(){let e=new G;E_.forEach(t=>{if(e.copy(t.pos3D),e.project(K_),e.z>1)t.element.style.display=`none`;else{let n=(e.x*.5+.5)*window.innerWidth,r=(e.y*-.5+.5)*window.innerHeight;t.element.style.display=`block`,t.element.style.transform=`translate(-50%, -50%) translate(${n}px, ${r}px)`}})}function av(e,t){V_.textContent=e,H_.innerHTML=t,B_.classList.add(`active`)}function ov(){B_.classList.remove(`active`)}var sv=new Gd;sv.setDecoderPath(`/DEMO/assets/libs/draco/gltf/`);var cv=new Hu;cv.setDRACOLoader(sv),P_.style.display=`flex`,P_.style.opacity=`1`,cv.load(`/DEMO/assets/models/dining_room_kitchen.glb`,e=>{S_=e.scene,S_.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material&&(e.material.roughness=Math.max(e.material.roughness,.3),e.material.map&&(e.material.map.colorSpace=ze)))});let t=new Xn().setFromObject(S_),n=t.getCenter(new G),r=t.getSize(new G),i=r.length();C_=t.clone(),C_.expandByScalar(-.5),O_=Math.max(.04,i*8e-5),console.log(`Calibrated Base Speed: ${O_.toFixed(4)} units/frame based on size: ${i.toFixed(1)}m`),G_.fog&&(G_.fog.density=Math.min(.015,3/i),console.log(`Calibrated Fog Density: ${G_.fog.density.toFixed(5)}`)),$_.position.set(n.x+r.x*.5,n.y+r.y+i*.5,n.z+r.z*.5),$_.shadow.camera.left=-i*.6,$_.shadow.camera.right=i*.6,$_.shadow.camera.top=i*.6,$_.shadow.camera.bottom=-i*.6,$_.shadow.camera.far=i*2,$_.shadow.camera.updateProjectionMatrix(),A_.fromGraphNode(S_),console.log(`Collision Octree successfully built from model graph!`),x_===`3d`&&(G_.add(S_),lv()),b_.to(P_,{opacity:0,duration:.5,onComplete:()=>{P_.style.display=`none`}})},e=>{e.total>0?F_.textContent=`Loading 3D Model: ${Math.round(e.loaded/e.total*100)}%`:F_.textContent=`Loading 3D Model: ${(e.loaded/(1024*1024)).toFixed(1)} MB`},e=>{console.error(`An error occurred loading the GLB model:`,e),F_.textContent=`Error loading model. Check console.`});function lv(){if(!S_)return;let t=new Xn().setFromObject(S_),n=t.getCenter(new G),r=t.getSize(new G),i=r.length();K_.position.set(n.x,n.y+Math.max(1.8,r.y*.1),n.z+r.z*.2),J_.target.copy(K_.position).add(new G(0,0,-.05)),J_.enablePan=!0,J_.enableZoom=!0,J_.minDistance=.1,J_.maxDistance=Math.max(30,i*1.5),J_.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.PAN,RIGHT:e.NONE},J_.update(),j_.start.set(K_.position.x,K_.position.y-1.3,K_.position.z),j_.end.set(K_.position.x,K_.position.y-.3,K_.position.z),N_.innerHTML=``,E_=[],[{title:`West Wing Area`,content:`Main entrance area showing structural pillars and connection grids.`,pos3D:n.clone().add(new G(-r.x*.2,r.y*.1,-r.z*.1)),camPos:n.clone().add(new G(-r.x*.2,r.y*.2+2,r.z*.1)),lookTarget:n.clone().add(new G(-r.x*.2,r.y*.1,-r.z*.1))},{title:`East Wing Area`,content:`Opposite viewing deck demonstrating spatial scale and material lighting.`,pos3D:n.clone().add(new G(r.x*.2,r.y*.1,r.z*.1)),camPos:n.clone().add(new G(r.x*.2,r.y*.2+2,-r.z*.1)),lookTarget:n.clone().add(new G(r.x*.2,r.y*.1,r.z*.1))}].forEach(rv)}function uv(){K_.position.set(0,0,.1),J_.target.set(0,0,0),J_.enablePan=!1,J_.enableZoom=!1,J_.minDistance=.01,J_.maxDistance=.1,J_.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.NONE,RIGHT:e.NONE},J_.update(),N_.innerHTML=``,E_=[],rv({title:`Project Showcase (360°)`,content:`Immersive panoramic viewport demonstrating standard lighting, mirror-like reflections, and environment reflections.`,pos3D:nv(40,-10,45),isPanoHotspot:!0})}function dv(e){D_||e===x_||(x_=e,ov(),W_(),e===`3d`?(R_.classList.add(`active`),z_.classList.remove(`active`),w_.visible=!1,X_.visible=!0,S_&&(G_.add(S_),S_.visible=!0,lv())):e===`pano`&&(z_.classList.add(`active`),R_.classList.remove(`active`),w_.visible=!0,X_.visible=!1,S_&&G_.remove(S_),uv()))}R_.addEventListener(`click`,()=>dv(`3d`)),z_.addEventListener(`click`,()=>dv(`pano`));function fv(){if(!S_||D_||x_!==`3d`)return;let e=k_.shift?5:1,t=O_*e,n=new G,r=new G;K_.getWorldDirection(r),r.y=0,r.normalize();let i=new G;if(i.crossVectors(K_.up,r).normalize(),k_.w&&n.add(r),k_.s&&n.sub(r),k_.a&&n.add(i),k_.d&&n.sub(i),k_.e&&(n.y+=1),k_.q&&--n.y,n.lengthSq()>0){let e=n.y*t;n.y=0,n.lengthSq()>0&&n.normalize().multiplyScalar(t),n.y=e;let r=new G;K_.getWorldDirection(r),j_.start.copy(K_.position).y-=1.3,j_.end.copy(K_.position).y-=.3,j_.translate(n);let i=A_.capsuleIntersect(j_);i&&j_.translate(i.normal.multiplyScalar(i.depth)),K_.position.copy(j_.end).y+=.3,J_.target.copy(K_.position).add(r.multiplyScalar(.05)),J_.update()}}q_.setAnimationLoop(()=>{if(x_===`3d`&&fv(),J_.update(),x_===`3d`&&S_&&C_&&!D_){let e=K_.position.clone(),t=new G;C_.getSize(t);let n=Math.max(1.6,t.y*.05),r=C_.min.y+n,i=new G(C_.min.x,r,C_.min.z);K_.position.clamp(i,C_.max);let a=K_.position.clone().sub(e);a.lengthSq()>0&&(J_.target.add(a),J_.update())}E_.length>0&&iv(),q_.render(G_,K_)}),window.addEventListener(`resize`,()=>{K_.aspect=window.innerWidth/window.innerHeight,K_.updateProjectionMatrix(),q_.setSize(window.innerWidth,window.innerHeight),q_.setPixelRatio(Math.min(window.devicePixelRatio,2))});