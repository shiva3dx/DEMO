...
void main() {
	...
	`}var Ss=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function Ld(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var Rd=class e{static createButton(t,n={}){let r=document.createElement(`button`);function i(){let e=null;async function i(n){n.addEventListener(`end`,a),await t.xr.setSession(n),r.textContent=`EXIT VR`,e=n}function a(){e.removeEventListener(`end`,a),r.textContent=`ENTER VR`,e=null}r.style.display=``,r.style.cursor=`pointer`,r.style.left=`calc(50% - 50px)`,r.style.width=`100px`,r.textContent=`ENTER VR`;let o={...n,optionalFeatures:[`local-floor`,`bounded-floor`,`layers`,...n.optionalFeatures||[]]};r.onmouseenter=function(){r.style.opacity=`1.0`},r.onmouseleave=function(){r.style.opacity=`0.5`},r.onclick=function(){e===null?navigator.xr.requestSession(`immersive-vr`,o).then(i):(e.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)})}function a(){r.style.display=``,r.style.cursor=`auto`,r.style.left=`calc(50% - 75px)`,r.style.width=`150px`,r.onmouseenter=null,r.onmouseleave=null,r.onclick=null}function o(){a(),r.textContent=`VR NOT SUPPORTED`}function s(e){a(),console.warn(`Exception when trying to call xr.isSessionSupported`,e),r.textContent=`VR NOT ALLOWED`}function c(e){e.style.position=`absolute`,e.style.bottom=`20px`,e.style.padding=`12px 6px`,e.style.border=`1px solid #fff`,e.style.borderRadius=`4px`,e.style.background=`rgba(0,0,0,0.1)`,e.style.color=`#fff`,e.style.font=`normal 13px sans-serif`,e.style.textAlign=`center`,e.style.opacity=`0.5`,e.style.outline=`none`,e.style.zIndex=`999`}if(`xr`in navigator)return r.id=`VRButton`,r.style.display=`none`,c(r),navigator.xr.isSessionSupported(`immersive-vr`).then(function(t){t?i():o(),t&&e.xrSessionIsGranted&&r.click()}).catch(s),r;{let e=document.createElement(`a`);return window.isSecureContext===!1?(e.href=document.location.href.replace(/^http:/,`https:`),e.innerHTML=`WEBXR NEEDS HTTPS`):(e.href=`https://immersiveweb.dev/`,e.innerHTML=`WEBXR NOT AVAILABLE`),e.style.left=`calc(50% - 90px)`,e.style.width=`180px`,e.style.textDecoration=`none`,c(e),e}}static registerSessionGrantedListener(){if(typeof navigator<`u`&&`xr`in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener(`sessiongranted`,()=>{e.xrSessionIsGranted=!0})}}};Rd.xrSessionIsGranted=!1,Rd.registerSessionGrantedListener();function zd(e){if(e===void 0)throw ReferenceError(`this hasn't been initialised - super() hasn't been called`);return e}function Bd(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}var Vd={autoSleep:120,force3D:`auto`,nullTargetWarn:1,units:{lineHeight:``}},Hd={duration:.5,overwrite:!1,delay:0},Ud,Wd,Gd,Kd=1e8,qd=1/Kd,Jd=Math.PI*2,Yd=Jd/4,Xd=0,Zd=Math.sqrt,Qd=Math.cos,$d=Math.sin,ef=function(e){return typeof e==`string`},tf=function(e){return typeof e==`function`},nf=function(e){return typeof e==`number`},rf=function(e){return e===void 0},af=function(e){return typeof e==`object`},of=function(e){return e!==!1},sf=function(){return typeof window<`u`},cf=function(e){return tf(e)||ef(e)},lf=typeof ArrayBuffer==`function`&&ArrayBuffer.isView||function(){},uf=Array.isArray,df=/random\([^)]+\)/g,ff=/,\s*/g,pf=/(?:-?\.?\d|\.)+/gi,mf=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,hf=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,gf=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,_f=/[+-]=-?[.\d]+/,vf=/[^,'"\[\]\s]+/gi,yf=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,bf,xf,Sf,Cf,wf={},Tf={},Ef,Df=function(e){return(Tf=ap(e,wf))&&Ch},Of=function(e,t){return console.warn(`Invalid property`,e,`set to`,t,`Missing plugin? gsap.registerPlugin()`)},kf=function(e,t){return!t&&console.warn(e)},Af=function(e,t){return e&&(wf[e]=t)&&Tf&&(Tf[e]=t)||wf},jf=function(){return 0},Mf={suppressEvents:!0,isStart:!0,kill:!1},Nf={suppressEvents:!0,kill:!1},Pf={suppressEvents:!0},Ff={},If=[],Lf={},Rf,zf={},Bf={},Vf=30,Hf=[],Uf=``,Wf=function(e){var t=e[0],n,r;if(af(t)||tf(t)||(e=[e]),!(n=(t._gsap||{}).harness)){for(r=Hf.length;r--&&!Hf[r].targetTest(t););n=Hf[r]}for(r=e.length;r--;)e[r]&&(e[r]._gsap||(e[r]._gsap=new Nm(e[r],n)))||e.splice(r,1);return e},Gf=function(e){return e._gsap||Wf(Hp(e))[0]._gsap},Kf=function(e,t,n){return(n=e[t])&&tf(n)?e[t]():rf(n)&&e.getAttribute&&e.getAttribute(t)||n},qf=function(e,t){return(e=e.split(`,`)).forEach(t)||e},Jf=function(e){return Math.round(e*1e5)/1e5||0},Yf=function(e){return Math.round(e*1e7)/1e7||0},Xf=function(e,t){var n=t.charAt(0),r=parseFloat(t.substr(2));return e=parseFloat(e),n===`+`?e+r:n===`-`?e-r:n===`*`?e*r:e/r},Zf=function(e,t){for(var n=t.length,r=0;e.indexOf(t[r])<0&&++r<n;);return r<n},Qf=function(){var e=If.length,t=If.slice(0),n,r;for(Lf={},If.length=0,n=0;n<e;n++)r=t[n],r&&r._lazy&&(r.render(r._lazy[0],r._lazy[1],!0)._lazy=0)},$f=function(e){return!!(e._initted||e._startAt||e.add)},ep=function(e,t,n,r){If.length&&!Wd&&Qf(),e.render(t,n,r||!!(Wd&&t<0&&$f(e))),If.length&&!Wd&&Qf()},tp=function(e){var t=parseFloat(e);return(t||t===0)&&(e+``).match(vf).length<2?t:ef(e)?e.trim():e},np=function(e){return e},rp=function(e,t){for(var n in t)n in e||(e[n]=t[n]);return e},ip=function(e){return function(t,n){for(var r in n)r in t||r===`duration`&&e||r===`ease`||(t[r]=n[r])}},ap=function(e,t){for(var n in t)e[n]=t[n];return e},op=function e(t,n){for(var r in n)r!==`__proto__`&&r!==`constructor`&&r!==`prototype`&&(t[r]=af(n[r])?e(t[r]||(t[r]={}),n[r]):n[r]);return t},sp=function(e,t){var n={},r;for(r in e)r in t||(n[r]=e[r]);return n},cp=function(e){var t=e.parent||bf,n=e.keyframes?ip(uf(e.keyframes)):rp;if(of(e.inherit))for(;t;)n(e,t.vars.defaults),t=t.parent||t._dp;return e},lp=function(e,t){for(var n=e.length,r=n===t.length;r&&n--&&e[n]===t[n];);return n<0},up=function(e,t,n,r,i){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var a=e[r],o;if(i)for(o=t[i];a&&a[i]>o;)a=a._prev;return a?(t._next=a._next,a._next=t):(t._next=e[n],e[n]=t),t._next?t._next._prev=t:e[r]=t,t._prev=a,t.parent=t._dp=e,t},dp=function(e,t,n,r){n===void 0&&(n=`_first`),r===void 0&&(r=`_last`);var i=t._prev,a=t._next;i?i._next=a:e[n]===t&&(e[n]=a),a?a._prev=i:e[r]===t&&(e[r]=i),t._next=t._prev=t.parent=null},fp=function(e,t){e.parent&&(!t||e.parent.autoRemoveChildren)&&e.parent.remove&&e.parent.remove(e),e._act=0},pp=function(e,t){if(e&&(!t||t._end>e._dur||t._start<0))for(var n=e;n;)n._dirty=1,n=n.parent;return e},mp=function(e){for(var t=e.parent;t&&t.parent;)t._dirty=1,t.totalDuration(),t=t.parent;return e},hp=function(e,t,n,r){return e._startAt&&(Wd?e._startAt.revert(Nf):e.vars.immediateRender&&!e.vars.autoRevert||e._startAt.render(t,!0,r))},gp=function e(t){return!t||t._ts&&e(t.parent)},_p=function(e){return e._repeat?vp(e._tTime,e=e.duration()+e._rDelay)*e:0},vp=function(e,t){var n=Math.floor(e=Yf(e/t));return e&&n===e?n-1:n},yp=function(e,t){return(e-t._start)*t._ts+(t._ts>=0?0:t._dirty?t.totalDuration():t._tDur)},bp=function(e){return e._end=Yf(e._start+(e._tDur/Math.abs(e._ts||e._rts||qd)||0))},xp=function(e,t){var n=e._dp;return n&&n.smoothChildTiming&&e._ts&&(e._start=Yf(n._time-(e._ts>0?t/e._ts:((e._dirty?e.totalDuration():e._tDur)-t)/-e._ts)),bp(e),n._dirty||pp(n,e)),e},Sp=function(e,t){var n;if((t._time||!t._dur&&t._initted||t._start<e._time&&(t._dur||!t.add))&&(n=yp(e.rawTime(),t),(!t._dur||Ip(0,t.totalDuration(),n)-t._tTime>qd)&&t.render(n,!0)),pp(e,t)._dp&&e._initted&&e._time>=e._dur&&e._ts){if(e._dur<e.duration())for(n=e;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;e._zTime=-qd}},Cp=function(e,t,n,r){return t.parent&&fp(t),t._start=Yf((nf(n)?n:n||e!==bf?Np(e,n,t):e._time)+t._delay),t._end=Yf(t._start+(t.totalDuration()/Math.abs(t.timeScale())||0)),up(e,t,`_first`,`_last`,e._sort?`_start`:0),Dp(t)||(e._recent=t),r||Sp(e,t),e._ts<0&&xp(e,e._tTime),e},wp=function(e,t){return(wf.ScrollTrigger||Of(`scrollTrigger`,t))&&wf.ScrollTrigger.create(t,e)},Tp=function(e,t,n,r,i){if(Hm(e,t,i),!e._initted)return 1;if(!n&&e._pt&&!Wd&&(e._dur&&e.vars.lazy!==!1||!e._dur&&e.vars.lazy)&&Rf!==bm.frame)return If.push(e),e._lazy=[i,r],1},Ep=function e(t){var n=t.parent;return n&&n._ts&&n._initted&&!n._lock&&(n.rawTime()<0||e(n))},Dp=function(e){var t=e.data;return t===`isFromStart`||t===`isStart`},Op=function(e,t,n,r){var i=e.ratio,a=t<0||!t&&(!e._start&&Ep(e)&&!(!e._initted&&Dp(e))||(e._ts<0||e._dp._ts<0)&&!Dp(e))?0:1,o=e._rDelay,s=0,c,l,u;if(o&&e._repeat&&(s=Ip(0,e._tDur,t),l=vp(s,o),e._yoyo&&l&1&&(a=1-a),l!==vp(e._tTime,o)&&(i=1-a,e.vars.repeatRefresh&&e._initted&&e.invalidate())),a!==i||Wd||r||e._zTime===qd||!t&&e._zTime){if(!e._initted&&Tp(e,t,r,n,s))return;for(u=e._zTime,e._zTime=t||(n?qd:0),n||=t&&!u,e.ratio=a,e._from&&(a=1-a),e._time=0,e._tTime=s,c=e._pt;c;)c.r(a,c.d),c=c._next;t<0&&hp(e,t,n,!0),e._onUpdate&&!n&&am(e,`onUpdate`),s&&e._repeat&&!n&&e.parent&&am(e,`onRepeat`),(t>=e._tDur||t<0)&&e.ratio===a&&(a&&fp(e,1),!n&&!Wd&&(am(e,a?`onComplete`:`onReverseComplete`,!0),e._prom&&e._prom()))}else e._zTime||=t},kp=function(e,t,n){var r;if(n>t)for(r=e._first;r&&r._start<=n;){if(r.data===`isPause`&&r._start>t)return r;r=r._next}else for(r=e._last;r&&r._start>=n;){if(r.data===`isPause`&&r._start<t)return r;r=r._prev}},Ap=function(e,t,n,r){var i=e._repeat,a=Yf(t)||0,o=e._tTime/e._tDur;return o&&!r&&(e._time*=a/e._dur),e._dur=a,e._tDur=i?i<0?1e10:Yf(a*(i+1)+e._rDelay*i):a,o>0&&!r&&xp(e,e._tTime=e._tDur*o),e.parent&&bp(e),n||pp(e.parent,e),e},jp=function(e){return e instanceof Fm?pp(e):Ap(e,e._dur)},Mp={_start:0,endTime:jf,totalDuration:jf},Np=function e(t,n,r){var i=t.labels,a=t._recent||Mp,o=t.duration()>=Kd?a.endTime(!1):t._dur,s,c,l;return ef(n)&&(isNaN(n)||n in i)?(c=n.charAt(0),l=n.substr(-1)===`%`,s=n.indexOf(`=`),c===`<`||c===`>`?(s>=0&&(n=n.replace(/=/,``)),(c===`<`?a._start:a.endTime(a._repeat>=0))+(parseFloat(n.substr(1))||0)*(l?(s<0?a:r).totalDuration()/100:1)):s<0?(n in i||(i[n]=o),i[n]):(c=parseFloat(n.charAt(s-1)+n.substr(s+1)),l&&r&&(c=c/100*(uf(r)?r[0]:r).totalDuration()),s>1?e(t,n.substr(0,s-1),r)+c:o+c)):n==null?o:+n},Pp=function(e,t,n){var r=nf(t[1]),i=(r?2:1)+(e<2?0:1),a=t[i],o,s;if(r&&(a.duration=t[1]),a.parent=n,e){for(o=a,s=n;s&&!(`immediateRender`in o);)o=s.vars.defaults||{},s=of(s.vars.inherit)&&s.parent;a.immediateRender=of(o.immediateRender),e<2?a.runBackwards=1:a.startAt=t[i-1]}return new Ym(t[0],a,t[i+1])},Fp=function(e,t){return e||e===0?t(e):t},Ip=function(e,t,n){return n<e?e:n>t?t:n},Lp=function(e,t){return!ef(e)||!(t=yf.exec(e))?``:t[1]},Rp=function(e,t,n){return Fp(n,function(n){return Ip(e,t,n)})},zp=[].slice,Bp=function(e,t){return e&&af(e)&&`length`in e&&(!t&&!e.length||e.length-1 in e&&af(e[0]))&&!e.nodeType&&e!==xf},Vp=function(e,t,n){return n===void 0&&(n=[]),e.forEach(function(e){var r;return ef(e)&&!t||Bp(e,1)?(r=n).push.apply(r,Hp(e)):n.push(e)})||n},Hp=function(e,t,n){return Gd&&!t&&Gd.selector?Gd.selector(e):ef(e)&&!n&&(Sf||!xm())?zp.call((t||Cf).querySelectorAll(e),0):uf(e)?Vp(e,n):Bp(e)?zp.call(e,0):e?[e]:[]},Up=function(e){return e=Hp(e)[0]||kf(`Invalid scope`)||{},function(t){var n=e.current||e.nativeElement||e;return Hp(t,n.querySelectorAll?n:n===e?kf(`Invalid scope`)||Cf.createElement(`div`):e)}},Wp=function(e){return e.sort(function(){return .5-Math.random()})},Gp=function(e){if(tf(e))return e;var t=af(e)?e:{each:e},n=Om(t.ease),r=t.from||0,i=parseFloat(t.base)||0,a={},o=r>0&&r<1,s=isNaN(r)||o,c=t.axis,l=r,u=r;return ef(r)?l=u={center:.5,edges:.5,end:1}[r]||0:!o&&s&&(l=r[0],u=r[1]),function(e,o,d){var f=(d||t).length,p=a[f],m,h,g,_,v,y,b,x,S;if(!p){if(S=t.grid===`auto`?0:(t.grid||[1,Kd])[1],!S){for(b=-Kd;b<(b=d[S++].getBoundingClientRect().left)&&S<f;);S<f&&S--}for(p=a[f]=[],m=s?Math.min(S,f)*l-.5:r%S,h=S===Kd?0:s?f*u/S-.5:r/S|0,b=0,x=Kd,y=0;y<f;y++)g=y%S-m,_=h-(y/S|0),p[y]=v=c?Math.abs(c===`y`?_:g):Zd(g*g+_*_),v>b&&(b=v),v<x&&(x=v);r===`random`&&Wp(p),p.max=b-x,p.min=x,p.v=f=(parseFloat(t.amount)||parseFloat(t.each)*(S>f?f-1:c?c===`y`?f/S:S:Math.max(S,f/S))||0)*(r===`edges`?-1:1),p.b=f<0?i-f:i,p.u=Lp(t.amount||t.each)||0,n=n&&f<0?Dm(n):n}return f=(p[e]-p.min)/p.max||0,Yf(p.b+(n?n(f):f)*p.v)+p.u}},Kp=function(e){var t=10**((e+``).split(`.`)[1]||``).length;return function(n){var r=Yf(Math.round(parseFloat(n)/e)*e*t);return(r-r%1)/t+(nf(n)?0:Lp(n))}},qp=function(e,t){var n=uf(e),r,i;return!n&&af(e)&&(r=n=e.radius||Kd,e.values?(e=Hp(e.values),(i=!nf(e[0]))&&(r*=r)):e=Kp(e.increment)),Fp(t,n?tf(e)?function(t){return i=e(t),Math.abs(i-t)<=r?i:t}:function(t){for(var n=parseFloat(i?t.x:t),a=parseFloat(i?t.y:0),o=Kd,s=0,c=e.length,l,u;c--;)i?(l=e[c].x-n,u=e[c].y-a,l=l*l+u*u):l=Math.abs(e[c]-n),l<o&&(o=l,s=c);return s=!r||o<=r?e[s]:t,i||s===t||nf(t)?s:s+Lp(t)}:Kp(e))},Jp=function(e,t,n,r){return Fp(uf(e)?!t:n===!0?!!(n=0):!r,function(){return uf(e)?e[~~(Math.random()*e.length)]:(n||=1e-5)&&(r=n<1?10**((n+``).length-2):1)&&Math.floor(Math.round((e-n/2+Math.random()*(t-e+n*.99))/n)*n*r)/r})},Yp=function(){var e=[...arguments];return function(t){return e.reduce(function(e,t){return t(e)},t)}},Xp=function(e,t){return function(n){return e(parseFloat(n))+(t||Lp(n))}},Zp=function(e,t,n){return nm(e,t,0,1,n)},Qp=function(e,t,n){return Fp(n,function(n){return e[~~t(n)]})},$p=function e(t,n,r){var i=n-t;return uf(t)?Qp(t,e(0,t.length),n):Fp(r,function(e){return(i+(e-t)%i)%i+t})},em=function e(t,n,r){var i=n-t,a=i*2;return uf(t)?Qp(t,e(0,t.length-1),n):Fp(r,function(e){return e=(a+(e-t)%a)%a||0,t+(e>i?a-e:e)})},tm=function(e){return e.replace(df,function(e){var t=e.indexOf(`[`)+1,n=e.substring(t||7,t?e.indexOf(`]`):e.length-1).split(ff);return Jp(t?n:+n[0],t?0:+n[1],+n[2]||1e-5)})},nm=function(e,t,n,r,i){var a=t-e,o=r-n;return Fp(i,function(t){return n+((t-e)/a*o||0)})},rm=function e(t,n,r,i){var a=isNaN(t+n)?0:function(e){return(1-e)*t+e*n};if(!a){var o=ef(t),s={},c,l,u,d,f;if(r===!0&&(i=1)&&(r=null),o)t={p:t},n={p:n};else if(uf(t)&&!uf(n)){for(u=[],d=t.length,f=d-2,l=1;l<d;l++)u.push(e(t[l-1],t[l]));d--,a=function(e){e*=d;var t=Math.min(f,~~e);return u[t](e-t)},r=n}else i||(t=ap(uf(t)?[]:{},t));if(!u){for(c in n)Lm.call(s,t,c,`get`,n[c]);a=function(e){return ih(e,s)||(o?t.p:t)}}}return Fp(r,a)},im=function(e,t,n){var r=e.labels,i=Kd,a,o,s;for(a in r)o=r[a]-t,o<0==!!n&&o&&i>(o=Math.abs(o))&&(s=a,i=o);return s},am=function(e,t,n){var r=e.vars,i=r[t],a=Gd,o=e._ctx,s,c,l;if(i)return s=r[t+`Params`],c=r.callbackScope||e,n&&If.length&&Qf(),o&&(Gd=o),l=s?i.apply(c,s):i.call(c),Gd=a,l},om=function(e){return fp(e),e.scrollTrigger&&e.scrollTrigger.kill(!!Wd),e.progress()<1&&am(e,`onInterrupt`),e},sm,cm=[],lm=function(e){if(e)if(e=!e.name&&e.default||e,sf()||e.headless){var t=e.name,n=tf(e),r=t&&!n&&e.init?function(){this._props=[]}:e,i={init:jf,render:ih,add:Lm,kill:oh,modifier:ah,rawVars:0},a={targetTest:0,get:0,getSetter:eh,aliases:{},register:0};if(xm(),e!==r){if(zf[t])return;rp(r,rp(sp(e,i),a)),ap(r.prototype,ap(i,sp(e,a))),zf[r.prop=t]=r,e.targetTest&&(Hf.push(r),Ff[t]=1),t=(t===`css`?`CSS`:t.charAt(0).toUpperCase()+t.substr(1))+`Plugin`}Af(t,r),e.register&&e.register(Ch,r,lh)}else cm.push(e)},um=255,dm={aqua:[0,um,um],lime:[0,um,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,um],navy:[0,0,128],white:[um,um,um],olive:[128,128,0],yellow:[um,um,0],orange:[um,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[um,0,0],pink:[um,192,203],cyan:[0,um,um],transparent:[um,um,um,0]},fm=function(e,t,n){return e+=e<0?1:e>1?-1:0,(e*6<1?t+(n-t)*e*6:e<.5?n:e*3<2?t+(n-t)*(2/3-e)*6:t)*um+.5|0},pm=function(e,t,n){var r=e?nf(e)?[e>>16,e>>8&um,e&um]:0:dm.black,i,a,o,s,c,l,u,d,f,p;if(!r){if(e.substr(-1)===`,`&&(e=e.substr(0,e.length-1)),dm[e])r=dm[e];else if(e.charAt(0)===`#`){if(e.length<6&&(i=e.charAt(1),a=e.charAt(2),o=e.charAt(3),e=`#`+i+i+a+a+o+o+(e.length===5?e.charAt(4)+e.charAt(4):``)),e.length===9)return r=parseInt(e.substr(1,6),16),[r>>16,r>>8&um,r&um,parseInt(e.substr(7),16)/255];e=parseInt(e.substr(1),16),r=[e>>16,e>>8&um,e&um]}else if(e.substr(0,3)===`hsl`){if(r=p=e.match(pf),!t)s=r[0]%360/360,c=r[1]/100,l=r[2]/100,a=l<=.5?l*(c+1):l+c-l*c,i=l*2-a,r.length>3&&(r[3]*=1),r[0]=fm(s+1/3,i,a),r[1]=fm(s,i,a),r[2]=fm(s-1/3,i,a);else if(~e.indexOf(`=`))return r=e.match(mf),n&&r.length<4&&(r[3]=1),r}else r=e.match(pf)||dm.transparent;r=r.map(Number)}return t&&!p&&(i=r[0]/um,a=r[1]/um,o=r[2]/um,u=Math.max(i,a,o),d=Math.min(i,a,o),l=(u+d)/2,u===d?s=c=0:(f=u-d,c=l>.5?f/(2-u-d):f/(u+d),s=u===i?(a-o)/f+(a<o?6:0):u===a?(o-i)/f+2:(i-a)/f+4,s*=60),r[0]=~~(s+.5),r[1]=~~(c*100+.5),r[2]=~~(l*100+.5)),n&&r.length<4&&(r[3]=1),r},mm=function(e){var t=[],n=[],r=-1;return e.split(gm).forEach(function(e){var i=e.match(hf)||[];t.push.apply(t,i),n.push(r+=i.length+1)}),t.c=n,t},hm=function(e,t,n){var r=``,i=(e+r).match(gm),a=t?`hsla(`:`rgba(`,o=0,s,c,l,u;if(!i)return e;if(i=i.map(function(e){return(e=pm(e,t,1))&&a+(t?e[0]+`,`+e[1]+`%,`+e[2]+`%,`+e[3]:e.join(`,`))+`)`}),n&&(l=mm(e),s=n.c,s.join(r)!==l.c.join(r)))for(c=e.replace(gm,`1`).split(hf),u=c.length-1;o<u;o++)r+=c[o]+(~s.indexOf(o)?i.shift()||a+`0,0,0,0)`:(l.length?l:i.length?i:n).shift());if(!c)for(c=e.split(gm),u=c.length-1;o<u;o++)r+=c[o]+i[o];return r+c[u]},gm=function(){var e=`(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b`,t;for(t in dm)e+=`|`+t+`\\b`;return RegExp(e+`)`,`gi`)}(),_m=/hsl[a]?\(/,vm=function(e){var t=e.join(` `),n;if(gm.lastIndex=0,gm.test(t))return n=_m.test(t),e[1]=hm(e[1],n),e[0]=hm(e[0],n,mm(e[1])),!0},ym,bm=function(){var e=Date.now,t=500,n=33,r=e(),i=r,a=1e3/240,o=a,s=[],c,l,u,d,f,p,m=function u(m){var h=e()-i,g=m===!0,_,v,y,b;if((h>t||h<0)&&(r+=h-n),i+=h,y=i-r,_=y-o,(_>0||g)&&(b=++d.frame,f=y-d.time*1e3,d.time=y/=1e3,o+=_+(_>=a?4:a-_),v=1),g||(c=l(u)),v)for(p=0;p<s.length;p++)s[p](y,f,b,m)};return d={time:0,frame:0,tick:function(){m(!0)},deltaRatio:function(e){return f/(1e3/(e||60))},wake:function(){Ef&&(!Sf&&sf()&&(xf=Sf=window,Cf=xf.document||{},wf.gsap=Ch,(xf.gsapVersions||=[]).push(Ch.version),Df(Tf||xf.GreenSockGlobals||!xf.gsap&&xf||{}),cm.forEach(lm)),u=typeof requestAnimationFrame<`u`&&requestAnimationFrame,c&&d.sleep(),l=u||function(e){return setTimeout(e,o-d.time*1e3+1|0)},ym=1,m(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(c),ym=0,l=jf},lagSmoothing:function(e,r){t=e||1/0,n=Math.min(r||33,t)},fps:function(e){a=1e3/(e||240),o=d.time*1e3+a},add:function(e,t,n){var r=t?function(t,n,i,a){e(t,n,i,a),d.remove(r)}:e;return d.remove(e),s[n?`unshift`:`push`](r),xm(),r},remove:function(e,t){~(t=s.indexOf(e))&&s.splice(t,1)&&p>=t&&p--},_listeners:s},d}(),xm=function(){return!ym&&bm.wake()},$={},Sm=/^[\d.\-M][\d.\-,\s]/,Cm=/["']/g,wm=function(e){for(var t={},n=e.substr(1,e.length-3).split(`:`),r=n[0],i=1,a=n.length,o,s,c;i<a;i++)s=n[i],o=i===a-1?s.length:s.lastIndexOf(`,`),c=s.substr(0,o),t[r]=isNaN(c)?c.replace(Cm,``).trim():+c,r=s.substr(o+1).trim();return t},Tm=function(e){var t=e.indexOf(`(`)+1,n=e.indexOf(`)`),r=e.indexOf(`(`,t);return e.substring(t,~r&&r<n?e.indexOf(`)`,n+1):n)},Em=function(e){var t=(e+``).split(`(`),n=$[t[0]];return n&&t.length>1&&n.config?n.config.apply(null,~e.indexOf(`{`)?[wm(t[1])]:Tm(e).split(`,`).map(tp)):$._CE&&Sm.test(e)?$._CE(``,e):n},Dm=function(e){return function(t){return 1-e(1-t)}},Om=function(e,t){return e&&(tf(e)?e:$[e]||Em(e))||t},km=function(e,t,n,r){n===void 0&&(n=function(e){return 1-t(1-e)}),r===void 0&&(r=function(e){return e<.5?t(e*2)/2:1-t((1-e)*2)/2});var i={easeIn:t,easeOut:n,easeInOut:r},a;return qf(e,function(e){for(var t in $[e]=wf[e]=i,$[a=e.toLowerCase()]=n,i)$[a+(t===`easeIn`?`.in`:t===`easeOut`?`.out`:`.inOut`)]=$[e+`.`+t]=i[t]}),i},Am=function(e){return function(t){return t<.5?(1-e(1-t*2))/2:.5+e((t-.5)*2)/2}},jm=function e(t,n,r){var i=n>=1?n:1,a=(r||(t?.3:.45))/(n<1?n:1),o=a/Jd*(Math.asin(1/i)||0),s=function(e){return e===1?1:i*2**(-10*e)*$d((e-o)*a)+1},c=t===`out`?s:t===`in`?function(e){return 1-s(1-e)}:Am(s);return a=Jd/a,c.config=function(n,r){return e(t,n,r)},c},Mm=function e(t,n){n===void 0&&(n=1.70158);var r=function(e){return e?--e*e*((n+1)*e+n)+1:0},i=t===`out`?r:t===`in`?function(e){return 1-r(1-e)}:Am(r);return i.config=function(n){return e(t,n)},i};qf(`Linear,Quad,Cubic,Quart,Quint,Strong`,function(e,t){var n=t<5?t+1:t;km(e+`,Power`+(n-1),t?function(e){return e**+n}:function(e){return e},function(e){return 1-(1-e)**n},function(e){return e<.5?(e*2)**n/2:1-((1-e)*2)**n/2})}),$.Linear.easeNone=$.none=$.Linear.easeIn,km(`Elastic`,jm(`in`),jm(`out`),jm()),(function(e,t){var n=1/t,r=2*n,i=2.5*n,a=function(a){return a<n?e*a*a:a<r?e*(a-1.5/t)**2+.75:a<i?e*(a-=2.25/t)*a+.9375:e*(a-2.625/t)**2+.984375};km(`Bounce`,function(e){return 1-a(1-e)},a)})(7.5625,2.75),km(`Expo`,function(e){return 2**(10*(e-1))*e+e*e*e*e*e*e*(1-e)}),km(`Circ`,function(e){return-(Zd(1-e*e)-1)}),km(`Sine`,function(e){return e===1?1:-Qd(e*Yd)+1}),km(`Back`,Mm(`in`),Mm(`out`),Mm()),$.SteppedEase=$.steps=wf.SteppedEase={config:function(e,t){e===void 0&&(e=1);var n=1/e,r=e+ +!t,i=+!!t,a=1-qd;return function(e){return((r*Ip(0,a,e)|0)+i)*n}}},Hd.ease=$[`quad.out`],qf(`onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt`,function(e){return Uf+=e+`,`+e+`Params,`});var Nm=function(e,t){this.id=Xd++,e._gsap=this,this.target=e,this.harness=t,this.get=t?t.get:Kf,this.set=t?t.getSetter:eh},Pm=function(){function e(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Ap(this,+e.duration,1,1),this.data=e.data,Gd&&(this._ctx=Gd,Gd.data.push(this)),ym||bm.wake()}var t=e.prototype;return t.delay=function(e){return e||e===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+e-this._delay),this._delay=e,this):this._delay},t.duration=function(e){return arguments.length?this.totalDuration(this._repeat>0?e+(e+this._rDelay)*this._repeat:e):this.totalDuration()&&this._dur},t.totalDuration=function(e){return arguments.length?(this._dirty=0,Ap(this,this._repeat<0?e:(e-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(e,t){if(xm(),!arguments.length)return this._tTime;var n=this._dp;if(n&&n.smoothChildTiming&&this._ts){for(xp(this,e),!n._dp||n.parent||Sp(n,this);n&&n.parent;)n.parent._time!==n._start+(n._ts>=0?n._tTime/n._ts:(n.totalDuration()-n._tTime)/-n._ts)&&n.totalTime(n._tTime,!0),n=n.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&e<this._tDur||this._ts<0&&e>0||!this._tDur&&!e)&&Cp(this._dp,this,this._start-this._delay)}return(this._tTime!==e||!this._dur&&!t||this._initted&&Math.abs(this._zTime)===qd||!this._initted&&this._dur&&e||!e&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=e),ep(this,e,t)),this},t.time=function(e,t){return arguments.length?this.totalTime(Math.min(this.totalDuration(),e+_p(this))%(this._dur+this._rDelay)||(e?this._dur:0),t):this._time},t.totalProgress=function(e,t){return arguments.length?this.totalTime(this.totalDuration()*e,t):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(e,t){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-e:e)+_p(this),t):this.duration()?Math.min(1,this._time/this._dur):+(this.rawTime()>0)},t.iteration=function(e,t){var n=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(e-1)*n,t):this._repeat?vp(this._tTime,n)+1:1},t.timeScale=function(e,t){if(!arguments.length)return this._rts===-qd?0:this._rts;if(this._rts===e)return this;var n=this.parent&&this._ts?yp(this.parent._time,this):this._tTime;return this._rts=+e||0,this._ts=this._ps||e===-qd?0:this._rts,this.totalTime(Ip(-Math.abs(this._delay),this.totalDuration(),n),t!==!1),bp(this),mp(this)},t.paused=function(e){return arguments.length?(this._ps!==e&&(this._ps=e,e?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(xm(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==qd&&(this._tTime-=qd)))),this):this._ps},t.startTime=function(e){if(arguments.length){this._start=Yf(e);var t=this.parent||this._dp;return t&&(t._sort||!this.parent)&&Cp(t,this,this._start-this._delay),this}return this._start},t.endTime=function(e){return this._start+(of(e)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(e){var t=this.parent||this._dp;return t?e&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?yp(t.rawTime(e),this):this._tTime:this._tTime},t.revert=function(e){e===void 0&&(e=Pf);var t=Wd;return Wd=e,$f(this)&&(this.timeline&&this.timeline.revert(e),this.totalTime(-.01,e.suppressEvents)),this.data!==`nested`&&e.kill!==!1&&this.kill(),Wd=t,this},t.globalTime=function(e){for(var t=this,n=arguments.length?e:t.rawTime();t;)n=t._start+n/(Math.abs(t._ts)||1),t=t._dp;return!this.parent&&this._sat?this._sat.globalTime(e):n},t.repeat=function(e){return arguments.length?(this._repeat=e===1/0?-2:e,jp(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(e){if(arguments.length){var t=this._time;return this._rDelay=e,jp(this),t?this.time(t):this}return this._rDelay},t.yoyo=function(e){return arguments.length?(this._yoyo=e,this):this._yoyo},t.seek=function(e,t){return this.totalTime(Np(this,e),of(t))},t.restart=function(e,t){return this.play().totalTime(e?-this._delay:0,of(t)),this._dur||(this._zTime=-qd),this},t.play=function(e,t){return e!=null&&this.seek(e,t),this.reversed(!1).paused(!1)},t.reverse=function(e,t){return e!=null&&this.seek(e||this.totalDuration(),t),this.reversed(!0).paused(!1)},t.pause=function(e,t){return e!=null&&this.seek(e,t),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(e){return arguments.length?(!!e!==this.reversed()&&this.timeScale(-this._rts||(e?-qd:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-qd,this},t.isActive=function(){var e=this.parent||this._dp,t=this._start,n;return!!(!e||this._ts&&this._initted&&e.isActive()&&(n=e.rawTime(!0))>=t&&n<this.endTime(!0)-qd)},t.eventCallback=function(e,t,n){var r=this.vars;return arguments.length>1?(t?(r[e]=t,n&&(r[e+`Params`]=n),e===`onUpdate`&&(this._onUpdate=t)):delete r[e],this):r[e]},t.then=function(e){var t=this,n=t._prom;return new Promise(function(r){var i=tf(e)?e:np,a=function(){var e=t.then;t.then=null,n&&n(),tf(i)&&(i=i(t))&&(i.then||i===t)&&(t.then=e),r(i),t.then=e};t._initted&&t.totalProgress()===1&&t._ts>=0||!t._tTime&&t._ts<0?a():t._prom=a})},t.kill=function(){om(this)},e}();rp(Pm.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-qd,_prom:0,_ps:!1,_rts:1});var Fm=function(e){Bd(t,e);function t(t,n){var r;return t===void 0&&(t={}),r=e.call(this,t)||this,r.labels={},r.smoothChildTiming=!!t.smoothChildTiming,r.autoRemoveChildren=!!t.autoRemoveChildren,r._sort=of(t.sortChildren),bf&&Cp(t.parent||bf,zd(r),n),t.reversed&&r.reverse(),t.paused&&r.paused(!0),t.scrollTrigger&&wp(zd(r),t.scrollTrigger),r}var n=t.prototype;return n.to=function(e,t,n){return Pp(0,arguments,this),this},n.from=function(e,t,n){return Pp(1,arguments,this),this},n.fromTo=function(e,t,n,r){return Pp(2,arguments,this),this},n.set=function(e,t,n){return t.duration=0,t.parent=this,cp(t).repeatDelay||(t.repeat=0),t.immediateRender=!!t.immediateRender,new Ym(e,t,Np(this,n),1),this},n.call=function(e,t,n){return Cp(this,Ym.delayedCall(0,e,t),n)},n.staggerTo=function(e,t,n,r,i,a,o){return n.duration=t,n.stagger=n.stagger||r,n.onComplete=a,n.onCompleteParams=o,n.parent=this,new Ym(e,n,Np(this,i)),this},n.staggerFrom=function(e,t,n,r,i,a,o){return n.runBackwards=1,cp(n).immediateRender=of(n.immediateRender),this.staggerTo(e,t,n,r,i,a,o)},n.staggerFromTo=function(e,t,n,r,i,a,o,s){return r.startAt=n,cp(r).immediateRender=of(r.immediateRender),this.staggerTo(e,t,r,i,a,o,s)},n.render=function(e,t,n){var r=this._time,i=this._dirty?this.totalDuration():this._tDur,a=this._dur,o=e<=0?0:Yf(e),s=this._zTime<0!=e<0&&(this._initted||!a),c,l,u,d,f,p,m,h,g,_,v,y;if(this!==bf&&o>i&&e>=0&&(o=i),o!==this._tTime||n||s){if(r!==this._time&&a&&(o+=this._time-r,e+=this._time-r),c=o,g=this._start,h=this._ts,p=!h,s&&(a||(r=this._zTime),(e||!t)&&(this._zTime=e)),this._repeat){if(v=this._yoyo,f=a+this._rDelay,this._repeat<-1&&e<0)return this.totalTime(f*100+e,t,n);if(c=Yf(o%f),o===i?(d=this._repeat,c=a):(_=Yf(o/f),d=~~_,d&&d===_&&(c=a,d--),c>a&&(c=a)),_=vp(this._tTime,f),!r&&this._tTime&&_!==d&&this._tTime-_*f-this._dur<=0&&(_=d),v&&d&1&&(c=a-c,y=1),d!==_&&!this._lock){var b=v&&_&1,x=b===(v&&d&1);if(d<_&&(b=!b),r=b?0:o%a?a:o,this._lock=1,this.render(r||(y?0:Yf(d*f)),t,!a)._lock=0,this._tTime=o,!t&&this.parent&&am(this,`onRepeat`),this.vars.repeatRefresh&&!y&&(this.invalidate()._lock=1,_=d),r&&r!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act||(a=this._dur,i=this._tDur,x&&(this._lock=2,r=b?a:-1e-4,this.render(r,!0),this.vars.repeatRefresh&&!y&&this.invalidate()),this._lock=0,!this._ts&&!p))return this}}if(this._hasPause&&!this._forcing&&this._lock<2&&(m=kp(this,Yf(r),Yf(c)),m&&(o-=c-(c=m._start))),this._tTime=o,this._time=c,this._act=!!h,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=e,r=0),!r&&o&&a&&!t&&!_&&(am(this,`onStart`),this._tTime!==o))return this;if(c>=r&&e>=0)for(l=this._first;l;){if(u=l._next,(l._act||c>=l._start)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(c-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(c-l._start)*l._ts,t,n),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=-qd);break}}l=u}else{l=this._last;for(var S=e<0?e:c;l;){if(u=l._prev,(l._act||S<=l._end)&&l._ts&&m!==l){if(l.parent!==this)return this.render(e,t,n);if(l.render(l._ts>0?(S-l._start)*l._ts:(l._dirty?l.totalDuration():l._tDur)+(S-l._start)*l._ts,t,n||Wd&&$f(l)),c!==this._time||!this._ts&&!p){m=0,u&&(o+=this._zTime=S?-qd:qd);break}}l=u}}if(m&&!t&&(this.pause(),m.render(c>=r?0:-qd)._zTime=c>=r?1:-1,this._ts))return this._start=g,bp(this),this.render(e,t,n);this._onUpdate&&!t&&am(this,`onUpdate`,!0),(o===i&&this._tTime>=this.totalDuration()||!o&&r)&&(g===this._start||Math.abs(h)!==Math.abs(this._ts))&&(this._lock||((e||!a)&&(o===i&&this._ts>0||!o&&this._ts<0)&&fp(this,1),!t&&!(e<0&&!r)&&(o||r||!i)&&(am(this,o===i&&e>=0?`onComplete`:`onReverseComplete`,!0),this._prom&&!(o<i&&this.timeScale()>0)&&this._prom())))}return this},n.add=function(e,t){var n=this;if(nf(t)||(t=Np(this,t,e)),!(e instanceof Pm)){if(uf(e))return e.forEach(function(e){return n.add(e,t)}),this;if(ef(e))return this.addLabel(e,t);if(tf(e))e=Ym.delayedCall(0,e);else return this}return this===e?this:Cp(this,e,t)},n.getChildren=function(e,t,n,r){e===void 0&&(e=!0),t===void 0&&(t=!0),n===void 0&&(n=!0),r===void 0&&(r=-Kd);for(var i=[],a=this._first;a;)a._start>=r&&(a instanceof Ym?t&&i.push(a):(n&&i.push(a),e&&i.push.apply(i,a.getChildren(!0,t,n)))),a=a._next;return i},n.getById=function(e){for(var t=this.getChildren(1,1,1),n=t.length;n--;)if(t[n].vars.id===e)return t[n]},n.remove=function(e){return ef(e)?this.removeLabel(e):tf(e)?this.killTweensOf(e):(e.parent===this&&dp(this,e),e===this._recent&&(this._recent=this._last),pp(this))},n.totalTime=function(t,n){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=Yf(bm.time-(this._ts>0?t/this._ts:(this.totalDuration()-t)/-this._ts))),e.prototype.totalTime.call(this,t,n),this._forcing=0,this):this._tTime},n.addLabel=function(e,t){return this.labels[e]=Np(this,t),this},n.removeLabel=function(e){return delete this.labels[e],this},n.addPause=function(e,t,n){var r=Ym.delayedCall(0,t||jf,n);return r.data=`isPause`,this._hasPause=1,Cp(this,r,Np(this,e))},n.removePause=function(e){var t=this._first;for(e=Np(this,e);t;)t._start===e&&t.data===`isPause`&&fp(t),t=t._next},n.killTweensOf=function(e,t,n){for(var r=this.getTweensOf(e,n),i=r.length;i--;)Bm!==r[i]&&r[i].kill(e,t);return this},n.getTweensOf=function(e,t){for(var n=[],r=Hp(e),i=this._first,a=nf(t),o;i;)i instanceof Ym?Zf(i._targets,r)&&(a?(!Bm||i._initted&&i._ts)&&i.globalTime(0)<=t&&i.globalTime(i.totalDuration())>t:!t||i.isActive())&&n.push(i):(o=i.getTweensOf(r,t)).length&&n.push.apply(n,o),i=i._next;return n},n.tweenTo=function(e,t){t||={};var n=this,r=Np(n,e),i=t,a=i.startAt,o=i.onStart,s=i.onStartParams,c=i.immediateRender,l,u=Ym.to(n,rp({ease:t.ease||`none`,lazy:!1,immediateRender:!1,time:r,overwrite:`auto`,duration:t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale())||qd,onStart:function(){if(n.pause(),!l){var e=t.duration||Math.abs((r-(a&&`time`in a?a.time:n._time))/n.timeScale());u._dur!==e&&Ap(u,e,0,1).render(u._time,!0,!0),l=1}o&&o.apply(u,s||[])}},t));return c?u.render(0):u},n.tweenFromTo=function(e,t,n){return this.tweenTo(t,rp({startAt:{time:Np(this,e)}},n))},n.recent=function(){return this._recent},n.nextLabel=function(e){return e===void 0&&(e=this._time),im(this,Np(this,e))},n.previousLabel=function(e){return e===void 0&&(e=this._time),im(this,Np(this,e),1)},n.currentLabel=function(e){return arguments.length?this.seek(e,!0):this.previousLabel(this._time+qd)},n.shiftChildren=function(e,t,n){n===void 0&&(n=0);var r=this._first,i=this.labels,a;for(e=Yf(e);r;)r._start>=n&&(r._start+=e,r._end+=e),r=r._next;if(t)for(a in i)i[a]>=n&&(i[a]+=e);return pp(this)},n.invalidate=function(t){var n=this._first;for(this._lock=0;n;)n.invalidate(t),n=n._next;return e.prototype.invalidate.call(this,t)},n.clear=function(e){e===void 0&&(e=!0);for(var t=this._first,n;t;)n=t._next,this.remove(t),t=n;return this._dp&&(this._time=this._tTime=this._pTime=0),e&&(this.labels={}),pp(this)},n.totalDuration=function(e){var t=0,n=this,r=n._last,i=Kd,a,o,s;if(arguments.length)return n.timeScale((n._repeat<0?n.duration():n.totalDuration())/(n.reversed()?-e:e));if(n._dirty){for(s=n.parent;r;)a=r._prev,r._dirty&&r.totalDuration(),o=r._start,o>i&&n._sort&&r._ts&&!n._lock?(n._lock=1,Cp(n,r,o-r._delay,1)._lock=0):i=o,o<0&&r._ts&&(t-=o,(!s&&!n._dp||s&&s.smoothChildTiming)&&(n._start+=Yf(o/n._ts),n._time-=o,n._tTime-=o),n.shiftChildren(-o,!1,-1/0),i=0),r._end>t&&r._ts&&(t=r._end),r=a;Ap(n,n===bf&&n._time>t?n._time:t,1,1),n._dirty=0}return n._tDur},t.updateRoot=function(e){if(bf._ts&&(ep(bf,yp(e,bf)),Rf=bm.frame),bm.frame>=Vf){Vf+=Vd.autoSleep||120;var t=bf._first;if((!t||!t._ts)&&Vd.autoSleep&&bm._listeners.length<2){for(;t&&!t._ts;)t=t._next;t||bm.sleep()}}},t}(Pm);rp(Fm.prototype,{_lock:0,_hasPause:0,_forcing:0});var Im=function(e,t,n,r,i,a,o){var s=new lh(this._pt,e,t,0,1,rh,null,i),c=0,l=0,u,d,f,p,m,h,g,_;for(s.b=n,s.e=r,n+=``,r+=``,(g=~r.indexOf(`random(`))&&(r=tm(r)),a&&(_=[n,r],a(_,e,t),n=_[0],r=_[1]),d=n.match(gf)||[];u=gf.exec(r);)p=u[0],m=r.substring(c,u.index),f?f=(f+1)%5:m.substr(-5)===`rgba(`&&(f=1),p!==d[l++]&&(h=parseFloat(d[l-1])||0,s._pt={_next:s._pt,p:m||l===1?m:`,`,s:h,c:p.charAt(1)===`=`?Xf(h,p)-h:parseFloat(p)-h,m:f&&f<4?Math.round:0},c=gf.lastIndex);return s.c=c<r.length?r.substring(c,r.length):``,s.fp=o,(_f.test(r)||g)&&(s.e=0),this._pt=s,s},Lm=function(e,t,n,r,i,a,o,s,c,l){tf(r)&&(r=r(i||0,e,a));var u=e[t],d=n===`get`?tf(u)?c?e[t.indexOf(`set`)||!tf(e[`get`+t.substr(3)])?t:`get`+t.substr(3)](c):e[t]():u:n,f=tf(u)?c?Qm:Zm:Xm,p;if(ef(r)&&(~r.indexOf(`random(`)&&(r=tm(r)),r.charAt(1)===`=`&&(p=Xf(d,r)+(Lp(d)||0),(p||p===0)&&(r=p))),!l||d!==r||Vm)return!isNaN(d*r)&&r!==``?(p=new lh(this._pt,e,t,+d||0,r-(d||0),typeof u==`boolean`?nh:th,0,f),c&&(p.fp=c),o&&p.modifier(o,this,e),this._pt=p):(!u&&!(t in e)&&Of(t,r),Im.call(this,e,t,d,r,f,s||Vd.stringFilter,c))},Rm=function(e,t,n,r,i){if(tf(e)&&(e=Km(e,i,t,n,r)),!af(e)||e.style&&e.nodeType||uf(e)||lf(e))return ef(e)?Km(e,i,t,n,r):e;var a={},o;for(o in e)a[o]=Km(e[o],i,t,n,r);return a},zm=function(e,t,n,r,i,a){var o,s,c,l;if(zf[e]&&(o=new zf[e]).init(i,o.rawVars?t[e]:Rm(t[e],r,i,a,n),n,r,a)!==!1&&(n._pt=s=new lh(n._pt,i,e,0,1,o.render,o,0,o.priority),n!==sm))for(c=n._ptLookup[n._targets.indexOf(i)],l=o._props.length;l--;)c[o._props[l]]=s;return o},Bm,Vm,Hm=function e(t,n,r){var i=t.vars,a=i.ease,o=i.startAt,s=i.immediateRender,c=i.lazy,l=i.onUpdate,u=i.runBackwards,d=i.yoyoEase,f=i.keyframes,p=i.autoRevert,m=t._dur,h=t._startAt,g=t._targets,_=t.parent,v=_&&_.data===`nested`?_.vars.targets:g,y=t._overwrite===`auto`&&!Ud,b=t.timeline,x=i.easeReverse||d,S,C,w,T,E,D,O,k,A,j,M,N,ee;if(b&&(!f||!a)&&(a=`none`),t._ease=Om(a,Hd.ease),t._rEase=x&&(Om(x)||t._ease),t._from=!b&&!!i.runBackwards,t._from&&(t.ratio=1),!b||f&&!i.stagger){if(k=g[0]?Gf(g[0]).harness:0,N=k&&i[k.prop],S=sp(i,Ff),h&&(h._zTime<0&&h.progress(1),n<0&&u&&s&&!p?h.render(-1,!0):h.revert(u&&m?Nf:Mf),h._lazy=0),o){if(fp(t._startAt=Ym.set(g,rp({data:`isStart`,overwrite:!1,parent:_,immediateRender:!0,lazy:!h&&of(c),startAt:null,delay:0,onUpdate:l&&function(){return am(t,`onUpdate`)},stagger:0},o))),t._startAt._dp=0,t._startAt._sat=t,n<0&&(Wd||!s&&!p)&&t._startAt.revert(Nf),s&&m&&n<=0&&r<=0){n&&(t._zTime=n);return}}else if(u&&m&&!h){if(n&&(s=!1),w=rp({overwrite:!1,data:`isFromStart`,lazy:s&&!h&&of(c),immediateRender:s,stagger:0,parent:_},S),N&&(w[k.prop]=N),fp(t._startAt=Ym.set(g,w)),t._startAt._dp=0,t._startAt._sat=t,n<0&&(Wd?t._startAt.revert(Nf):t._startAt.render(-1,!0)),t._zTime=n,!s)e(t._startAt,qd,qd);else if(!n)return}for(t._pt=t._ptCache=0,c=m&&of(c)||c&&!m,C=0;C<g.length;C++){if(E=g[C],O=E._gsap||Wf(g)[C]._gsap,t._ptLookup[C]=j={},Lf[O.id]&&If.length&&Qf(),M=v===g?C:v.indexOf(E),k&&(A=new k).init(E,N||S,t,M,v)!==!1&&(t._pt=T=new lh(t._pt,E,A.name,0,1,A.render,A,0,A.priority),A._props.forEach(function(e){j[e]=T}),A.priority&&(D=1)),!k||N)for(w in S)zf[w]&&(A=zm(w,S,t,M,E,v))?A.priority&&(D=1):j[w]=T=Lm.call(t,E,w,`get`,S[w],M,v,0,i.stringFilter);t._op&&t._op[C]&&t.kill(E,t._op[C]),y&&t._pt&&(Bm=t,bf.killTweensOf(E,j,t.globalTime(n)),ee=!t.parent,Bm=0),t._pt&&c&&(Lf[O.id]=1)}D&&ch(t),t._onInit&&t._onInit(t)}t._onUpdate=l,t._initted=(!t._op||t._pt)&&!ee,f&&n<=0&&b.render(Kd,!0,!0)},Um=function(e,t,n,r,i,a,o,s){var c=(e._pt&&e._ptCache||(e._ptCache={}))[t],l,u,d,f;if(!c)for(c=e._ptCache[t]=[],d=e._ptLookup,f=e._targets.length;f--;){if(l=d[f][t],l&&l.d&&l.d._pt)for(l=l.d._pt;l&&l.p!==t&&l.fp!==t;)l=l._next;if(!l)return Vm=1,e.vars[t]=`+=0`,Hm(e,o),Vm=0,s?kf(t+` not eligible for reset. Try splitting into individual properties`):1;c.push(l)}for(f=c.length;f--;)u=c[f],l=u._pt||u,l.s=(r||r===0)&&!i?r:l.s+(r||0)+a*l.c,l.c=n-l.s,u.e&&=Jf(n)+Lp(u.e),u.b&&=l.s+Lp(u.b)},Wm=function(e,t){var n=e[0]?Gf(e[0]).harness:0,r=n&&n.aliases,i,a,o,s;if(!r)return t;for(a in i=ap({},t),r)if(a in i)for(s=r[a].split(`,`),o=s.length;o--;)i[s[o]]=i[a];return i},Gm=function(e,t,n,r){var i=t.ease||r||`power1.inOut`,a,o;if(uf(t))o=n[e]||(n[e]=[]),t.forEach(function(e,n){return o.push({t:n/(t.length-1)*100,v:e,e:i})});else for(a in t)o=n[a]||(n[a]=[]),a===`ease`||o.push({t:parseFloat(e),v:t[a],e:i})},Km=function(e,t,n,r,i){return tf(e)?e.call(t,n,r,i):ef(e)&&~e.indexOf(`random(`)?tm(e):e},qm=Uf+`repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert`,Jm={};qf(qm+`,id,stagger,delay,duration,paused,scrollTrigger`,function(e){return Jm[e]=1});var Ym=function(e){Bd(t,e);function t(t,n,r,i){var a;typeof n==`number`&&(r.duration=n,n=r,r=null),a=e.call(this,i?n:cp(n))||this;var o=a.vars,s=o.duration,c=o.delay,l=o.immediateRender,u=o.stagger,d=o.overwrite,f=o.keyframes,p=o.defaults,m=o.scrollTrigger,h=n.parent||bf,g=(uf(t)||lf(t)?nf(t[0]):`length`in n)?[t]:Hp(t),_,v,y,b,x,S,C,w;if(a._targets=g.length?Wf(g):kf(`GSAP target `+t+` not found. https://gsap.com`,!Vd.nullTargetWarn)||[],a._ptLookup=[],a._overwrite=d,f||u||cf(s)||cf(c)){n=a.vars;var T=n.easeReverse||n.yoyoEase;if(_=a.timeline=new Fm({data:`nested`,defaults:p||{},targets:h&&h.data===`nested`?h.vars.targets:g}),_.kill(),_.parent=_._dp=zd(a),_._start=0,u||cf(s)||cf(c)){if(b=g.length,C=u&&Gp(u),af(u))for(x in u)~qm.indexOf(x)&&(w||={},w[x]=u[x]);for(v=0;v<b;v++)y=sp(n,Jm),y.stagger=0,T&&(y.easeReverse=T),w&&ap(y,w),S=g[v],y.duration=+Km(s,zd(a),v,S,g),y.delay=(+Km(c,zd(a),v,S,g)||0)-a._delay,!u&&b===1&&y.delay&&(a._delay=c=y.delay,a._start+=c,y.delay=0),_.to(S,y,C?C(v,S,g):0),_._ease=$.none;_.duration()?s=c=0:a.timeline=0}else if(f){cp(rp(_.vars.defaults,{ease:`none`})),_._ease=Om(f.ease||n.ease||`none`);var E=0,D,O,k;if(uf(f))f.forEach(function(e){return _.to(g,e,`>`)}),_.duration();else{for(x in y={},f)x===`ease`||x===`easeEach`||Gm(x,f[x],y,f.easeEach);for(x in y)for(D=y[x].sort(function(e,t){return e.t-t.t}),E=0,v=0;v<D.length;v++)O=D[v],k={ease:O.e,duration:(O.t-(v?D[v-1].t:0))/100*s},k[x]=O.v,_.to(g,k,E),E+=k.duration;_.duration()<s&&_.to({},{duration:s-_.duration()})}}s||a.duration(s=_.duration())}else a.timeline=0;return d===!0&&!Ud&&(Bm=zd(a),bf.killTweensOf(g),Bm=0),Cp(h,zd(a),r),n.reversed&&a.reverse(),n.paused&&a.paused(!0),(l||!s&&!f&&a._start===Yf(h._time)&&of(l)&&gp(zd(a))&&h.data!==`nested`)&&(a._tTime=-qd,a.render(Math.max(0,-c)||0)),m&&wp(zd(a),m),a}var n=t.prototype;return n.render=function(e,t,n){var r=this._time,i=this._tDur,a=this._dur,o=e<0,s=e>i-qd&&!o?i:e<qd?0:e,c,l,u,d,f,p,m,h;if(!a)Op(this,e,t,n);else if(s!==this._tTime||!e||n||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==o||this._lazy){if(c=s,h=this.timeline,this._repeat){if(d=a+this._rDelay,this._repeat<-1&&o)return this.totalTime(d*100+e,t,n);if(c=Yf(s%d),s===i?(u=this._repeat,c=a):(f=Yf(s/d),u=~~f,u&&u===f?(c=a,u--):c>a&&(c=a)),p=this._yoyo&&u&1,p&&(c=a-c),f=vp(this._tTime,d),c===r&&!n&&this._initted&&u===f)return this._tTime=s,this;u!==f&&this.vars.repeatRefresh&&!p&&!this._lock&&c!==d&&this._initted&&(this._lock=n=1,this.render(Yf(d*u),!0).invalidate()._lock=0)}if(!this._initted){if(Tp(this,o?e:c,n,t,s))return this._tTime=0,this;if(r!==this._time&&!(n&&this.vars.repeatRefresh&&u!==f))return this;if(a!==this._dur)return this.render(e,t,n)}if(this._rEase){var g=c<r;if(g!==this._inv){var _=g?r:a-r;this._inv=g,this._from&&(this.ratio=1-this.ratio),this._invRatio=this.ratio,this._invTime=r,this._invRecip=_?(g?-1:1)/_:0,this._invScale=g?-this.ratio:1-this.ratio,this._invEase=g?this._rEase:this._ease}this.ratio=m=this._invRatio+this._invScale*this._invEase((c-this._invTime)*this._invRecip)}else this.ratio=m=this._ease(c/a);if(this._from&&(this.ratio=m=1-m),this._tTime=s,this._time=c,!this._act&&this._ts&&(this._act=1,this._lazy=0),!r&&s&&!t&&!f&&(am(this,`onStart`),this._tTime!==s))return this;for(l=this._pt;l;)l.r(m,l.d),l=l._next;h&&h.render(e<0?e:h._dur*h._ease(c/this._dur),t,n)||this._startAt&&(this._zTime=e),this._onUpdate&&!t&&(o&&hp(this,e,t,n),am(this,`onUpdate`)),this._repeat&&u!==f&&this.vars.onRepeat&&!t&&this.parent&&am(this,`onRepeat`),(s===this._tDur||!s)&&this._tTime===s&&(o&&!this._onUpdate&&hp(this,e,!0,!0),(e||!a)&&(s===this._tDur&&this._ts>0||!s&&this._ts<0)&&fp(this,1),!t&&!(o&&!r)&&(s||r||p)&&(am(this,s===i?`onComplete`:`onReverseComplete`,!0),this._prom&&!(s<i&&this.timeScale()>0)&&this._prom()))}return this},n.targets=function(){return this._targets},n.invalidate=function(t){return(!t||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(t),e.prototype.invalidate.call(this,t)},n.resetTo=function(e,t,n,r,i){ym||bm.wake(),this._ts||this.play();var a=Math.min(this._dur,(this._dp._time-this._start)*this._ts),o;return this._initted||Hm(this,a),o=this._ease(a/this._dur),Um(this,e,t,n,r,o,a,i)?this.resetTo(e,t,n,r,1):(xp(this,0),this.parent||up(this._dp,this,`_first`,`_last`,this._dp._sort?`_start`:0),this.render(0))},n.kill=function(e,t){if(t===void 0&&(t=`all`),!e&&(!t||t===`all`))return this._lazy=this._pt=0,this.parent?om(this):this.scrollTrigger&&this.scrollTrigger.kill(!!Wd),this;if(this.timeline){var n=this.timeline.totalDuration();return this.timeline.killTweensOf(e,t,Bm&&Bm.vars.overwrite!==!0)._first||om(this),this.parent&&n!==this.timeline.totalDuration()&&Ap(this,this._dur*this.timeline._tDur/n,0,1),this}var r=this._targets,i=e?Hp(e):r,a=this._ptLookup,o=this._pt,s,c,l,u,d,f,p;if((!t||t===`all`)&&lp(r,i))return t===`all`&&(this._pt=0),om(this);for(s=this._op=this._op||[],t!==`all`&&(ef(t)&&(d={},qf(t,function(e){return d[e]=1}),t=d),t=Wm(r,t)),p=r.length;p--;)if(~i.indexOf(r[p]))for(d in c=a[p],t===`all`?(s[p]=t,u=c,l={}):(l=s[p]=s[p]||{},u=t),u)f=c&&c[d],f&&((!(`kill`in f.d)||f.d.kill(d)===!0)&&dp(this,f,`_pt`),delete c[d]),l!==`all`&&(l[d]=1);return this._initted&&!this._pt&&o&&om(this),this},t.to=function(e,n){return new t(e,n,arguments[2])},t.from=function(e,t){return Pp(1,arguments)},t.delayedCall=function(e,n,r,i){return new t(n,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:e,onComplete:n,onReverseComplete:n,onCompleteParams:r,onReverseCompleteParams:r,callbackScope:i})},t.fromTo=function(e,t,n){return Pp(2,arguments)},t.set=function(e,n){return n.duration=0,n.repeatDelay||(n.repeat=0),new t(e,n)},t.killTweensOf=function(e,t,n){return bf.killTweensOf(e,t,n)},t}(Pm);rp(Ym.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0}),qf(`staggerTo,staggerFrom,staggerFromTo`,function(e){Ym[e]=function(){var t=new Fm,n=zp.call(arguments,0);return n.splice(e===`staggerFromTo`?5:4,0,0),t[e].apply(t,n)}});var Xm=function(e,t,n){return e[t]=n},Zm=function(e,t,n){return e[t](n)},Qm=function(e,t,n,r){return e[t](r.fp,n)},$m=function(e,t,n){return e.setAttribute(t,n)},eh=function(e,t){return tf(e[t])?Zm:rf(e[t])&&e.setAttribute?$m:Xm},th=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e6)/1e6,t)},nh=function(e,t){return t.set(t.t,t.p,!!(t.s+t.c*e),t)},rh=function(e,t){var n=t._pt,r=``;if(!e&&t.b)r=t.b;else if(e===1&&t.e)r=t.e;else{for(;n;)r=n.p+(n.m?n.m(n.s+n.c*e):Math.round((n.s+n.c*e)*1e4)/1e4)+r,n=n._next;r+=t.c}t.set(t.t,t.p,r,t)},ih=function(e,t){for(var n=t._pt;n;)n.r(e,n.d),n=n._next},ah=function(e,t,n,r){for(var i=this._pt,a;i;)a=i._next,i.p===r&&i.modifier(e,t,n),i=a},oh=function(e){for(var t=this._pt,n,r;t;)r=t._next,t.p===e&&!t.op||t.op===e?dp(this,t,`_pt`):t.dep||(n=1),t=r;return!n},sh=function(e,t,n,r){r.mSet(e,t,r.m.call(r.tween,n,r.mt),r)},ch=function(e){for(var t=e._pt,n,r,i,a;t;){for(n=t._next,r=i;r&&r.pr>t.pr;)r=r._next;(t._prev=r?r._prev:a)?t._prev._next=t:i=t,(t._next=r)?r._prev=t:a=t,t=n}e._pt=i},lh=function(){function e(e,t,n,r,i,a,o,s,c){this.t=t,this.s=r,this.c=i,this.p=n,this.r=a||th,this.d=o||this,this.set=s||Xm,this.pr=c||0,this._next=e,e&&(e._prev=this)}var t=e.prototype;return t.modifier=function(e,t,n){this.mSet=this.mSet||this.set,this.set=sh,this.m=e,this.mt=n,this.tween=t},e}();qf(Uf+`parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse`,function(e){return Ff[e]=1}),wf.TweenMax=wf.TweenLite=Ym,wf.TimelineLite=wf.TimelineMax=Fm,bf=new Fm({sortChildren:!1,defaults:Hd,autoRemoveChildren:!0,id:`root`,smoothChildTiming:!0}),Vd.stringFilter=vm;var uh=[],dh={},fh=[],ph=0,mh=0,hh=function(e){return(dh[e]||fh).map(function(e){return e()})},gh=function(){var e=Date.now(),t=[];e-ph>2&&(hh(`matchMediaInit`),uh.forEach(function(e){var n=e.queries,r=e.conditions,i,a,o,s;for(a in n)i=xf.matchMedia(n[a]).matches,i&&(o=1),i!==r[a]&&(r[a]=i,s=1);s&&(e.revert(),o&&t.push(e))}),hh(`matchMediaRevert`),t.forEach(function(e){return e.onMatch(e,function(t){return e.add(null,t)})}),ph=e,hh(`matchMedia`))},_h=function(){function e(e,t){this.selector=t&&Up(t),this.data=[],this._r=[],this.isReverted=!1,this.id=mh++,e&&this.add(e)}var t=e.prototype;return t.add=function(e,t,n){tf(e)&&(n=t,t=e,e=tf);var r=this,i=function(){var e=Gd,i=r.selector,a;return e&&e!==r&&e.data.push(r),n&&(r.selector=Up(n)),Gd=r,a=t.apply(r,arguments),tf(a)&&r._r.push(a),Gd=e,r.selector=i,r.isReverted=!1,a};return r.last=i,e===tf?i(r,function(e){return r.add(null,e)}):e?r[e]=i:i},t.ignore=function(e){var t=Gd;Gd=null,e(this),Gd=t},t.getTweens=function(){var t=[];return this.data.forEach(function(n){return n instanceof e?t.push.apply(t,n.getTweens()):n instanceof Ym&&!(n.parent&&n.parent.data===`nested`)&&t.push(n)}),t},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(e,t){var n=this;if(e?(function(){for(var t=n.getTweens(),r=n.data.length,i;r--;)i=n.data[r],i.data===`isFlip`&&(i.revert(),i.getChildren(!0,!0,!1).forEach(function(e){return t.splice(t.indexOf(e),1)}));for(t.map(function(e){return{g:e._dur||e._delay||e._sat&&!e._sat.vars.immediateRender?e.globalTime(0):-1/0,t:e}}).sort(function(e,t){return t.g-e.g||-1/0}).forEach(function(t){return t.t.revert(e)}),r=n.data.length;r--;)i=n.data[r],i instanceof Fm?i.data!==`nested`&&(i.scrollTrigger&&i.scrollTrigger.revert(),i.kill()):!(i instanceof Ym)&&i.revert&&i.revert(e);n._r.forEach(function(t){return t(e,n)}),n.isReverted=!0})():this.data.forEach(function(e){return e.kill&&e.kill()}),this.clear(),t)for(var r=uh.length;r--;)uh[r].id===this.id&&uh.splice(r,1)},t.revert=function(e){this.kill(e||{})},e}(),vh=function(){function e(e){this.contexts=[],this.scope=e,Gd&&Gd.data.push(this)}var t=e.prototype;return t.add=function(e,t,n){af(e)||(e={matches:e});var r=new _h(0,n||this.scope),i=r.conditions={},a,o,s;for(o in Gd&&!r.selector&&(r.selector=Gd.selector),this.contexts.push(r),t=r.add(`onMatch`,t),r.queries=e,e)o===`all`?s=1:(a=xf.matchMedia(e[o]),a&&(uh.indexOf(r)<0&&uh.push(r),(i[o]=a.matches)&&(s=1),a.addListener?a.addListener(gh):a.addEventListener(`change`,gh)));return s&&t(r,function(e){return r.add(null,e)}),this},t.revert=function(e){this.kill(e||{})},t.kill=function(e){this.contexts.forEach(function(t){return t.kill(e,!0)})},e}(),yh={registerPlugin:function(){[...arguments].forEach(function(e){return lm(e)})},timeline:function(e){return new Fm(e)},getTweensOf:function(e,t){return bf.getTweensOf(e,t)},getProperty:function(e,t,n,r){ef(e)&&(e=Hp(e)[0]);var i=Gf(e||{}).get,a=n?np:tp;return n===`native`&&(n=``),e&&(t?a((zf[t]&&zf[t].get||i)(e,t,n,r)):function(t,n,r){return a((zf[t]&&zf[t].get||i)(e,t,n,r))})},quickSetter:function(e,t,n){if(e=Hp(e),e.length>1){var r=e.map(function(e){return Ch.quickSetter(e,t,n)}),i=r.length;return function(e){for(var t=i;t--;)r[t](e)}}e=e[0]||{};var a=zf[t],o=Gf(e),s=o.harness&&(o.harness.aliases||{})[t]||t,c=a?function(t){var r=new a;sm._pt=0,r.init(e,n?t+n:t,sm,0,[e]),r.render(1,r),sm._pt&&ih(1,sm)}:o.set(e,s);return a?c:function(t){return c(e,s,n?t+n:t,o,1)}},quickTo:function(e,t,n){var r,i=Ch.to(e,rp((r={},r[t]=`+=0.1`,r.paused=!0,r.stagger=0,r),n||{})),a=function(e,n,r){return i.resetTo(t,e,n,r)};return a.tween=i,a},isTweening:function(e){return bf.getTweensOf(e,!0).length>0},defaults:function(e){return e&&e.ease&&(e.ease=Om(e.ease,Hd.ease)),op(Hd,e||{})},config:function(e){return op(Vd,e||{})},registerEffect:function(e){var t=e.name,n=e.effect,r=e.plugins,i=e.defaults,a=e.extendTimeline;(r||``).split(`,`).forEach(function(e){return e&&!zf[e]&&!wf[e]&&kf(t+` effect requires `+e+` plugin.`)}),Bf[t]=function(e,t,r){return n(Hp(e),rp(t||{},i),r)},a&&(Fm.prototype[t]=function(e,n,r){return this.add(Bf[t](e,af(n)?n:(r=n)&&{},this),r)})},registerEase:function(e,t){$[e]=Om(t)},parseEase:function(e,t){return arguments.length?Om(e,t):$},getById:function(e){return bf.getById(e)},exportRoot:function(e,t){e===void 0&&(e={});var n=new Fm(e),r,i;for(n.smoothChildTiming=of(e.smoothChildTiming),bf.remove(n),n._dp=0,n._time=n._tTime=bf._time,r=bf._first;r;)i=r._next,(t||!(!r._dur&&r instanceof Ym&&r.vars.onComplete===r._targets[0]))&&Cp(n,r,r._start-r._delay),r=i;return Cp(bf,n,0),n},context:function(e,t){return e?new _h(e,t):Gd},matchMedia:function(e){return new vh(e)},matchMediaRefresh:function(){return uh.forEach(function(e){var t=e.conditions,n,r;for(r in t)t[r]&&(t[r]=!1,n=1);n&&e.revert()})||gh()},addEventListener:function(e,t){var n=dh[e]||(dh[e]=[]);~n.indexOf(t)||n.push(t)},removeEventListener:function(e,t){var n=dh[e],r=n&&n.indexOf(t);r>=0&&n.splice(r,1)},utils:{wrap:$p,wrapYoyo:em,distribute:Gp,random:Jp,snap:qp,normalize:Zp,getUnit:Lp,clamp:Rp,splitColor:pm,toArray:Hp,selector:Up,mapRange:nm,pipe:Yp,unitize:Xp,interpolate:rm,shuffle:Wp},install:Df,effects:Bf,ticker:bm,updateRoot:Fm.updateRoot,plugins:zf,globalTimeline:bf,core:{PropTween:lh,globals:Af,Tween:Ym,Timeline:Fm,Animation:Pm,getCache:Gf,_removeLinkedListItem:dp,reverting:function(){return Wd},context:function(e){return e&&Gd&&(Gd.data.push(e),e._ctx=Gd),Gd},suppressOverwrites:function(e){return Ud=e}}};qf(`to,from,fromTo,delayedCall,set,killTweensOf`,function(e){return yh[e]=Ym[e]}),bm.add(Fm.updateRoot),sm=yh.to({},{duration:0});var bh=function(e,t){for(var n=e._pt;n&&n.p!==t&&n.op!==t&&n.fp!==t;)n=n._next;return n},xh=function(e,t){var n=e._targets,r,i,a;for(r in t)for(i=n.length;i--;)a=e._ptLookup[i][r],(a&&=a.d)&&(a._pt&&(a=bh(a,r)),a&&a.modifier&&a.modifier(t[r],e,n[i],r))},Sh=function(e,t){return{name:e,headless:1,rawVars:1,init:function(e,n,r){r._onInit=function(e){var r,i;if(ef(n)&&(r={},qf(n,function(e){return r[e]=1}),n=r),t){for(i in r={},n)r[i]=t(n[i]);n=r}xh(e,n)}}}},Ch=yh.registerPlugin({name:`attr`,init:function(e,t,n,r,i){var a,o,s;for(a in this.tween=n,t)s=e.getAttribute(a)||``,o=this.add(e,`setAttribute`,(s||0)+``,t[a],r,i,0,0,a),o.op=a,o.b=s,this._props.push(a)},render:function(e,t){for(var n=t._pt;n;)Wd?n.set(n.t,n.p,n.b,n):n.r(e,n.d),n=n._next}},{name:`endArray`,headless:1,init:function(e,t){for(var n=t.length;n--;)this.add(e,n,e[n]||0,t[n],0,0,0,0,0,1)}},Sh(`roundProps`,Kp),Sh(`modifiers`),Sh(`snap`,qp))||yh;Ym.version=Fm.version=Ch.version=`3.15.0`,Ef=1,sf()&&xm(),$.Power0,$.Power1,$.Power2,$.Power3,$.Power4,$.Linear,$.Quad,$.Cubic,$.Quart,$.Quint,$.Strong,$.Elastic,$.Back,$.SteppedEase,$.Bounce,$.Sine,$.Expo,$.Circ;var wh,Th,Eh,Dh,Oh,kh,Ah,jh=function(){return typeof window<`u`},Mh={},Nh=180/Math.PI,Ph=Math.PI/180,Fh=Math.atan2,Ih=1e8,Lh=/([A-Z])/g,Rh=/(left|right|width|margin|padding|x)/i,zh=/[\s,\(]\S/,Bh={autoAlpha:`opacity,visibility`,scale:`scaleX,scaleY`,alpha:`opacity`},Vh=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Hh=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Uh=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Wh=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Gh=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Kh=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},qh=function(e,t){return t.set(t.t,t.p,e===1?t.e:t.b,t)},Jh=function(e,t,n){return e.style[t]=n},Yh=function(e,t,n){return e.style.setProperty(t,n)},Xh=function(e,t,n){return e._gsap[t]=n},Zh=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Qh=function(e,t,n,r,i){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(i,a)},$h=function(e,t,n,r,i){var a=e._gsap;a[t]=n,a.renderTransform(i,a)},eg=`transform`,tg=eg+`Origin`,ng=function e(t,n){var r=this,i=this.target,a=i.style,o=i._gsap;if(t in Mh&&a){if(this.tfm=this.tfm||{},t!==`transform`)t=Bh[t]||t,~t.indexOf(`,`)?t.split(`,`).forEach(function(e){return r.tfm[e]=xg(i,e)}):this.tfm[t]=o.x?o[t]:xg(i,t),t===tg&&(this.tfm.zOrigin=o.zOrigin);else return Bh.transform.split(`,`).forEach(function(t){return e.call(r,t,n)});if(this.props.indexOf(eg)>=0)return;o.svg&&(this.svgo=i.getAttribute(`data-svg-origin`),this.props.push(tg,n,``)),t=eg}(a||n)&&this.props.push(t,n,a[t])},rg=function(e){e.translate&&(e.removeProperty(`translate`),e.removeProperty(`scale`),e.removeProperty(`rotate`))},ig=function(){var e=this.props,t=this.target,n=t.style,r=t._gsap,i,a;for(i=0;i<e.length;i+=3)e[i+1]?e[i+1]===2?t[e[i]](e[i+2]):t[e[i]]=e[i+2]:e[i+2]?n[e[i]]=e[i+2]:n.removeProperty(e[i].substr(0,2)===`--`?e[i]:e[i].replace(Lh,`-$1`).toLowerCase());if(this.tfm){for(a in this.tfm)r[a]=this.tfm[a];r.svg&&(r.renderTransform(),t.setAttribute(`data-svg-origin`,this.svgo||``)),i=Ah(),(!i||!i.isStart)&&!n[eg]&&(rg(n),r.zOrigin&&n[tg]&&(n[tg]+=` `+r.zOrigin+`px`,r.zOrigin=0,r.renderTransform()),r.uncache=1)}},ag=function(e,t){var n={target:e,props:[],revert:ig,save:ng};return e._gsap||Ch.core.getCache(e),t&&e.style&&e.nodeType&&t.split(`,`).forEach(function(e){return n.save(e)}),n},og,sg=function(e,t){var n=Th.createElementNS?Th.createElementNS((t||`http://www.w3.org/1999/xhtml`).replace(/^https/,`http`),e):Th.createElement(e);return n&&n.style?n:Th.createElement(e)},cg=function e(t,n,r){var i=getComputedStyle(t);return i[n]||i.getPropertyValue(n.replace(Lh,`-$1`).toLowerCase())||i.getPropertyValue(n)||!r&&e(t,ug(n)||n,1)||``},lg=`O,Moz,ms,Ms,Webkit`.split(`,`),ug=function(e,t,n){var r=(t||Oh).style,i=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);i--&&!(lg[i]+e in r););return i<0?null:(i===3?`ms`:i>=0?lg[i]:``)+e},dg=function(){jh()&&window.document&&(wh=window,Th=wh.document,Eh=Th.documentElement,Oh=sg(`div`)||{style:{}},sg(`div`),eg=ug(eg),tg=eg+`Origin`,Oh.style.cssText=`border-width:0;line-height:0;position:absolute;padding:0`,og=!!ug(`perspective`),Ah=Ch.core.reverting,Dh=1)},fg=function(e){var t=e.ownerSVGElement,n=sg(`svg`,t&&t.getAttribute(`xmlns`)||`http://www.w3.org/2000/svg`),r=e.cloneNode(!0),i;r.style.display=`block`,n.appendChild(r),Eh.appendChild(n);try{i=r.getBBox()}catch{}return n.removeChild(r),Eh.removeChild(n),i},pg=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},mg=function(e){var t,n;try{t=e.getBBox()}catch{t=fg(e),n=1}return t&&(t.width||t.height)||n||(t=fg(e)),t&&!t.width&&!t.x&&!t.y?{x:+pg(e,[`x`,`cx`,`x1`])||0,y:+pg(e,[`y`,`cy`,`y1`])||0,width:0,height:0}:t},hg=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&mg(e))},gg=function(e,t){if(t){var n=e.style,r;t in Mh&&t!==tg&&(t=eg),n.removeProperty?(r=t.substr(0,2),(r===`ms`||t.substr(0,6)===`webkit`)&&(t=`-`+t),n.removeProperty(r===`--`?t:t.replace(Lh,`-$1`).toLowerCase())):n.removeAttribute(t)}},_g=function(e,t,n,r,i,a){var o=new lh(e._pt,t,n,0,1,a?qh:Kh);return e._pt=o,o.b=r,o.e=i,e._props.push(n),o},vg={deg:1,rad:1,turn:1},yg={grid:1,flex:1},bg=function e(t,n,r,i){var a=parseFloat(r)||0,o=(r+``).trim().substr((a+``).length)||`px`,s=Oh.style,c=Rh.test(n),l=t.tagName.toLowerCase()===`svg`,u=(l?`client`:`offset`)+(c?`Width`:`Height`),d=100,f=i===`px`,p=i===`%`,m,h,g,_;if(i===o||!a||vg[i]||vg[o])return a;if(o!==`px`&&!f&&(a=e(t,n,r,`px`)),_=t.getCTM&&hg(t),(p||o===`%`)&&(Mh[n]||~n.indexOf(`adius`)))return m=_?t.getBBox()[c?`width`:`height`]:t[u],Jf(p?a/m*d:a/100*m);if(s[c?`width`:`height`]=d+(f?o:i),h=i!==`rem`&&~n.indexOf(`adius`)||i===`em`&&t.appendChild&&!l?t:t.parentNode,_&&(h=(t.ownerSVGElement||{}).parentNode),(!h||h===Th||!h.appendChild)&&(h=Th.body),g=h._gsap,g&&p&&g.width&&c&&g.time===bm.time&&!g.uncache)return Jf(a/g.width*d);if(p&&(n===`height`||n===`width`)){var v=t.style[n];t.style[n]=d+i,m=t[u],v?t.style[n]=v:gg(t,n)}else(p||o===`%`)&&!yg[cg(h,`display`)]&&(s.position=cg(t,`position`)),h===t&&(s.position=`static`),h.appendChild(Oh),m=Oh[u],h.removeChild(Oh),s.position=`absolute`;return c&&p&&(g=Gf(h),g.time=bm.time,g.width=h[u]),Jf(f?m*a/d:m&&a?d/m*a:0)},xg=function(e,t,n,r){var i;return Dh||dg(),t in Bh&&t!==`transform`&&(t=Bh[t],~t.indexOf(`,`)&&(t=t.split(`,`)[0])),Mh[t]&&t!==`transform`?(i=Ng(e,r),i=t===`transformOrigin`?i.svg?i.origin:Pg(cg(e,tg))+` `+i.zOrigin+`px`:i[t]):(i=e.style[t],(!i||i===`auto`||r||~(i+``).indexOf(`calc(`))&&(i=Eg[t]&&Eg[t](e,t,n)||cg(e,t)||Kf(e,t)||+(t===`opacity`))),n&&!~(i+``).trim().indexOf(` `)?bg(e,t,i,n)+n:i},Sg=function(e,t,n,r){if(!n||n===`none`){var i=ug(t,e,1),a=i&&cg(e,i,1);a&&a!==n?(t=i,n=a):t===`borderColor`&&(n=cg(e,`borderTopColor`))}var o=new lh(this._pt,e.style,t,0,1,rh),s=0,c=0,l,u,d,f,p,m,h,g,_,v,y,b;if(o.b=n,o.e=r,n+=``,r+=``,r.substring(0,6)===`var(--`&&(r=cg(e,r.substring(4,r.indexOf(`)`)))),r===`auto`&&(m=e.style[t],e.style[t]=r,r=cg(e,t)||r,m?e.style[t]=m:gg(e,t)),l=[n,r],vm(l),n=l[0],r=l[1],d=n.match(hf)||[],b=r.match(hf)||[],b.length){for(;u=hf.exec(r);)h=u[0],_=r.substring(s,u.index),p?p=(p+1)%5:(_.substr(-5)===`rgba(`||_.substr(-5)===`hsla(`)&&(p=1),h!==(m=d[c++]||``)&&(f=parseFloat(m)||0,y=m.substr((f+``).length),h.charAt(1)===`=`&&(h=Xf(f,h)+y),g=parseFloat(h),v=h.substr((g+``).length),s=hf.lastIndex-v.length,v||(v=v||Vd.units[t]||y,s===r.length&&(r+=v,o.e+=v)),y!==v&&(f=bg(e,t,m,v)||0),o._pt={_next:o._pt,p:_||c===1?_:`,`,s:f,c:g-f,m:p&&p<4||t===`zIndex`?Math.round:0});o.c=s<r.length?r.substring(s,r.length):``}else o.r=t===`display`&&r===`none`?qh:Kh;return _f.test(r)&&(o.e=0),this._pt=o,o},Cg={top:`0%`,bottom:`100%`,left:`0%`,right:`100%`,center:`50%`},wg=function(e){var t=e.split(` `),n=t[0],r=t[1]||`50%`;return(n===`top`||n===`bottom`||r===`left`||r===`right`)&&(e=n,n=r,r=e),t[0]=Cg[n]||n,t[1]=Cg[r]||r,t.join(` `)},Tg=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,r=n.style,i=t.u,a=n._gsap,o,s,c;if(i===`all`||i===!0)r.cssText=``,s=1;else for(i=i.split(`,`),c=i.length;--c>-1;)o=i[c],Mh[o]&&(s=1,o=o===`transformOrigin`?tg:eg),gg(n,o);s&&(gg(n,eg),a&&(a.svg&&n.removeAttribute(`transform`),r.scale=r.rotate=r.translate=`none`,Ng(n,1),a.uncache=1,rg(r)))}},Eg={clearProps:function(e,t,n,r,i){if(i.data!==`isFromStart`){var a=e._pt=new lh(e._pt,t,n,0,0,Tg);return a.u=r,a.pr=-10,a.tween=i,e._props.push(n),1}}},Dg=[1,0,0,1,0,0],Og={},kg=function(e){return e===`matrix(1, 0, 0, 1, 0, 0)`||e===`none`||!e},Ag=function(e){var t=cg(e,eg);return kg(t)?Dg:t.substr(7).match(mf).map(Jf)},jg=function(e,t){var n=e._gsap||Gf(e),r=e.style,i=Ag(e),a,o,s,c;return n.svg&&e.getAttribute(`transform`)?(s=e.transform.baseVal.consolidate().matrix,i=[s.a,s.b,s.c,s.d,s.e,s.f],i.join(`,`)===`1,0,0,1,0,0`?Dg:i):(i===Dg&&!e.offsetParent&&e!==Eh&&!n.svg&&(s=r.display,r.display=`block`,a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(c=1,o=e.nextElementSibling,Eh.appendChild(e)),i=Ag(e),s?r.display=s:gg(e,`display`),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):Eh.removeChild(e))),t&&i.length>6?[i[0],i[1],i[4],i[5],i[12],i[13]]:i)},Mg=function(e,t,n,r,i,a){var o=e._gsap,s=i||jg(e,!0),c=o.xOrigin||0,l=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=s[0],p=s[1],m=s[2],h=s[3],g=s[4],_=s[5],v=t.split(` `),y=parseFloat(v[0])||0,b=parseFloat(v[1])||0,x,S,C,w;n?s!==Dg&&(S=f*h-p*m)&&(C=h/S*y+b*(-m/S)+(m*_-h*g)/S,w=y*(-p/S)+f/S*b-(f*_-p*g)/S,y=C,b=w):(x=mg(e),y=x.x+(~v[0].indexOf(`%`)?y/100*x.width:y),b=x.y+(~(v[1]||v[0]).indexOf(`%`)?b/100*x.height:b)),r||r!==!1&&o.smooth?(g=y-c,_=b-l,o.xOffset=u+(g*f+_*m)-g,o.yOffset=d+(g*p+_*h)-_):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=b,o.smooth=!!r,o.origin=t,o.originIsAbsolute=!!n,e.style[tg]=`0px 0px`,a&&(_g(a,o,`xOrigin`,c,y),_g(a,o,`yOrigin`,l,b),_g(a,o,`xOffset`,u,o.xOffset),_g(a,o,`yOffset`,d,o.yOffset)),e.setAttribute(`data-svg-origin`,y+` `+b)},Ng=function(e,t){var n=e._gsap||new Nm(e);if(`x`in n&&!t&&!n.uncache)return n;var r=e.style,i=n.scaleX<0,a=`px`,o=`deg`,s=getComputedStyle(e),c=cg(e,tg)||`0`,l=u=d=m=h=g=_=v=y=0,u,d,f=p=1,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,ee,P,F,te,ne,re,ie;return n.svg=!!(e.getCTM&&hg(e)),s.translate&&((s.translate!==`none`||s.scale!==`none`||s.rotate!==`none`)&&(r[eg]=(s.translate===`none`?``:`translate3d(`+(s.translate+` 0 0`).split(` `).slice(0,3).join(`, `)+`) `)+(s.rotate===`none`?``:`rotate(`+s.rotate+`) `)+(s.scale===`none`?``:`scale(`+s.scale.split(` `).join(`,`)+`) `)+(s[eg]===`none`?``:s[eg])),r.scale=r.rotate=r.translate=`none`),S=jg(e,n.svg),n.svg&&(n.uncache?(N=e.getBBox(),c=n.xOrigin-N.x+`px `+(n.yOrigin-N.y)+`px`,M=``):M=!t&&e.getAttribute(`data-svg-origin`),Mg(e,M||c,!!M||n.originIsAbsolute,n.smooth!==!1,S)),b=n.xOrigin||0,x=n.yOrigin||0,S!==Dg&&(E=S[0],D=S[1],O=S[2],k=S[3],l=A=S[4],u=j=S[5],S.length===6?(f=Math.sqrt(E*E+D*D),p=Math.sqrt(k*k+O*O),m=E||D?Fh(D,E)*Nh:0,_=O||k?Fh(O,k)*Nh+m:0,_&&(p*=Math.abs(Math.cos(_*Ph))),n.svg&&(l-=b-(b*E+x*O),u-=x-(b*D+x*k))):(ie=S[6],ne=S[7],P=S[8],F=S[9],te=S[10],re=S[11],l=S[12],u=S[13],d=S[14],C=Fh(ie,te),h=C*Nh,C&&(w=Math.cos(-C),T=Math.sin(-C),M=A*w+P*T,N=j*w+F*T,ee=ie*w+te*T,P=A*-T+P*w,F=j*-T+F*w,te=ie*-T+te*w,re=ne*-T+re*w,A=M,j=N,ie=ee),C=Fh(-O,te),g=C*Nh,C&&(w=Math.cos(-C),T=Math.sin(-C),M=E*w-P*T,N=D*w-F*T,ee=O*w-te*T,re=k*T+re*w,E=M,D=N,O=ee),C=Fh(D,E),m=C*Nh,C&&(w=Math.cos(C),T=Math.sin(C),M=E*w+D*T,N=A*w+j*T,D=D*w-E*T,j=j*w-A*T,E=M,A=N),h&&Math.abs(h)+Math.abs(m)>359.9&&(h=m=0,g=180-g),f=Jf(Math.sqrt(E*E+D*D+O*O)),p=Jf(Math.sqrt(j*j+ie*ie)),C=Fh(A,j),_=Math.abs(C)>2e-4?C*Nh:0,y=re?1/(re<0?-re:re):0),n.svg&&(M=e.getAttribute(`transform`),n.forceCSS=e.setAttribute(`transform`,``)||!kg(cg(e,eg)),M&&e.setAttribute(`transform`,M))),Math.abs(_)>90&&Math.abs(_)<270&&(i?(f*=-1,_+=m<=0?180:-180,m+=m<=0?180:-180):(p*=-1,_+=_<=0?180:-180)),t||=n.uncache,n.x=l-((n.xPercent=l&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-l)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=Jf(f),n.scaleY=Jf(p),n.rotation=Jf(m)+o,n.rotationX=Jf(h)+o,n.rotationY=Jf(g)+o,n.skewX=_+o,n.skewY=v+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(c.split(` `)[2])||!t&&n.zOrigin||0)&&(r[tg]=Pg(c)),n.xOffset=n.yOffset=0,n.force3D=Vd.force3D,n.renderTransform=n.svg?Vg:og?Bg:Ig,n.uncache=0,n},Pg=function(e){return(e=e.split(` `))[0]+` `+e[1]},Fg=function(e,t,n){var r=Lp(t);return Jf(parseFloat(t)+parseFloat(bg(e,`x`,n+`px`,r)))+r},Ig=function(e,t){t.z=`0px`,t.rotationY=t.rotationX=`0deg`,t.force3D=0,Bg(e,t)},Lg=`0deg`,Rg=`0px`,zg=`) `,Bg=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.z,c=n.rotation,l=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,p=n.scaleX,m=n.scaleY,h=n.transformPerspective,g=n.force3D,_=n.target,v=n.zOrigin,y=``,b=g===`auto`&&e&&e!==1||g===!0;if(v&&(u!==Lg||l!==Lg)){var x=parseFloat(l)*Ph,S=Math.sin(x),C=Math.cos(x),w;x=parseFloat(u)*Ph,w=Math.cos(x),a=Fg(_,a,S*w*-v),o=Fg(_,o,-Math.sin(x)*-v),s=Fg(_,s,C*w*-v+v)}h!==Rg&&(y+=`perspective(`+h+zg),(r||i)&&(y+=`translate(`+r+`%, `+i+`%) `),(b||a!==Rg||o!==Rg||s!==Rg)&&(y+=s!==Rg||b?`translate3d(`+a+`, `+o+`, `+s+`) `:`translate(`+a+`, `+o+zg),c!==Lg&&(y+=`rotate(`+c+zg),l!==Lg&&(y+=`rotateY(`+l+zg),u!==Lg&&(y+=`rotateX(`+u+zg),(d!==Lg||f!==Lg)&&(y+=`skew(`+d+`, `+f+zg),(p!==1||m!==1)&&(y+=`scale(`+p+`, `+m+zg),_.style[eg]=y||`translate(0, 0)`},Vg=function(e,t){var n=t||this,r=n.xPercent,i=n.yPercent,a=n.x,o=n.y,s=n.rotation,c=n.skewX,l=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,p=n.xOrigin,m=n.yOrigin,h=n.xOffset,g=n.yOffset,_=n.forceCSS,v=parseFloat(a),y=parseFloat(o),b,x,S,C,w;s=parseFloat(s),c=parseFloat(c),l=parseFloat(l),l&&(l=parseFloat(l),c+=l,s+=l),s||c?(s*=Ph,c*=Ph,b=Math.cos(s)*u,x=Math.sin(s)*u,S=Math.sin(s-c)*-d,C=Math.cos(s-c)*d,c&&(l*=Ph,w=Math.tan(c-l),w=Math.sqrt(1+w*w),S*=w,C*=w,l&&(w=Math.tan(l),w=Math.sqrt(1+w*w),b*=w,x*=w)),b=Jf(b),x=Jf(x),S=Jf(S),C=Jf(C)):(b=u,C=d,x=S=0),(v&&!~(a+``).indexOf(`px`)||y&&!~(o+``).indexOf(`px`))&&(v=bg(f,`x`,a,`px`),y=bg(f,`y`,o,`px`)),(p||m||h||g)&&(v=Jf(v+p-(p*b+m*S)+h),y=Jf(y+m-(p*x+m*C)+g)),(r||i)&&(w=f.getBBox(),v=Jf(v+r/100*w.width),y=Jf(y+i/100*w.height)),w=`matrix(`+b+`,`+x+`,`+S+`,`+C+`,`+v+`,`+y+`)`,f.setAttribute(`transform`,w),_&&(f.style[eg]=w)},Hg=function(e,t,n,r,i){var a=360,o=ef(i),s=parseFloat(i)*(o&&~i.indexOf(`rad`)?Nh:1)-r,c=r+s+`deg`,l,u;return o&&(l=i.split(`_`)[1],l===`short`&&(s%=a,s!==s%(a/2)&&(s+=s<0?a:-a)),l===`cw`&&s<0?s=(s+a*Ih)%a-~~(s/a)*a:l===`ccw`&&s>0&&(s=(s-a*Ih)%a-~~(s/a)*a)),e._pt=u=new lh(e._pt,t,n,r,s,Hh),u.e=c,u.u=`deg`,e._props.push(n),u},Ug=function(e,t){for(var n in t)e[n]=t[n];return e},Wg=function(e,t,n){var r=Ug({},n._gsap),i=`perspective,force3D,transformOrigin,svgOrigin`,a=n.style,o,s,c,l,u,d,f,p;for(s in r.svg?(c=n.getAttribute(`transform`),n.setAttribute(`transform`,``),a[eg]=t,o=Ng(n,1),gg(n,eg),n.setAttribute(`transform`,c)):(c=getComputedStyle(n)[eg],a[eg]=t,o=Ng(n,1),a[eg]=c),Mh)c=r[s],l=o[s],c!==l&&i.indexOf(s)<0&&(f=Lp(c),p=Lp(l),u=f===p?parseFloat(c):bg(n,s,c,p),d=parseFloat(l),e._pt=new lh(e._pt,o,s,u,d-u,Vh),e._pt.u=p||0,e._props.push(s));Ug(o,r)};qf(`padding,margin,Width,Radius`,function(e,t){var n=`Top`,r=`Right`,i=`Bottom`,a=`Left`,o=(t<3?[n,r,i,a]:[n+a,n+r,i+r,i+a]).map(function(n){return t<2?e+n:`border`+n+e});Eg[t>1?`border`+e:e]=function(e,t,n,r,i){var a,s;if(arguments.length<4)return a=o.map(function(t){return xg(e,t,n)}),s=a.join(` `),s.split(a[0]).length===5?a[0]:s;a=(r+``).split(` `),s={},o.forEach(function(e,t){return s[e]=a[t]=a[t]||a[(t-1)/2|0]}),e.init(t,s,i)}});var Gg={name:`css`,register:dg,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,r,i){var a=this._props,o=e.style,s=n.vars.startAt,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;for(m in Dh||dg(),this.styles=this.styles||ag(e),C=this.styles.props,this.tween=n,t)if(m!==`autoRound`&&(l=t[m],!(zf[m]&&zm(m,t,n,r,e,i)))){if(f=typeof l,p=Eg[m],f===`function`&&(l=l.call(n,r,e,i),f=typeof l),f===`string`&&~l.indexOf(`random(`)&&(l=tm(l)),p)p(this,e,m,l,n)&&(S=1);else if(m.substr(0,2)===`--`)c=(getComputedStyle(e).getPropertyValue(m)+``).trim(),l+=``,gm.lastIndex=0,gm.test(c)||(h=Lp(c),g=Lp(l),g?h!==g&&(c=bg(e,m,c,g)+g):h&&(l+=h)),this.add(o,`setProperty`,c,l,r,i,0,0,m),a.push(m),C.push(m,0,o[m]);else if(f!==`undefined`){if(s&&m in s?(c=typeof s[m]==`function`?s[m].call(n,r,e,i):s[m],ef(c)&&~c.indexOf(`random(`)&&(c=tm(c)),Lp(c+``)||c===`auto`||(c+=Vd.units[m]||Lp(xg(e,m))||``),(c+``).charAt(1)===`=`&&(c=xg(e,m))):c=xg(e,m),d=parseFloat(c),_=f===`string`&&l.charAt(1)===`=`&&l.substr(0,2),_&&(l=l.substr(2)),u=parseFloat(l),m in Bh&&(m===`autoAlpha`&&(d===1&&xg(e,`visibility`)===`hidden`&&u&&(d=0),C.push(`visibility`,0,o.visibility),_g(this,o,`visibility`,d?`inherit`:`hidden`,u?`inherit`:`hidden`,!u)),m!==`scale`&&m!==`transform`&&(m=Bh[m],~m.indexOf(`,`)&&(m=m.split(`,`)[0]))),v=m in Mh,v){if(this.styles.save(m),w=l,f===`string`&&l.substring(0,6)===`var(--`){if(l=cg(e,l.substring(4,l.indexOf(`)`))),l.substring(0,5)===`calc(`){var T=e.style.perspective;e.style.perspective=l,l=cg(e,`perspective`),T?e.style.perspective=T:gg(e,`perspective`)}u=parseFloat(l)}if(y||(b=e._gsap,b.renderTransform&&!t.parseTransform||Ng(e,t.parseTransform),x=t.smoothOrigin!==!1&&b.smooth,y=this._pt=new lh(this._pt,o,eg,0,1,b.renderTransform,b,0,-1),y.dep=1),m===`scale`)this._pt=new lh(this._pt,b,`scaleY`,b.scaleY,(_?Xf(b.scaleY,_+u):u)-b.scaleY||0,Vh),this._pt.u=0,a.push(`scaleY`,m),m+=`X`;else if(m===`transformOrigin`){C.push(tg,0,o[tg]),l=wg(l),b.svg?Mg(e,l,0,x,0,this):(g=parseFloat(l.split(` `)[2])||0,g!==b.zOrigin&&_g(this,b,`zOrigin`,b.zOrigin,g),_g(this,o,m,Pg(c),Pg(l)));continue}else if(m===`svgOrigin`){Mg(e,l,1,x,0,this);continue}else if(m in Og){Hg(this,b,m,d,_?Xf(d,_+l):l);continue}else if(m===`smoothOrigin`){_g(this,b,`smooth`,b.smooth,l);continue}else if(m===`force3D`){b[m]=l;continue}else if(m===`transform`){Wg(this,l,e);continue}}else m in o||(m=ug(m)||m);if(v||(u||u===0)&&(d||d===0)&&!zh.test(l)&&m in o)h=(c+``).substr((d+``).length),u||=0,g=Lp(l)||(m in Vd.units?Vd.units[m]:h),h!==g&&(d=bg(e,m,c,g)),this._pt=new lh(this._pt,v?b:o,m,d,(_?Xf(d,_+u):u)-d,!v&&(g===`px`||m===`zIndex`)&&t.autoRound!==!1?Gh:Vh),this._pt.u=g||0,v&&w!==l?(this._pt.b=c,this._pt.e=w,this._pt.r=Wh):h!==g&&g!==`%`&&(this._pt.b=c,this._pt.r=Uh);else if(m in o)Sg.call(this,e,m,c,_?_+l:l);else if(m in e)this.add(e,m,c||e[m],_?_+l:l,r,i);else if(m!==`parseTransform`){Of(m,l);continue}v||(m in o?C.push(m,0,o[m]):typeof e[m]==`function`?C.push(m,2,e[m]()):C.push(m,1,c||e[m])),a.push(m)}}S&&ch(this)},render:function(e,t){if(t.tween._time||!Ah())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:xg,aliases:Bh,getSetter:function(e,t,n){var r=Bh[t];return r&&r.indexOf(`,`)<0&&(t=r),t in Mh&&t!==tg&&(e._gsap.x||xg(e,`x`))?n&&kh===n?t===`scale`?Zh:Xh:(kh=n||{})&&(t===`scale`?Qh:$h):e.style&&!rf(e.style[t])?Jh:~t.indexOf(`-`)?Yh:eh(e,t)},core:{_removeProperty:gg,_getMatrix:jg}};Ch.utils.checkPrefix=ug,Ch.core.getStyleSaver=ag,(function(e,t,n,r){var i=qf(e+`,`+t+`,`+n,function(e){Mh[e]=1});qf(t,function(e){Vd.units[e]=`deg`,Og[e]=1}),Bh[i[13]]=e+`,`+t,qf(r,function(e){var t=e.split(`:`);Bh[t[1]]=i[t[0]]})})(`x,y,z,scale,scaleX,scaleY,xPercent,yPercent`,`rotation,rotationX,rotationY,skewX,skewY`,`transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective`,`0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY`),qf(`x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective`,function(e){Vd.units[e]=`px`}),Ch.registerPlugin(Gg);var Kg=Ch.registerPlugin(Gg)||Ch;Kg.core.Tween;var qg=`3d`,Jg=null,Yg=null,Xg=null,Zg=null,Qg=[],$g=!1,e_={w:!1,a:!1,s:!1,d:!1,q:!1,e:!1},t_=document.getElementById(`canvas-container`),n_=document.getElementById(`hotspot-overlay`),r_=document.getElementById(`loading-overlay`),i_=r_.querySelector(`.loading-text`),a_=document.getElementById(`room-badge`),o_=document.getElementById(`nav-panel`),s_=document.getElementById(`btn-mode-3d`),c_=document.getElementById(`btn-mode-pano`),l_=document.getElementById(`info-modal`),u_=document.getElementById(`info-title`),d_=document.getElementById(`info-body`),f_=document.getElementById(`info-close`);a_.textContent=`Dining Room & Kitchen`;var p_=()=>{qg===`3d`?o_.innerHTML=`
    ...
    `};p_();var m_=new Fn;m_.background=new Y(657935),m_.fog=new Pn(657935,.015);var h_=new po(60,window.innerWidth/window.innerHeight,.1,1e3);h_.position.set(0,1.8,5);var g_=new ou({antialias:!0,powerPreference:`high-performance`});g_.setPixelRatio(Math.min(window.devicePixelRatio,2)),g_.setSize(window.innerWidth,window.innerHeight),g_.shadowMap.enabled=!0,g_.shadowMap.type=1,g_.outputColorSpace=ze,g_.xr.enabled=!0,t_.appendChild(g_.domElement),document.body.appendChild(Rd.createButton(g_));var __=new _u(h_,g_.domElement);__.enableDamping=!0,__.dampingFactor=.05,__.enablePan=!0,__.panSpeed=2.5,__.target.set(0,1.8,4.95),__.update();var v_=new la(50,60,40);v_.scale(-1,1,1),Zg=new Ur({color:16777215,transparent:!0,opacity:1}),Xg=new ti(v_,Zg),Xg.visible=!1,m_.add(Xg),new $a().load(`/assets/panoramas/dining_room_360.jpg`,e=>{e.colorSpace=ze,Zg.map=e,Zg.needsUpdate=!0},void 0,e=>{console.error(`Error loading 360 panorama image:`,e)});var y_=new En;m_.add(y_);var b_=new xo(16777215,.7);y_.add(b_);var x_=new bo(16777215,.8);x_.position.set(10,20,10),x_.castShadow=!0,x_.shadow.mapSize.width=2048,x_.shadow.mapSize.height=2048,x_.shadow.bias=-1e-4,y_.add(x_);var S_=new bo(3900150,.3);S_.position.set(-10,10,-10),y_.add(S_),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&(e_.w=!0),(t===`s`||t===`arrowdown`)&&(e_.s=!0),(t===`a`||t===`arrowleft`)&&(e_.a=!0),(t===`d`||t===`arrowright`)&&(e_.d=!0),t===`q`&&(e_.q=!0),t===`e`&&(e_.e=!0)}),window.addEventListener(`keyup`,e=>{let t=e.key.toLowerCase();(t===`w`||t===`arrowup`)&&(e_.w=!1),(t===`s`||t===`arrowdown`)&&(e_.s=!1),(t===`a`||t===`arrowleft`)&&(e_.a=!1),(t===`d`||t===`arrowright`)&&(e_.d=!1),t===`q`&&(e_.q=!1),t===`e`&&(e_.e=!1)}),f_.addEventListener(`click`,O_);function C_(e,t,n){if($g)return;$g=!0,__.enabled=!1,O_();let r=Kg.timeline({onComplete:()=>{let e=new G;h_.getWorldDirection(e),__.target.copy(h_.position).add(e.multiplyScalar(.05)),__.update(),__.enabled=!0,$g=!1,n&&n()}});r.to(h_.position,{x:e.x,y:e.y,z:e.z,duration:1.5,ease:`power2.inOut`}),r.to(__.target,{x:t.x,y:t.y,z:t.z,duration:1.5,ease:`power2.inOut`},`<`)}function w_(e,t,n=40){let r=kt.degToRad(90-t),i=kt.degToRad(e);return new G(n*Math.sin(r)*Math.sin(i),n*Math.cos(r),n*Math.sin(r)*Math.cos(i))}function T_(e){let t=document.createElement(`div`);t.className=`hotspot hotspot-info`;let n=document.createElement(`div`);n.className=`hotspot-icon`,n.innerHTML=`i`,t.appendChild(n);let r=document.createElement(`div`);r.className=`hotspot-tooltip`,r.textContent=e.title,t.appendChild(r),t.addEventListener(`click`,()=>{e.isPanoHotspot?D_(e.title,e.content):C_(e.camPos,e.lookTarget,()=>{D_(e.title,e.content)})}),n_.appendChild(t),Qg.push({element:t,pos3D:e.pos3D})}function E_(){let e=new G;Qg.forEach(t=>{if(e.copy(t.pos3D),e.project(h_),e.z>1)t.element.style.display=`none`;else{let n=(e.x*.5+.5)*window.innerWidth,r=(e.y*-.5+.5)*window.innerHeight;t.element.style.display=`block`,t.element.style.transform=`translate(-50%, -50%) translate(${n}px, ${r}px)`}})}function D_(e,t){u_.textContent=e,d_.innerHTML=t,l_.classList.add(`active`)}function O_(){l_.classList.remove(`active`)}var k_=new Id;k_.setDecoderPath(`https://www.gstatic.com/draco/versioned/decoders/1.5.7/`);var A_=new Nu;A_.setDRACOLoader(k_),r_.style.display=`flex`,r_.style.opacity=`1`,A_.load(`/assets/models/dining_room_kitchen.glb`,e=>{Jg=e.scene,Jg.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material&&(e.material.roughness=Math.max(e.material.roughness,.3),e.material.map&&(e.material.map.colorSpace=ze)))});let t=new Xn().setFromObject(Jg);t.getCenter(new G),t.getSize(new G),Yg=t.clone(),Yg.expandByScalar(-.5),qg===`3d`&&(m_.add(Jg),j_()),Kg.to(r_,{opacity:0,duration:.5,onComplete:()=>{r_.style.display=`none`}})},e=>{e.total>0?i_.textContent=`Loading 3D Model: ${Math.round(e.loaded/e.total*100)}%`:i_.textContent=`Loading 3D Model: ${(e.loaded/(1024*1024)).toFixed(1)} MB`},e=>{console.error(`An error occurred loading the GLB model:`,e),i_.textContent=`Error loading model. Check console.`});function j_(){if(!Jg)return;let t=new Xn().setFromObject(Jg),n=t.getCenter(new G),r=t.getSize(new G);h_.position.set(n.x,n.y+1.8,n.z+r.z*.4),__.target.copy(h_.position).add(new G(0,0,-.05)),__.enablePan=!0,__.enableZoom=!0,__.minDistance=.1,__.maxDistance=30,__.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.PAN,RIGHT:e.NONE},__.update(),n_.innerHTML=``,Qg=[],[{title:`Dining Area`,content:`Contemporary dining layout featuring custom oak furniture, ambient architectural lighting, and open layout connecting to the kitchen.`,pos3D:n.clone().add(new G(-1,.4,-.5)),camPos:n.clone().add(new G(-1,1.8,1)),lookTarget:n.clone().add(new G(-1,1.5,-.5))},{title:`Gourmet Kitchen`,content:`Fully integrated smart appliances, solid marble countertops, and seamless flush cabinetry designed for modern culinary experiences.`,pos3D:n.clone().add(new G(1.2,.4,.8)),camPos:n.clone().add(new G(1.2,1.8,-.4)),lookTarget:n.clone().add(new G(1.2,1.5,.8))}].forEach(T_)}function M_(){h_.position.set(0,0,.1),__.target.set(0,0,0),__.enablePan=!1,__.enableZoom=!1,__.minDistance=.01,__.maxDistance=.1,__.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.NONE,RIGHT:e.NONE},__.update(),n_.innerHTML=``,Qg=[],T_({title:`Dining Room (Cycles Render)`,content:`A photorealistic 360-degree render of the dining space using Blender Cycles, demonstrating the perfect mirror reflections and soft architectural ambient lighting.`,pos3D:w_(40,-10,45),isPanoHotspot:!0})}function N_(e){$g||e===qg||(qg=e,O_(),p_(),e===`3d`?(s_.classList.add(`active`),c_.classList.remove(`active`),Xg.visible=!1,y_.visible=!0,Jg&&(m_.add(Jg),Jg.visible=!0,j_())):e===`pano`&&(c_.classList.add(`active`),s_.classList.remove(`active`),Xg.visible=!0,y_.visible=!1,Jg&&m_.remove(Jg),M_()))}s_.addEventListener(`click`,()=>N_(`3d`)),c_.addEventListener(`click`,()=>N_(`pano`));function P_(){if(!Jg||$g||qg!==`3d`)return;let e=.06,t=new G,n=new G;h_.getWorldDirection(n),n.y=0,n.normalize();let r=new G;if(r.crossVectors(h_.up,n).normalize(),e_.w&&t.add(n),e_.s&&t.sub(n),e_.a&&t.add(r),e_.d&&t.sub(r),e_.e&&(t.y+=1),e_.q&&--t.y,t.lengthSq()>0){let n=t.y*e;t.y=0,t.lengthSq()>0&&t.normalize().multiplyScalar(e),t.y=n,h_.position.add(t),__.target.add(t),__.update()}}g_.setAnimationLoop(()=>{if(qg===`3d`&&P_(),__.update(),qg===`3d`&&Jg&&Yg&&!$g){let e=h_.position.clone();h_.position.clamp(Yg.min,Yg.max);let t=h_.position.clone().sub(e);t.lengthSq()>0&&(__.target.add(t),__.update())}Qg.length>0&&E_(),g_.render(m_,h_)}),window.addEventListener(`resize`,()=>{h_.aspect=window.innerWidth/window.innerHeight,h_.updateProjectionMatrix(),g_.setSize(window.innerWidth,window.innerHeight),g_.setPixelRatio(Math.min(window.devicePixelRatio,2))});